...
func ParseRealtimeClientSecretBody(raw json.RawMessage) (map[string]json.RawMessage, *KoutakuError) {
...
func ExtractRealtimeClientSecretModel(root map[string]json.RawMessage) (string, *KoutakuError) {
...
func NewRealtimeClientSecretBodyError(status int, errorType, message string, err error) *KoutakuError {
	return &KoutakuError{
