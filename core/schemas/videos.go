...
type KoutakuVideoGenerationRequest struct {
...
func (b *KoutakuVideoGenerationRequest) GetRawRequestBody() []byte {
	return b.RawRequestBody
}

func (b *KoutakuVideoGenerationRequest) GetExtraParams() map[string]interface{} {
...
// KoutakuVideoGenerationResponse represents the video generation job response in koutaku format.
type KoutakuVideoGenerationResponse struct {
...
func getSecondsFromVideoRequest(req *KoutakuRequest) *string {
	if req == nil {
		return nil
	}
...
func (r *KoutakuVideoGenerationResponse) BackfillParams(req *KoutakuRequest) {
	if r == nil || req == nil {
		return
	}
...
type KoutakuVideoRemixRequest struct {
	ID             string                `json:"id"`
	Provider       ModelProvider         `json:"provider"`
	Input          *VideoGenerationInput `json:"input"`
	ExtraParams    map[string]any        `json:"-"`
...
func (b *KoutakuVideoRemixRequest) GetRawRequestBody() []byte {
	return b.RawRequestBody
}

func (b *KoutakuVideoRemixRequest) GetExtraParams() map[string]interface{} {
	if b == nil {
		return nil
	}
...
type KoutakuVideoListRequest struct {
	Provider ModelProvider `json:"provider"`
...
type KoutakuVideoListResponse struct {
...
type KoutakuVideoReferenceRequest struct {
	Provider ModelProvider `json:"provider"`
	ID       string        `json:"id"`
}

type KoutakuVideoDeleteRequest = KoutakuVideoReferenceRequest
type KoutakuVideoRetrieveRequest = KoutakuVideoReferenceRequest

type KoutakuVideoDeleteResponse struct {
	ID          string                     `json:"id"`
...
type KoutakuVideoDownloadRequest struct {
	Provider    ModelProvider         `json:"provider"`
	ID          string                `json:"id"`
...
type KoutakuVideoDownloadResponse struct {
