...
type Key struct {
	ID                 string              `json:"id"`                             // The unique identifier for the key (used by koutaku to identify the key)
	Name               string              `json:"name"`                           // The name of the key (used by users to identify the key, not used by koutaku)
...
type Account interface {
	...
	// The context can carry data from any source that sets values before the Koutaku request,
