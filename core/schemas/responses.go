...
type KoutakuResponsesRequest struct {
...
func (r *KoutakuResponsesRequest) GetRawRequestBody() []byte {
	return r.RawRequestBody
}

type KoutakuResponsesResponse struct {
...
func (resp *KoutakuResponsesResponse) BackfillParams(request *KoutakuResponsesRequest) {
...
func (resp *KoutakuResponsesResponse) WithDefaults() *KoutakuResponsesResponse {
	if resp == nil {
		return nil
	}

	result := &KoutakuResponsesResponse{
		ID:        resp.ID,
...
type KoutakuResponsesStreamResponse struct {
	Type           ResponsesStreamResponseType `json:"type"`
	SequenceNumber int                         `json:"sequence_number"`

	Response *KoutakuResponsesResponse `json:"response,omitempty"`
...
func (resp *KoutakuResponsesStreamResponse) WithDefaults() *KoutakuResponsesStreamResponse {
	if resp == nil {
		return nil
	}
	...
	result := &KoutakuResponsesStreamResponse{
		Type:           resp.Type,
