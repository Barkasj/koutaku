...
// KoutakuBatchCreateRequest represents a request to create a batch job.
type KoutakuBatchCreateRequest struct {
...
func (request *KoutakuBatchCreateRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}

// KoutakuBatchCreateResponse represents the response from creating a batch job.
type KoutakuBatchCreateResponse struct {
	ID               string             `json:"id"`
...
// KoutakuBatchListRequest represents a request to list batch jobs.
type KoutakuBatchListRequest struct {
	Provider ModelProvider `json:"provider"`
...
// KoutakuBatchListResponse represents the response from listing batch jobs.
type KoutakuBatchListResponse struct {
	Object  string                         `json:"object,omitempty"` // "list"
	Data    []KoutakuBatchRetrieveResponse `json:"data"`
...
// KoutakuBatchRetrieveRequest represents a request to retrieve a batch job.
type KoutakuBatchRetrieveRequest struct {
	Provider ModelProvider `json:"provider"`
	Model    *string       `json:"model"`
...
// GetRawRequestBody returns the raw request body.
func (request *KoutakuBatchRetrieveRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}

// KoutakuBatchRetrieveResponse represents the response from retrieving a batch job.
type KoutakuBatchRetrieveResponse struct {
	ID               string             `json:"id"`
	Object           string             `json:"object,omitempty"`
	Endpoint         string             `json:"endpoint,omitempty"`
	InputFileID      string             `json:"input_file_id,omitempty"`
...
// KoutakuBatchCancelRequest represents a request to cancel a batch job.
type KoutakuBatchCancelRequest struct {
	Provider ModelProvider `json:"provider"`
	Model    *string       `json:"model"`
...
// GetRawRequestBody returns the raw request body.
func (request *KoutakuBatchCancelRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}

// KoutakuBatchCancelResponse represents the response from cancelling a batch job.
type KoutakuBatchCancelResponse struct {
	ID            string             `json:"id"`
	Object        string             `json:"object,omitempty"`
	Status        BatchStatus        `json:"status"`
	RequestCounts BatchRequestCounts `json:"request_counts,omitempty"`
...
// KoutakuBatchDeleteRequest represents a request to delete a batch job.
type KoutakuBatchDeleteRequest struct {
	Provider ModelProvider `json:"provider"`
	Model    *string       `json:"model"`
...
// GetRawRequestBody returns the raw request body.
func (request *KoutakuBatchDeleteRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}

// KoutakuBatchDeleteResponse represents the response from deleting a batch job.
type KoutakuBatchDeleteResponse struct {
	ID            string             `json:"id"`
	Object        string             `json:"object,omitempty"`
	Status        BatchStatus        `json:"status"`
	RequestCounts BatchRequestCounts `json:"request_counts,omitempty"`
...
// KoutakuBatchResultsRequest represents a request to retrieve batch results.
type KoutakuBatchResultsRequest struct {
	Provider ModelProvider `json:"provider"`
	Model    *string       `json:"model"`
...
// GetRawRequestBody returns the raw request body.
func (request *KoutakuBatchResultsRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}
...
// KoutakuBatchResultsResponse represents the response from retrieving batch results.
type KoutakuBatchResultsResponse struct {
