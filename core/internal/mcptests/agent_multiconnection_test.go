...
func TestAgent_MultiConnection_MixedPermissions(t *testing.T) {
	...
	assert.True(t, toolNames["koutakuInternal-calculator"], "calculator should be waiting for approval")
...
func TestAgent_MultiConnection_ErrorInSTDIO(t *testing.T) {
	...
	// Assertions
	require.Nil(t, koutakuErr, "Agent should not fail on tool error")
	require.NotNil(t, result)
...
func TestAgent_MultiConnection_LargeParallelBatch(t *testing.T) {
	...
	expectedTools := []string{
		...
		"koutakuInternal-calculator",
		"koutakuInternal-get_weather",
		"koutakuInternal-get_time",
