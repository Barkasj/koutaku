...
func RunEagerInputStreamingTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("EagerInputStreaming", func(t *testing.T) {
		...
		for response := range responseChannel {
			...
			if response.KoutakuChatResponse.Choices != nil {
				for i, choice := range response.KoutakuChatResponse.Choices {
