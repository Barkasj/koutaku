...
func RunImageBase64Test(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ImageBase64", func(t *testing.T) {
		...
		validateChatBase64ImageProcessing := func(response *schemas.KoutakuChatResponse, apiName string) {
			content := GetChatContent(response)
			validateBase64ImageContent(t, content, apiName)
		}

		validateResponsesBase64ImageProcessing := func(response *schemas.KoutakuResponsesResponse, apiName string) {
