...
//
// This test sends the exact curl-reported shape via KoutakuChatRequest +
...
func RunServerToolsViaOpenAIEndpointTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
