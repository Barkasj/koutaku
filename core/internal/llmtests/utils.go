...
func GetSampleChatTool(toolName SampleToolType) *schemas.ChatTool {
	...
	return &schemas.ChatTool{
		...
		Function: &schemas.ChatToolFunction{
			...
			Description: koutaku.Ptr(description),
...
func GetSampleResponsesTool(toolName SampleToolType) *schemas.ResponsesTool {
	...
	return &schemas.ResponsesTool{
		Type:        "function",
		Name:        koutaku.Ptr(toolDisplayName),
		Description: koutaku.Ptr(description),
...
func CreateSpeechRequest(text, voice, format string) *schemas.KoutakuSpeechRequest {
...
func CreateTranscriptionInput(audioData []byte, language, responseFormat *string) *schemas.KoutakuTranscriptionRequest {
	return &schemas.KoutakuTranscriptionRequest{
...
func CreateBasicChatMessage(content string) schemas.ChatMessage {
	return schemas.ChatMessage{
		...
		Content: &schemas.ChatMessageContent{
			ContentStr: koutaku.Ptr(content),
		},
	}
}
	...
	return schemas.ChatMessage{
		...
		Content: &schemas.ChatMessageContent{
			ContentBlocks: []schemas.ChatContentBlock{
				{Type: schemas.ChatContentBlockTypeText, Text: koutaku.Ptr(text)},
	...
	return schemas.ResponsesMessage{
		...
		Content: &schemas.ResponsesMessageContent{
			ContentBlocks: []schemas.ResponsesMessageContentBlock{
				{Type: schemas.ResponsesInputMessageContentBlockTypeText, Text: koutaku.Ptr(text)},
				{
					Type: schemas.ResponsesInputMessageContentBlockTypeImage,
					ResponsesInputMessageContentBlockImage: &schemas.ResponsesInputMessageContentBlockImage{
						ImageURL: koutaku.Ptr(imageURL),
					},
				},
			},
		},
...
func CreateAudioChatMessage(text, audioData string, audioFormat string) schemas.ChatMessage {
	format := koutaku.Ptr(audioFormat)
	return schemas.ChatMessage{
		Role: schemas.ChatMessageRoleUser,
		Content: &schemas.ChatMessageContent{
			ContentBlocks: []schemas.ChatContentBlock{
...
func CreateToolChatMessage(content string, toolCallID string) schemas.ChatMessage {
	return schemas.ChatMessage{
		...
		ChatToolMessage: &schemas.ChatToolMessage{
			ToolCallID: koutaku.Ptr(toolCallID),
		},
	}
}
...
// GetChatContent returns the string content from a KoutakuChatResponse
func GetChatContent(response *schemas.KoutakuChatResponse) string {
...
// GetTextCompletionContent returns the string content from a KoutakuTextCompletionResponse
func GetTextCompletionContent(response *schemas.KoutakuTextCompletionResponse) string {
	if response == nil || response.Choices == nil {
		return ""
	}
...
// GetResponsesContent returns the string content from a KoutakuResponsesResponse
func GetResponsesContent(response *schemas.KoutakuResponsesResponse) string {
...
// ExtractChatToolCalls extracts tool call information from a KoutakuChatResponse
func ExtractChatToolCalls(response *schemas.KoutakuChatResponse) []ToolCallInfo {
...
// ExtractResponsesToolCalls extracts tool call information from a KoutakuResponsesResponse
func ExtractResponsesToolCalls(response *schemas.KoutakuResponsesResponse) []ToolCallInfo {
	var toolCalls []ToolCallInfo
...
func GetResultContent(response *schemas.KoutakuResponse) string {
	if response == nil {
		return ""
	}
...
func ExtractToolCalls(response *schemas.KoutakuResponse) []ToolCallInfo {
	if response == nil {
		return []ToolCallInfo{}
	}
...
// getEmbeddingVector extracts the float64 vector from a KoutakuEmbeddingResponse.
...
func GenerateTTSAudioForTest(ctx context.Context, t *testing.T, client *koutaku.Koutaku, provider schemas.ModelProvider, ttsModel string, text string, voiceType string, format string) ([]byte, string) {
	...
	req := &schemas.KoutakuSpeechRequest{
		Provider: provider,
		Model:    ttsModel,
	...
	resp, err := WithSpeechTestRetry(t, speechRetryConfig, retryContext, expectations, "GenerateTTSAudioForTest", func() (*schemas.KoutakuSpeechResponse, *schemas.KoutakuError) {
	...
	suffix := "." + format
	f, cerr := os.CreateTemp("", "koutaku-tts-*"+suffix)
	if cerr != nil {
...
func GetErrorMessage(err *schemas.KoutakuError) string {
	if err == nil {
		return ""
	}
