...
// ValidateExtraFieldsRaw validates rawRequest and rawResponse on KoutakuResponseExtraFields
func ValidateExtraFieldsRaw(extraFields schemas.KoutakuResponseExtraFields) []error {
	var errs []error
