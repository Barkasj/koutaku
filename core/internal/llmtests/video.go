...
func RunVideoGenerationTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunVideoRetrieveTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunVideoRemixTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoRemix", func(t *testing.T) {
		...
		remixReq := &schemas.KoutakuVideoRemixRequest{
...
func RunVideoDownloadTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoDownload", func(t *testing.T) {
		...
		downloadReq := &schemas.KoutakuVideoDownloadRequest{
			Provider: testConfig.Provider,
			ID:       created.ID,
		}
		bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
...
func RunVideoListTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoList", func(t *testing.T) {
		...
		order := "desc"
		limit := 5
		req := &schemas.KoutakuVideoListRequest{
			Provider: testConfig.Provider,
			Order:    koutaku.Ptr(order),
			Limit:    koutaku.Ptr(limit),
		}
		bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
...
func RunVideoDeleteTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoDelete", func(t *testing.T) {
		...
		deleteReq := &schemas.KoutakuVideoDeleteRequest{
			Provider: testConfig.Provider,
			ID:       created.ID,
		}
		bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
...
func RunVideoUnsupportedTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("VideoUnsupported", func(t *testing.T) {
		...
		_, listErr := client.VideoListRequest(bfCtx, &schemas.KoutakuVideoListRequest{
			Provider: testConfig.Provider,
		})
		...
		_, deleteErr := client.VideoDeleteRequest(bfCtx, &schemas.KoutakuVideoDeleteRequest{
			Provider: testConfig.Provider,
			ID:       "video_test_id",
		})
		...
		_, remixErr := client.VideoRemixRequest(bfCtx, &schemas.KoutakuVideoRemixRequest{
			Provider: testConfig.Provider,
			ID:       "video_test_id",
...
func createVideoJob(client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) (*schemas.KoutakuVideoGenerationResponse, *schemas.KoutakuError) {
...
func retrieveVideoWithRetries(client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig, videoID string) (*schemas.KoutakuVideoGenerationResponse, *schemas.KoutakuError) {
	var lastErr *schemas.KoutakuError
	for attempt := 0; attempt < videoRetrieveMaxRetries; attempt++ {
		req := &schemas.KoutakuVideoRetrieveRequest{
			Provider: testConfig.Provider,
			ID:       videoID,
		}
		bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
...
func waitForVideoCompletion(
	...
	var lastResp *schemas.KoutakuVideoGenerationResponse
	var lastErr *schemas.KoutakuError
...
func isUnsupportedOperationError(err *schemas.KoutakuError) bool {
