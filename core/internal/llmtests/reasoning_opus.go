...
func RunOpus45ReasoningTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, config OpusReasoningTestConfig) {
		...
		t.Run("ResponsesAPI", func(t *testing.T) {
			...
			responsesReq := &schemas.KoutakuResponsesRequest{
				...
				Params: &schemas.ResponsesParameters{
					MaxOutputTokens: koutaku.Ptr(4000),
			...
			response, responsesError := WithResponsesTestRetry(t, responsesRetryConfig, retryContext, expectations, "Opus45_Reasoning_Responses", func() (*schemas.KoutakuResponsesResponse, *schemas.KoutakuError) {
		...
		t.Run("ChatCompletionsAPI", func(t *testing.T) {
			...
			chatReq := &schemas.KoutakuChatRequest{
				...
				Params: &schemas.ChatParameters{
					MaxCompletionTokens: koutaku.Ptr(4000),
					Reasoning: &schemas.ChatReasoning{
						Effort:    koutaku.Ptr("high"),
						MaxTokens: koutaku.Ptr(2000), // Budget tokens for Opus 4.5
					},
				},
				Fallbacks: config.Fallbacks,
			}
			...
			response, chatError := WithChatTestRetry(t, chatRetryConfig, retryContext, expectations, "Opus45_Reasoning_Chat", func() (*schemas.KoutakuChatResponse, *schemas.KoutakuError) {
				bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
...
func RunOpus46ReasoningTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, config OpusReasoningTestConfig) {
			...
			t.Run("ResponsesAPI_Effort_"+effort, func(t *testing.T) {
				...
				responsesReq := &schemas.KoutakuResponsesRequest{
					...
					Params: &schemas.ResponsesParameters{
						MaxOutputTokens: koutaku.Ptr(4000),
						Reasoning: &schemas.ResponsesParametersReasoning{
							Effort: koutaku.Ptr(effort), // Adaptive thinking uses effort parameter
						},
						Include: []string{"reasoning.encrypted_content"},
					},
					Fallbacks: config.Fallbacks,
				...
				response, responsesError := WithResponsesTestRetry(t, responsesRetryConfig, retryContext, expectations, "Opus46_Reasoning_Responses_"+effort, func() (*schemas.KoutakuResponsesResponse, *schemas.KoutakuError) {
					bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
					return client.ResponsesRequest(bfCtx, responsesReq)
				})
		...
		t.Run("ChatCompletionsAPI", func(t *testing.T) {
			...
			chatReq := &schemas.KoutakuChatRequest{
				...
				Params: &schemas.ChatParameters{
					MaxCompletionTokens: koutaku.Ptr(4000),
					Reasoning: &schemas.ChatReasoning{
						Effort: koutaku.Ptr("high"), // Opus 4.6 uses adaptive thinking with effort
			...
			response, chatError := WithChatTestRetry(t, chatRetryConfig, retryContext, expectations, "Opus46_Reasoning_Chat", func() (*schemas.KoutakuChatResponse, *schemas.KoutakuError) {
				bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
				return client.ChatCompletionRequest(bfCtx, chatReq)
			})
...
func RunOpus46MultiTurnReasoningTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, config OpusReasoningTestConfig) {
	if config.SkipOpus46 {
	...
	t.Run("Opus46_MultiTurnReasoning", func(t *testing.T) {
		...
		firstResponse, chatError := WithChatTestRetry(t, chatRetryConfig, retryContext, expectations, "Opus46_MultiTurn_Step1", func() (*schemas.KoutakuChatResponse, *schemas.KoutakuError) {
			bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
			return client.ChatCompletionRequest(bfCtx, chatReq)
		})
		...
		multiTurnReq := &schemas.KoutakuChatRequest{
			Provider: config.Provider,
			Model:    config.Opus46Model,
		...
		secondResponse, chatError2 := WithChatTestRetry(t, chatRetryConfig, retryContext2, expectations, "Opus46_MultiTurn_Step2", func() (*schemas.KoutakuChatResponse, *schemas.KoutakuError) {
			bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
...
func RunAllOpusReasoningTests(t *testing.T, client *koutaku.Koutaku, ctx context.Context, config OpusReasoningTestConfig) {
