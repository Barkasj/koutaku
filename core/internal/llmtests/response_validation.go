...
func ValidateChatResponse(t *testing.T, response *schemas.KoutakuChatResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
...
func ValidateTextCompletionResponse(t *testing.T, response *schemas.KoutakuTextCompletionResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateResponsesResponse(t *testing.T, response *schemas.KoutakuResponsesResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateSpeechResponse(t *testing.T, response *schemas.KoutakuSpeechResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateImageGenerationResponse(t *testing.T, response *schemas.KoutakuImageGenerationResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateTranscriptionResponse(t *testing.T, response *schemas.KoutakuTranscriptionResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateListModelsResponse(t *testing.T, response *schemas.KoutakuListModelsResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateEmbeddingResponse(t *testing.T, response *schemas.KoutakuEmbeddingResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateCountTokensResponse(t *testing.T, response *schemas.KoutakuCountTokensResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func validateChatBasicStructure(t *testing.T, response *schemas.KoutakuChatResponse, expectations ResponseExpectations, result *ValidationResult, scenarioName string) {
	// Object is a constant koutaku schema marker ("chat.completion" / "chat.completion.chunk").
...
func validateChatContent(t *testing.T, response *schemas.KoutakuChatResponse, expectations ResponseExpectations, result *ValidationResult) {
...
func validateChatToolCalls(t *testing.T, response *schemas.KoutakuChatResponse, expectations ResponseExpectations, result *ValidationResult) {
	totalToolCalls := 0
...
func validateChatTechnicalFields(t *testing.T, response *schemas.KoutakuChatResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Check usage stats
...
func collectChatResponseMetrics(response *schemas.KoutakuChatResponse, result *ValidationResult) {
...
func validateTextCompletionBasicStructure(t *testing.T, response *schemas.KoutakuTextCompletionResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Check choice count
	if expectations.ExpectedChoiceCount > 0 {
		actualCount := 0
		if response.Choices != nil {
...
func validateTextCompletionContent(t *testing.T, response *schemas.KoutakuTextCompletionResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Skip content validation for responses that don't have text content
	if !expectations.ShouldHaveContent {
		return
	}
...
func validateTextCompletionTechnicalFields(t *testing.T, response *schemas.KoutakuTextCompletionResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Check usage stats
	if expectations.ShouldHaveUsageStats {
		if response.Usage == nil {
			result.Passed = false
...
func collectTextCompletionResponseMetrics(response *schemas.KoutakuTextCompletionResponse, result *ValidationResult) {
	result.MetricsCollected["choice_count"] = len(response.Choices)
	result.MetricsCollected["has_usage"] = response.Usage != nil
	result.MetricsCollected["has_model"] = response.Model != ""
...
func validateResponsesBasicStructure(response *schemas.KoutakuResponsesResponse, expectations ResponseExpectations, result *ValidationResult) {
...
func validateResponsesContent(t *testing.T, response *schemas.KoutakuResponsesResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Skip content validation for responses that don't have text content
	if !expectations.ShouldHaveContent {
		return
	}
...
func validateResponsesToolCalls(t *testing.T, response *schemas.KoutakuResponsesResponse, expectations ResponseExpectations, result *ValidationResult) {
	totalToolCalls := 0
...
func validateResponsesTechnicalFields(t *testing.T, response *schemas.KoutakuResponsesResponse, expectations ResponseExpectations, result *ValidationResult) {
	// Check usage stats
	if expectations.ShouldHaveUsageStats {
		if response.Usage == nil {
			result.Passed = false
...
func collectResponsesResponseMetrics(response *schemas.KoutakuResponsesResponse, result *ValidationResult) {
	if response.Output != nil {
...
func validateSpeechSynthesisResponse(t *testing.T, response *schemas.KoutakuSpeechResponse, expectations ResponseExpectations, result *ValidationResult) {
...
func collectSpeechResponseMetrics(response *schemas.KoutakuSpeechResponse, result *ValidationResult) {
...
func validateTranscriptionFields(t *testing.T, response *schemas.KoutakuTranscriptionResponse, expectations ResponseExpectations, result *ValidationResult) {
...
func collectTranscriptionResponseMetrics(response *schemas.KoutakuTranscriptionResponse, result *ValidationResult) {
...
func validateImageGenerationFields(t *testing.T, response *schemas.KoutakuImageGenerationResponse, expectations ResponseExpectations, result *ValidationResult) {
...
func collectImageGenerationResponseMetrics(response *schemas.KoutakuImageGenerationResponse, result *ValidationResult) {
...
func validateEmbeddingFields(t *testing.T, response *schemas.KoutakuEmbeddingResponse, expectations ResponseExpectations, result *ValidationResult) {
...
func validateCountTokensFields(t *testing.T, response *schemas.KoutakuCountTokensResponse, expectations ResponseExpectations, result *ValidationResult) {
	_ = t
...
func validateListModelsFields(t *testing.T, response *schemas.KoutakuListModelsResponse, expectations ResponseExpectations, result *ValidationResult) {
...
func collectListModelsResponseMetrics(response *schemas.KoutakuListModelsResponse, result *ValidationResult) {
...
func collectEmbeddingResponseMetrics(response *schemas.KoutakuEmbeddingResponse, result *ValidationResult) {
...
func collectCountTokensResponseMetrics(response *schemas.KoutakuCountTokensResponse, result *ValidationResult) {
...
func ValidateBatchCreateResponse(t *testing.T, response *schemas.KoutakuBatchCreateResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateBatchListResponse(t *testing.T, response *schemas.KoutakuBatchListResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateBatchRetrieveResponse(t *testing.T, response *schemas.KoutakuBatchRetrieveResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateBatchCancelResponse(t *testing.T, response *schemas.KoutakuBatchCancelResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateBatchResultsResponse(t *testing.T, response *schemas.KoutakuBatchResultsResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateFileUploadResponse(t *testing.T, response *schemas.KoutakuFileUploadResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateFileListResponse(t *testing.T, response *schemas.KoutakuFileListResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateFileRetrieveResponse(t *testing.T, response *schemas.KoutakuFileRetrieveResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateFileDeleteResponse(t *testing.T, response *schemas.KoutakuFileDeleteResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func ValidateFileContentResponse(t *testing.T, response *schemas.KoutakuFileContentResponse, err *schemas.KoutakuError, expectations ResponseExpectations, scenarioName string) ValidationResult {
	result := ValidationResult{
		Passed:           true,
		Errors:           make([]string, 0),
		Warnings:         make([]string, 0),
...
func extractChatToolCallNames(response *schemas.KoutakuChatResponse) []string {
...
func extractResponsesToolCallNames(response *schemas.KoutakuResponsesResponse) []string {
	var toolNames []string
...
func validateChatSpecificToolCalls(response *schemas.KoutakuChatResponse, expectedCalls []ToolCallExpectation, result *ValidationResult) {
...
func validateResponsesSpecificToolCalls(response *schemas.KoutakuResponsesResponse, expectedCalls []ToolCallExpectation, result *ValidationResult) {
	for _, expected := range expectedCalls {
		found := false
