...
func RunCompleteEnd2EndTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("CompleteEnd2End", func(t *testing.T) {
		...
		chatOperation1 := func() (*schemas.KoutakuChatResponse, *schemas.KoutakuError) {
			...
			chatReq := &schemas.KoutakuChatRequest{
				...
				Params: &schemas.ChatParameters{
					...
					ToolChoice: &schemas.ChatToolChoice{
						ChatToolChoiceStr: koutaku.Ptr(string(schemas.ChatToolChoiceTypeRequired)),
					},
					MaxCompletionTokens: koutaku.Ptr(400),
				},
		...
		responsesOperation1 := func() (*schemas.KoutakuResponsesResponse, *schemas.KoutakuError) {
			bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
			responsesReq := &schemas.KoutakuResponsesRequest{
				...
				Params: &schemas.ResponsesParameters{
					...
					ToolChoice: &schemas.ResponsesToolChoice{
						ResponsesToolChoiceStr: koutaku.Ptr(string(schemas.ResponsesToolChoiceTypeRequired)),
					},
					MaxOutputTokens: koutaku.Ptr(400),
				},
			}
		...
		chatOperation2 := func() (*schemas.KoutakuChatResponse, *schemas.KoutakuError) {
			bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
			chatReq := &schemas.KoutakuChatRequest{
				Provider: testConfig.Provider,
				Model:    testConfig.ChatModel,
		...
		responsesOperation2 := func() (*schemas.KoutakuResponsesResponse, *schemas.KoutakuError) {
			bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
			responsesReq := &schemas.KoutakuResponsesRequest{
				Provider: testConfig.Provider,
				Model:    testConfig.ChatModel,
		...
		chatOperation3 := func() (*schemas.KoutakuChatResponse, *schemas.KoutakuError) {
			bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
			chatReq := &schemas.KoutakuChatRequest{
				Provider: testConfig.Provider,
				Model:    model,
		...
		responsesOperation3 := func() (*schemas.KoutakuResponsesResponse, *schemas.KoutakuError) {
			bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
			responsesReq := &schemas.KoutakuResponsesRequest{
				Provider: testConfig.Provider,
				Model:    model,
