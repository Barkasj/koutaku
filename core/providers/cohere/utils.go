...
var (
	...
	cohereFinishReasonToKoutaku = map[CohereFinishReason]string{
...
// ConvertCohereFinishReasonToKoutaku converts provider finish reasons to Koutaku format
func ConvertCohereFinishReasonToKoutaku(providerReason CohereFinishReason) string {
	if koutakuReason, ok := cohereFinishReasonToKoutaku[providerReason]; ok {
...
// This handles the conversion from Cohere's flexible parameter format to Koutaku's structured format
...
// convertCohereResponseFormatToKoutaku converts Cohere's typed response_format back to interface{}
func convertCohereResponseFormatToKoutaku(cohereFormat *CohereResponseFormat) *interface{} {
	if cohereFormat == nil {
		return nil
	}
