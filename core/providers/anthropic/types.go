...
type AnthropicTextRequest struct {
	...
	// Koutaku specific field (only parsed when converting from Provider -> Koutaku request)
...
// ToKoutakuFileUploadResponse converts an Anthropic file response to Koutaku file upload response.
func (r *AnthropicFileResponse) ToKoutakuFileUploadResponse(latency time.Duration, sendBackRawRequest bool, sendBackRawResponse bool, rawRequest interface{}, rawResponse interface{}) *schemas.KoutakuFileUploadResponse {
...
// ToKoutakuFileRetrieveResponse converts an Anthropic file response to Koutaku file retrieve response.
func (r *AnthropicFileResponse) ToKoutakuFileRetrieveResponse(latency time.Duration, sendBackRawRequest bool, sendBackRawResponse bool, rawRequest interface{}, rawResponse interface{}) *schemas.KoutakuFileRetrieveResponse {
