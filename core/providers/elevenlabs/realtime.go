...
func (provider *ElevenlabsProvider) ExchangeRealtimeWebRTCSDP(_ *schemas.KoutakuContext, _ schemas.Key, _ string, _ string, _ json.RawMessage) (string, *schemas.KoutakuError) {
...
func (provider *ElevenlabsProvider) ShouldStartRealtimeTurn(event *schemas.KoutakuRealtimeEvent) bool {
	return false
}
...
func (provider *ElevenlabsProvider) ShouldForwardRealtimeEvent(event *schemas.KoutakuRealtimeEvent) bool {
	return true
}
...
// ToKoutakuRealtimeEvent converts an ElevenLabs Conversational AI event to the unified Koutaku format.
func (provider *ElevenlabsProvider) ToKoutakuRealtimeEvent(providerEvent json.RawMessage) (*schemas.KoutakuRealtimeEvent, error) {
...
// ToProviderRealtimeEvent converts a unified Koutaku Realtime event to ElevenLabs' native JSON.
func (provider *ElevenlabsProvider) ToProviderRealtimeEvent(koutakuEvent *schemas.KoutakuRealtimeEvent) (json.RawMessage, error) {
	switch koutakuEvent.Type {
	case schemas.RTEventInputAudioAppend:
		...
		out := map[string]interface{}{
			...
			"user_audio_chunk": koutakuEvent.Delta.Audio,
		}
