...
func ToHuggingFaceSpeechRequest(request *schemas.KoutakuSpeechRequest) (*HuggingFaceSpeechRequest, error) {
	if request == nil {
		return nil, nil
	}
...
func (response *HuggingFaceSpeechResponse) ToKoutakuSpeechResponse(requestedModel string, audioData []byte) (*schemas.KoutakuSpeechResponse, error) {
	if response == nil {
		return nil, nil
	}
	...
	// Create the base Koutaku response with the downloaded audio data
