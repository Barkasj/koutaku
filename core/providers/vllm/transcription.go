...
// a KoutakuTranscriptionStreamResponse. It returns (nil, false) if the payload is not
// valid vLLM format or has no content to emit.
func parseVLLMTranscriptionStreamChunk(jsonData []byte) (*schemas.KoutakuTranscriptionStreamResponse, bool) {
	...
	if chunk.Usage != nil {
		return &schemas.KoutakuTranscriptionStreamResponse{
