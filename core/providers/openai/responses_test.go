...
func TestToOpenAIResponsesRequest_ReasoningOnlyMessageSkip(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			result := ToOpenAIResponsesRequest(koutakuReq)
...
func TestToOpenAIResponsesRequest_ToolNormalization(t *testing.T) {
	...
	origParams := koutakuReq.Params.Tools[0].ResponsesToolFunction.Parameters
	...
	if funcTool.ResponsesToolFunction == koutakuReq.Params.Tools[0].ResponsesToolFunction {
