...
// ToKoutakuBatchStatus converts OpenAI status to Koutaku status.
...
// ToKoutakuBatchCreateResponse converts OpenAI batch response to Koutaku batch response.
func (r *OpenAIBatchResponse) ToKoutakuBatchCreateResponse(latency time.Duration, sendBackRawRequest bool, sendBackRawResponse bool, rawRequest interface{}, rawResponse interface{}) *schemas.KoutakuBatchCreateResponse {
	resp := &schemas.KoutakuBatchCreateResponse{
		...
		Status:           ToKoutakuBatchStatus(r.Status),
		Metadata:         r.Metadata,
...
// ToKoutakuBatchRetrieveResponse converts OpenAI batch response to Koutaku batch retrieve response.
func (r *OpenAIBatchResponse) ToKoutakuBatchRetrieveResponse(latency time.Duration, sendBackRawRequest bool, sendBackRawResponse bool, rawRequest interface{}, rawResponse interface{}) *schemas.KoutakuBatchRetrieveResponse {
