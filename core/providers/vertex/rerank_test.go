...
func TestVertexRankResponseToKoutakuRerankResponse(t *testing.T) {
	t.Parallel()
	...
	}).ToKoutakuRerankResponse(docs, true)
	require.NoError(t, err)
...
func TestVertexRankRequestToKoutakuRerankRequest(t *testing.T) {
	t.Parallel()
	...
	result := req.ToKoutakuRerankRequest(koutakuCtx)
...
func TestVertexRankRequestToKoutakuRerankRequestNil(t *testing.T) {
	t.Parallel()
...
func TestVertexRankResponseToKoutakuRerankResponseInvalidID(t *testing.T) {
	t.Parallel()
	...
	}).ToKoutakuRerankResponse([]schemas.RerankDocument{{Text: "doc"}}, false)
	require.Error(t, err)
