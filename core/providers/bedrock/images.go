...
// ToStabilityAIImageGenerationRequest converts a Koutaku image generation request to the Stability AI
// flat request format used by Bedrock (stability.stable-image-* models).
func ToStabilityAIImageGenerationRequest(request *schemas.KoutakuImageGenerationRequest) (*StabilityAIImageGenerationRequest, error) {
	if request == nil {
...
// ToBedrockImageGenerationRequest converts a Koutaku image generation request to a Bedrock image generation request
func ToBedrockImageGenerationRequest(request *schemas.KoutakuImageGenerationRequest) (*BedrockImageGenerationRequest, error) {
	if request == nil {
		return nil, fmt.Errorf("request is nil")
	}
...
// ToStabilityAIImageGenerationResponse converts a KoutakuImageGenerationResponse back to
...
func ToStabilityAIImageGenerationResponse(response *schemas.KoutakuImageGenerationResponse) (*BedrockImageGenerationResponse, error) {
	if response == nil {
...
// ToBedrockImageVariationRequest converts a Koutaku image variation request to a Bedrock image variation request
func ToBedrockImageVariationRequest(request *schemas.KoutakuImageVariationRequest) (*BedrockImageVariationRequest, error) {
	if request == nil {
		return nil, fmt.Errorf("request is nil")
	}
...
// ToBedrockImageEditRequest converts a Koutaku image edit request to a Bedrock image edit request
func ToBedrockImageEditRequest(request *schemas.KoutakuImageEditRequest) (*BedrockImageEditRequest, error) {
	// Validate request
...
// Helper functions
func buildInPaintingParams(imageBase64 string, request *schemas.KoutakuImageEditRequest) *BedrockInPaintingParams {
...
func buildOutPaintingParams(imageBase64 string, request *schemas.KoutakuImageEditRequest) *BedrockOutPaintingParams {
...
// getStabilityAITaskTypeFromParams maps the generic KoutakuImageEditParameters.Type value
...
// ToStabilityAIImageEditRequest converts a Koutaku image edit request to the Stability AI flat request
...
func ToStabilityAIImageEditRequest(request *schemas.KoutakuImageEditRequest, deployment string) (*StabilityAIImageEditRequest, error) {
	if request == nil || request.Input == nil {
		return nil, fmt.Errorf("request or input is nil")
	}
...
// ToKoutakuImageGenerationResponse converts a Bedrock image generation response to a Koutaku image generation response
func ToKoutakuImageGenerationResponse(response *BedrockImageGenerationResponse) *schemas.KoutakuImageGenerationResponse {
	if response == nil {
		return nil
	}

	koutakuResponse := &schemas.KoutakuImageGenerationResponse{}

	if len(response.FinishReasons) > 0 || len(response.Seeds) > 0 {
		koutakuResponse.ImageGenerationResponseParameters = &schemas.ImageGenerationResponseParameters{
	...
	for index, image := range response.Images {
		koutakuResponse.Data = append(koutakuResponse.Data, schemas.ImageData{
			B64JSON: image,
			Index:   index,
		})
	}
