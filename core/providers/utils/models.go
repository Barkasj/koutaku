...
//
// Every provider's ToKoutakuListModelsResponse follows the same logical steps:
...
// single ListModels response. Construct one per ToKoutakuListModelsResponse call
...
// ShouldEarlyExit reports whether ToKoutakuListModelsResponse should immediately
