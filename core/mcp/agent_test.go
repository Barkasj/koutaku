...
// MockLLMCaller implements schemas.KoutakuLLMCaller for testing
type MockLLMCaller struct {
	chatResponses      []*schemas.KoutakuChatResponse
	responsesResponses []*schemas.KoutakuResponsesResponse
	chatCallCount      int
	responsesCallCount int
}

func (m *MockLLMCaller) ChatCompletionRequest(ctx context.Context, req *schemas.KoutakuChatRequest) (*schemas.KoutakuChatResponse, *schemas.KoutakuError) {
...
func (m *MockLLMCaller) ResponsesRequest(ctx context.Context, req *schemas.KoutakuResponsesRequest) (*schemas.KoutakuResponsesResponse, *schemas.KoutakuError) {
...
func TestHasToolCallsForChatResponse(t *testing.T) {
	...
	// Test empty choices
	emptyResponse := &schemas.KoutakuChatResponse{
	...
	toolCallsResponse := &schemas.KoutakuChatResponse{
		Choices: []schemas.KoutakuResponseChoice{
			{
	...
	responseWithToolCalls := &schemas.KoutakuChatResponse{
		Choices: []schemas.KoutakuResponseChoice{
			{
	...
	responseWithStopReason := &schemas.KoutakuChatResponse{
		Choices: []schemas.KoutakuResponseChoice{
			{
	...
	responseWithStopNoTools := &schemas.KoutakuChatResponse{
		Choices: []schemas.KoutakuResponseChoice{
			{
				FinishReason: schemas.Ptr("stop"),
				ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
	...
	// ToKoutakuChatResponse() splits text and tool calls across separate choices when a model
	// returns both text content and tool calls (e.g. Claude via the /v1/responses endpoint).
	responseWithToolCallsInSecondChoice := &schemas.KoutakuChatResponse{
		Choices: []schemas.KoutakuResponseChoice{
			{
...
func TestExtractToolCalls(t *testing.T) {
	...
	responseNoTools := &schemas.KoutakuChatResponse{
		Choices: []schemas.KoutakuResponseChoice{
			{
				FinishReason: schemas.Ptr("stop"),
			},
	...
	responseWithTools := &schemas.KoutakuChatResponse{
		Choices: []schemas.KoutakuResponseChoice{
			{
				ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
					Message: &schemas.ChatMessage{
...
func TestExecuteAgentForChatRequest_WithNonAutoExecutableTools(t *testing.T) {
	...
	responseWithNonAutoTools := &schemas.KoutakuChatResponse{
		Choices: []schemas.KoutakuResponseChoice{
			{
				FinishReason: schemas.Ptr("tool_calls"),
				ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
...
func TestHasToolCallsForResponsesResponse(t *testing.T) {
	...
	// Test empty output
	emptyResponse := &schemas.KoutakuResponsesResponse{
	...
	responseWithFunctionCall := &schemas.KoutakuResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
	...
	responseWithoutToolMessage := &schemas.KoutakuResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
				Type: schemas.Ptr(schemas.ResponsesMessageTypeFunctionCall),
	...
	responseWithRegularMessage := &schemas.KoutakuResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
...
func TestExecuteAgentForResponsesRequest(t *testing.T) {
	...
	// Test with response that has no tool calls - should return immediately
	responseNoTools := &schemas.KoutakuResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
				Type: schemas.Ptr(schemas.ResponsesMessageTypeMessage),
...
func TestExecuteAgentForResponsesRequest_WithNonAutoExecutableTools(t *testing.T) {
	...
	// Create a response with tool calls that will NOT be auto-executed
	responseWithNonAutoTools := &schemas.KoutakuResponsesResponse{
		Output: []schemas.ResponsesMessage{
			{
				Type: schemas.Ptr(schemas.ResponsesMessageTypeFunctionCall),
				Role: schemas.Ptr(schemas.ResponsesInputMessageRoleAssistant),
...
// single LLM response each receive a unique KoutakuContextKeyMCPLogID in their context.
//
...
func TestParallelToolCallsHaveUniqueMCPLogIDs(t *testing.T) {
	...
	executeToolFunc := func(ctx *schemas.KoutakuContext, req *schemas.KoutakuMCPRequest) (*schemas.KoutakuMCPResponse, error) {
