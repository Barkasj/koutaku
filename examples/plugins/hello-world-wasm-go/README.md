...
A minimal example of a Koutaku plugin written in Go and compiled to WebAssembly using TinyGo.
...
**PostLLMHook Input:**
- `ctx`: Context JSON
- `resp`: Koutaku response JSON
- `err`: Koutaku error JSON (or null)
