#!/bin/bash
# Koutaku Helm Chart Installation Script
# This script helps you install Koutaku with different configurations
...
print_banner() {
    ...
    echo -e "${BLUE}╔═══════════════════════════════════════════╗${NC}"
    echo -e "${BLUE}║                                           ║${NC}"
    echo -e "${BLUE}║      Koutaku Helm Chart Installer        ║${NC}"
    echo -e "${BLUE}║                                           ║${NC}"
    echo -e "${BLUE}╚═══════════════════════════════════════════╝${NC}"
    echo ""
}
...
# Get release name
get_release_name() {
    read -p "Enter release name (default: koutaku): " RELEASE_NAME
    RELEASE_NAME=${RELEASE_NAME:-koutaku}
}
...
install_chart() {
    ...
    if helm install "$RELEASE_NAME" "$CHART_DIR" \
        ...
        print_success "Koutaku installed successfully!"
        echo ""
        ...
        echo "  kubectl logs -l app.kubernetes.io/name=koutaku -n $NAMESPACE -f"
        echo ""
    else
