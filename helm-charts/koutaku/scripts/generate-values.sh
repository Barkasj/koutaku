...
print_banner() {
    ...
    echo -e "${BLUE}╔═══════════════════════════════════════════╗${NC}"
    echo -e "${BLUE}║                                           ║${NC}"
    echo -e "${BLUE}║     Koutaku Values Generator             ║${NC}"
    echo -e "${BLUE}║                                           ║${NC}"
    echo -e "${BLUE}╚═══════════════════════════════════════════╝${NC}"
    echo ""
}
...
if [[ "$ingress_choice" =~ ^[Yy]$ ]]; then
    ...
    read -p "   Enter your domain (e.g., koutaku.yourdomain.com): " DOMAIN
else
    INGRESS_ENABLED="false"
    DOMAIN="koutaku.local"
fi
...
echo ""
print_info "Install with: helm install koutaku ./koutaku -f $OUTPUT_FILE"
