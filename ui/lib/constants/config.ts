...
export const IS_ENTERPRISE = process.env.KOUTAKU_IS_ENTERPRISE === "true";
export const TRIAL_EXPIRY = parseTrialExpiry(process.env.KOUTAKU_ENTERPRISE_TRIAL_EXPIRY);