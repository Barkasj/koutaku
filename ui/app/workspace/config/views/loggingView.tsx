...
export default function LoggingView() {
	...
	}, [koutakuConfig, localConfig, updateCoreConfig]);
	...
	return (
		<div className="mx-auto w-full max-w-4xl space-y-4">
			...
			<div className="space-y-4">
					...
					<div className="flex items-center justify-between space-x-2 rounded-lg border p-4">
						<div className="space-y-0.5">
							...
							<p className="text-muted-foreground text-sm">
								...
								{!koutakuConfig?.is_logs_connected && (
						...
						<Switch
							id="enable-logging"
							size="md"
							checked={localConfig.enable_logging && koutakuConfig?.is_logs_connected}
							disabled={!koutakuConfig?.is_logs_connected}
							onCheckedChange={(checked) => {
								if (koutakuConfig?.is_logs_connected) {
				...
				{localConfig.enable_logging && koutakuConfig?.is_logs_connected && (
					<div>
						<div className="flex items-center justify-between space-x-2 rounded-lg border p-4">
							<div className="space-y-0.5">
