...
export default function CachingView() {
	const { data: koutakuConfig, isLoading, error: configError } = useGetCoreConfigQuery({ fromDB: true });
	...
	return (
		<div className="mx-auto w-full max-w-4xl space-y-4">
			...
			{!isLoading && !configError && <PluginsForm isVectorStoreEnabled={koutakuConfig?.is_cache_connected ?? false} />}
		</div>
	);
}