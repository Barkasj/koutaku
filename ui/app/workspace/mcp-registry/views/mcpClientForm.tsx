										...
										<div className="flex items-center gap-2">
											...
											<TooltipProvider>
												<Tooltip>
													...
													<TooltipContent className="max-w-xs">
														<p>
															Leave empty to use Dynamic Client Registration (RFC 7591). Koutaku will automatically register with the OAuth
								...
								<div className="flex items-start gap-2">
									...
									<div className="flex-1">
										...
										<p className="mt-0.5 text-xs text-amber-800">
											If not using the official Koutaku Docker image, STDIO connections may not work if required commands (npx, python,
