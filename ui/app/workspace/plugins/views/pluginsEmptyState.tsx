...
const CUSTOM_PLUGINS_DOCS_URL = "https://github.com/Barkasj/koutaku/tree/main/docs/plugins";
	...
	return (
		...
		>
			...
			<div className="flex flex-col gap-1">
				<h1 className="text-muted-foreground text-xl font-medium">Custom plugins extend Koutaku with your own business logic</h1>
