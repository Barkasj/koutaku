...
client = openai.OpenAI(
    ...
    api_key="dummy-api-key" # Handled by Koutaku
)
...
const openai = new OpenAI({
  ...
  apiKey: "dummy-api-key", // Handled by Koutaku
});
...
const genAI = new GoogleGenerativeAI("dummy-api-key", { // Handled by Koutaku
...
# Initialize ChatOpenAI with Koutaku
llm = ChatOpenAI(
    model="gpt-4o-mini",
    api_key="dummy-api-key",  # Handled by Koutaku
...
const llm = new ChatOpenAI({
  model: "gpt-4o-mini",
  openAIApiKey: "dummy-api-key", // Handled by Koutaku
  clientOptions: {
