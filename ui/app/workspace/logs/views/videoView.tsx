...
import { KoutakuVideoDownloadOutput, KoutakuVideoGenerationOutput, KoutakuVideoListOutput } from "@/lib/types/logs";
...
type VideoOutput = KoutakuVideoGenerationOutput | KoutakuVideoDownloadOutput;

interface VideoViewProps {
	videoInput?: VideoGenerationInput;
	videoOutput?: VideoOutput;
	videoListOutput?: KoutakuVideoListOutput;
	requestType?: string;
}
...
export default function VideoView({ videoInput, videoOutput, videoListOutput, requestType }: VideoViewProps) {
	...
	const downloadOutput = isDownload && videoOutput ? (videoOutput as KoutakuVideoDownloadOutput) : null;
	const generationOutput = !isDownload && videoOutput ? (videoOutput as KoutakuVideoGenerationOutput) : null;
