...
func hydrateOpenAIRequestFromLargePayloadMetadata(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) {
	if koutakuCtx == nil {
		return
	}
...
func openAILargePayloadPreHook(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
	hydrateOpenAIRequestFromLargePayloadMetadata(ctx, koutakuCtx, req)
	schemas.ExtractAndSetUserAgentFromHeaders(extractHeadersFromRequest(ctx), koutakuCtx)
	return nil
}

func AzureEndpointPreHook(handlerStore lib.HandlerStore) func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
	return func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
		hydrateOpenAIRequestFromLargePayloadMetadata(ctx, koutakuCtx, req)
		schemas.ExtractAndSetUserAgentFromHeaders(extractHeadersFromRequest(ctx), koutakuCtx)
		...
		case *schemas.KoutakuListModelsRequest:
			if deploymentProviderStr != "" {
		...
		ctx.SetUserValue(schemas.KoutakuContextKeyDirectKey, key)
...
func CreateOpenAIRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	routes = append(routes, RouteConfig{
		...
		GetRequestTypeInstance: func(ctx context.Context) interface{} {
			if requestType, ok := ctx.Value(schemas.KoutakuContextKeyHTTPRequestType).(schemas.RequestType); ok {
				switch requestType {
		...
		RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
			if openaiReq, ok := req.(*openai.OpenAIChatRequest); ok {
				return &schemas.KoutakuRequest{
					ChatRequest: openaiReq.ToKoutakuChatRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAITextCompletionRequest); ok {
				return &schemas.KoutakuRequest{
					TextCompletionRequest: openaiReq.ToKoutakuTextCompletionRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAIEmbeddingRequest); ok {
				return &schemas.KoutakuRequest{
					EmbeddingRequest: openaiReq.ToKoutakuEmbeddingRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAISpeechRequest); ok {
				return &schemas.KoutakuRequest{
					SpeechRequest: openaiReq.ToKoutakuSpeechRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAITranscriptionRequest); ok {
				return &schemas.KoutakuRequest{
					TranscriptionRequest: openaiReq.ToKoutakuTranscriptionRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAIImageGenerationRequest); ok {
				return &schemas.KoutakuRequest{
					ImageGenerationRequest: openaiReq.ToKoutakuImageGenerationRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAIImageEditRequest); ok {
				return &schemas.KoutakuRequest{
					ImageEditRequest: openaiReq.ToKoutakuImageEditRequest(ctx),
				}, nil
			} else if openaiReq, ok := req.(*openai.OpenAIImageVariationRequest); ok {
				return &schemas.KoutakuRequest{
					ImageVariationRequest: openaiReq.ToKoutakuImageVariationRequest(ctx),
				}, nil
			}
		...
		TextResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuTextCompletionResponse) (interface{}, error) {
			if resp.ExtraFields.Provider == schemas.OpenAI {
				if resp.ExtraFields.RawResponse != nil {
					return resp.ExtraFields.RawResponse, nil
				}
		...
		SpeechResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuSpeechResponse) (interface{}, error) {
			if resp.ExtraFields.Provider == schemas.OpenAI {
				if resp.ExtraFields.RawResponse != nil {
					return resp.ExtraFields.RawResponse, nil
				}
		...
		TranscriptionResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuTranscriptionResponse) (interface{}, error) {
		...
		ImageGenerationResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuImageGenerationResponse) (interface{}, error) {
			if resp.ExtraFields.Provider == schemas.OpenAI {
				if resp.ExtraFields.RawResponse != nil {
					return resp.ExtraFields.RawResponse, nil
				}
		...
		StreamConfig: &StreamConfig{
			...
			TextStreamResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuTextCompletionResponse) (string, interface{}, error) {
				if resp.ExtraFields.Provider == schemas.OpenAI {
					if resp.ExtraFields.RawResponse != nil {
						return "", resp.ExtraFields.RawResponse, nil
					}
			...
			SpeechStreamResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuSpeechStreamResponse) (string, interface{}, error) {
				if resp.ExtraFields.Provider == schemas.OpenAI {
					if resp.ExtraFields.RawResponse != nil {
						return "", resp.ExtraFields.RawResponse, nil
					}
			...
			TranscriptionStreamResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuTranscriptionStreamResponse) (string, interface{}, error) {
				if resp.ExtraFields.Provider == schemas.OpenAI {
					if resp.ExtraFields.RawResponse != nil {
						return "", resp.ExtraFields.RawResponse, nil
					}
			...
			ImageGenerationStreamResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuImageGenerationStreamResponse) (string, interface{}, error) {
				if resp.ExtraFields.Provider == schemas.OpenAI {
					if resp.ExtraFields.RawResponse != nil {
						return "", resp.ExtraFields.RawResponse, nil
					}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if openaiReq, ok := req.(*openai.OpenAIResponsesRequest); ok {
					return &schemas.KoutakuRequest{
						ResponsesRequest: openaiReq.ToKoutakuResponsesRequest(ctx),
					}, nil
				}
				return nil, errors.New("invalid request type")
			},
			ResponsesResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuResponsesResponse) (interface{}, error) {
				if resp.ExtraFields.Provider == schemas.OpenAI {
					if resp.ExtraFields.RawResponse != nil {
						return resp.ExtraFields.RawResponse, nil
					}
			...
			AsyncResponsesResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.AsyncJobResponse, responsesResponseConverter ResponsesResponseConverter) (interface{}, map[string]string, error) {
				koutakuResponse := &schemas.KoutakuResponsesResponse{
					ID:     &resp.ID,
					Status: koutaku.Ptr(string(resp.Status)),
				}
				if resp.Status == schemas.AsyncJobStatusCompleted {
					responsesResp, ok := resp.Result.(*schemas.KoutakuResponsesResponse)
					if !ok {
						return nil, nil, errors.New("invalid responses response type")
					}
					koutakuResponse = responsesResp
				}
				response, err := responsesResponseConverter(ctx, koutakuResponse)
				if err != nil {
					return nil, nil, err
				}
			...
			StreamConfig: &StreamConfig{
				ResponsesStreamResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuResponsesStreamResponse) (string, interface{}, error) {
					if resp.ExtraFields.Provider == schemas.OpenAI {
						if resp.ExtraFields.RawResponse != nil {
			...
			PreCallback: func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
				hydrateOpenAIRequestFromLargePayloadMetadata(ctx, koutakuCtx, req)
				schemas.ExtractAndSetUserAgentFromHeaders(extractHeadersFromRequest(ctx), koutakuCtx)
				if isAzureSDKRequest(ctx) {
					koutakuCtx.SetValue(schemas.KoutakuContextKeyIsAzureUserAgent, true)
				}
				return nil
			},
		})
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if openaiReq, ok := req.(*openai.OpenAIResponsesRequest); ok {
					return &schemas.KoutakuRequest{
						CountTokensRequest: openaiReq.ToKoutakuResponsesRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if embeddingReq, ok := req.(*openai.OpenAIEmbeddingRequest); ok {
					return &schemas.KoutakuRequest{
						EmbeddingRequest: embeddingReq.ToKoutakuEmbeddingRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if speechReq, ok := req.(*openai.OpenAISpeechRequest); ok {
					return &schemas.KoutakuRequest{
						SpeechRequest: speechReq.ToKoutakuSpeechRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if transcriptionReq, ok := req.(*openai.OpenAITranscriptionRequest); ok {
					return &schemas.KoutakuRequest{
						TranscriptionRequest: transcriptionReq.ToKoutakuTranscriptionRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if imageGenReq, ok := req.(*openai.OpenAIImageGenerationRequest); ok {
					return &schemas.KoutakuRequest{
						ImageGenerationRequest: imageGenReq.ToKoutakuImageGenerationRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if imageEditReq, ok := req.(*openai.OpenAIImageEditRequest); ok {
					return &schemas.KoutakuRequest{
						ImageEditRequest: imageEditReq.ToKoutakuImageEditRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if imageVariationReq, ok := req.(*openai.OpenAIImageVariationRequest); ok {
					return &schemas.KoutakuRequest{
						ImageVariationRequest: imageVariationReq.ToKoutakuImageVariationRequest(ctx),
					}, nil
				}
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if videoGenerationReq, ok := req.(*openai.OpenAIVideoGenerationRequest); ok {
					return &schemas.KoutakuRequest{
						VideoGenerationRequest: videoGenerationReq.ToKoutakuVideoGenerationRequest(ctx),
					}, nil
				}
				return nil, errors.New("invalid video generation request type")
			},
			VideoGenerationResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuVideoGenerationResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.KoutakuContext, err *schemas.KoutakuError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuVideoRetrieveRequest{}
			},
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if videoRetrieveReq, ok := req.(*schemas.KoutakuVideoRetrieveRequest); ok {
					return &schemas.KoutakuRequest{
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuVideoDownloadRequest{}
			},
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if videoDownloadReq, ok := req.(*schemas.KoutakuVideoDownloadRequest); ok {
					return &schemas.KoutakuRequest{
			...
			VideoDownloadResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuVideoDownloadResponse) (interface{}, error) {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuVideoDeleteRequest{}
			},
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if videoDeleteReq, ok := req.(*schemas.KoutakuVideoDeleteRequest); ok {
					return &schemas.KoutakuRequest{
			...
			VideoDeleteResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuVideoDeleteResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.KoutakuContext, err *schemas.KoutakuError) interface{} {
				return err
		...
		routes = append(routes, RouteConfig{
			...
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if videoRemixReq, ok := req.(*openai.OpenAIVideoRemixRequest); ok {
					return &schemas.KoutakuRequest{
						VideoRemixRequest: openai.ToKoutakuVideoRemixRequest(videoRemixReq),
					}, nil
				}
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuVideoListRequest{}
			},
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if videoListReq, ok := req.(*schemas.KoutakuVideoListRequest); ok {
					return &schemas.KoutakuRequest{
			...
			VideoListResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuVideoListResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.KoutakuContext, err *schemas.KoutakuError) interface{} {
				return err
...
func CreateOpenAIListModelsRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuListModelsRequest{}
			},
			RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
				if listModelsReq, ok := req.(*schemas.KoutakuListModelsRequest); ok {
					return &schemas.KoutakuRequest{
			...
			ListModelsResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuListModelsResponse) (interface{}, error) {
...
func CreateOpenAIBatchRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuBatchCreateRequest{}
			},
			BatchRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*BatchRequest, error) {
				if openaiReq, ok := req.(*schemas.KoutakuBatchCreateRequest); ok {
			...
			BatchCreateResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuBatchCreateResponse) (interface{}, error) {
			...
			PreCallback: func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
				...
				if createReq, ok := req.(*schemas.KoutakuBatchCreateRequest); ok {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuBatchListRequest{}
			},
			BatchRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*BatchRequest, error) {
				if listReq, ok := req.(*schemas.KoutakuBatchListRequest); ok {
					if listReq.Provider == "" {
			...
			BatchListResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuBatchListResponse) (interface{}, error) {
				switch resp.ExtraFields.Provider {
				case schemas.Gemini:
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuBatchRetrieveRequest{}
			},
			BatchRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*BatchRequest, error) {
				if retrieveReq, ok := req.(*schemas.KoutakuBatchRetrieveRequest); ok {
			...
			BatchRetrieveResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuBatchRetrieveResponse) (interface{}, error) {
				switch resp.ExtraFields.Provider {
				case schemas.Gemini:
					resp.ID = strings.Replace(resp.ID, "batches/", "batches-", 1)
					resp.InputFileID = strings.Replace(resp.InputFileID, "files/", "files-", 1)
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuBatchCancelRequest{}
			},
			BatchRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*BatchRequest, error) {
				if cancelReq, ok := req.(*schemas.KoutakuBatchCancelRequest); ok {
			...
			BatchCancelResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuBatchCancelResponse) (interface{}, error) {
				switch resp.ExtraFields.Provider {
				case schemas.Gemini:
					resp.ID = strings.Replace(resp.ID, "batches/", "batches-", 1)
				case schemas.Bedrock:
...
func CreateOpenAIFileRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuFileUploadRequest{}
			},
			RequestParser: parseOpenAIFileUploadMultipartRequest,
			FileRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*FileRequest, error) {
				if uploadReq, ok := req.(*schemas.KoutakuFileUploadRequest); ok {
					return &FileRequest{
			...
			FileUploadResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuFileUploadResponse) (interface{}, error) {
			...
			PreCallback: func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
				...
				if koutakuReq, ok := req.(*schemas.KoutakuFileUploadRequest); ok {
					if koutakuReq.Provider == "" {
						if isAzureSDKRequest(ctx) {
							koutakuReq.Provider = schemas.Azure
						} else {
							koutakuReq.Provider = schemas.OpenAI
						}
					}
				}
				return nil
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuFileListRequest{}
			},
			FileRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*FileRequest, error) {
				if listReq, ok := req.(*schemas.KoutakuFileListRequest); ok {
					if listReq.Provider == "" {
						listReq.Provider = schemas.OpenAI
					}
					return &FileRequest{
			...
			FileListResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuFileListResponse) (interface{}, error) {
				if resp.ExtraFields.RawResponse != nil && resp.ExtraFields.Provider == schemas.OpenAI {
					return resp.ExtraFields.RawResponse, nil
				}
				switch resp.ExtraFields.Provider {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuFileRetrieveRequest{}
			},
			FileRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*FileRequest, error) {
				if retrieveReq, ok := req.(*schemas.KoutakuFileRetrieveRequest); ok {
					if retrieveReq.Provider == "" {
						retrieveReq.Provider = schemas.OpenAI
					}
			...
			FileRetrieveResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuFileRetrieveResponse) (interface{}, error) {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuFileDeleteRequest{}
			},
			FileRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*FileRequest, error) {
				if deleteReq, ok := req.(*schemas.KoutakuFileDeleteRequest); ok {
			...
			FileDeleteResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuFileDeleteResponse) (interface{}, error) {
				if resp.ExtraFields.RawResponse != nil && resp.ExtraFields.Provider == schemas.OpenAI {
					return resp.ExtraFields.RawResponse, nil
				}
				switch resp.ExtraFields.Provider {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuFileContentRequest{}
			},
			FileRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*FileRequest, error) {
				if contentReq, ok := req.(*schemas.KoutakuFileContentRequest); ok {
...
func extractBatchIDFromPath(_ lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.KoutakuBatchRetrieveRequest:
			r.BatchID = batchIDStr
			r.Provider = provider
		case *schemas.KoutakuBatchCancelRequest:
			r.BatchID = batchIDStr
			// For POST cancel, provider comes from body, only set if empty
			if r.Provider == "" {
				r.Provider = provider
			}
		case *schemas.KoutakuBatchResultsRequest:
			r.BatchID = batchIDStr
			r.Provider = provider
		}
...
func extractVideoIDFromPath(_ lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.KoutakuVideoReferenceRequest:
			r.Provider = providerName
			r.ID = rawVideoID
		case *schemas.KoutakuVideoDownloadRequest:
			r.Provider = providerName
			r.ID = rawVideoID
...
func extractFileIDFromPath(_ lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.KoutakuFileRetrieveRequest:
			r.FileID = fileIDStr
			r.Provider = provider
			if storageConfig != nil {
				r.StorageConfig = storageConfig
			}
		case *schemas.KoutakuFileDeleteRequest:
			r.FileID = fileIDStr
			r.Provider = provider
			if storageConfig != nil {
				r.StorageConfig = storageConfig
			}
		case *schemas.KoutakuFileContentRequest:
			r.FileID = fileIDStr
			r.Provider = provider
			if storageConfig != nil {
				r.StorageConfig = storageConfig
...
func parseOpenAIFileUploadMultipartRequest(ctx *fasthttp.RequestCtx, req interface{}) error {
	uploadReq, ok := req.(*schemas.KoutakuFileUploadRequest)
	if !ok {
...
func CreateOpenAIContainerRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuContainerCreateRequest{}
			},
			ContainerRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*ContainerRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if createReq, ok := req.(*schemas.KoutakuContainerCreateRequest); ok {
			...
			ContainerCreateResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuContainerCreateResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.KoutakuContext, err *schemas.KoutakuError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuContainerListRequest{}
			},
			ContainerRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*ContainerRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if listReq, ok := req.(*schemas.KoutakuContainerListRequest); ok {
					if listReq.Provider == "" {
						listReq.Provider = schemas.OpenAI
					}
					return &ContainerRequest{
			...
			ContainerListResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuContainerListResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.KoutakuContext, err *schemas.KoutakuError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuContainerRetrieveRequest{}
			},
			ContainerRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*ContainerRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if retrieveReq, ok := req.(*schemas.KoutakuContainerRetrieveRequest); ok {
					if retrieveReq.Provider == "" {
						retrieveReq.Provider = schemas.OpenAI
					}
					return &ContainerRequest{
			...
			ContainerRetrieveResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuContainerRetrieveResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.KoutakuContext, err *schemas.KoutakuError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuContainerDeleteRequest{}
			},
			ContainerRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*ContainerRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if deleteReq, ok := req.(*schemas.KoutakuContainerDeleteRequest); ok {
					if deleteReq.Provider == "" {
						deleteReq.Provider = schemas.OpenAI
					}
					return &ContainerRequest{
			...
			ContainerDeleteResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuContainerDeleteResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.KoutakuContext, err *schemas.KoutakuError) interface{} {
				return err
...
func extractContainerIDFromPath(_ lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.KoutakuContainerRetrieveRequest:
			r.ContainerID = containerIDStr
			r.Provider = provider
		case *schemas.KoutakuContainerDeleteRequest:
			r.ContainerID = containerIDStr
			r.Provider = provider
		}
...
func CreateOpenAIContainerFileRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuContainerFileCreateRequest{}
			},
			RequestParser: parseContainerFileCreateMultipartRequest,
			ContainerFileRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if createReq, ok := req.(*schemas.KoutakuContainerFileCreateRequest); ok {
			...
			ContainerFileCreateResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuContainerFileCreateResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.KoutakuContext, err *schemas.KoutakuError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuContainerFileListRequest{}
			},
			ContainerFileRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if listReq, ok := req.(*schemas.KoutakuContainerFileListRequest); ok {
					return &ContainerFileRequest{
			...
			ContainerFileListResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuContainerFileListResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.KoutakuContext, err *schemas.KoutakuError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuContainerFileRetrieveRequest{}
			},
			ContainerFileRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if retrieveReq, ok := req.(*schemas.KoutakuContainerFileRetrieveRequest); ok {
					return &ContainerFileRequest{
			...
			ContainerFileRetrieveResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuContainerFileRetrieveResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.KoutakuContext, err *schemas.KoutakuError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuContainerFileContentRequest{}
			},
			ContainerFileRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if contentReq, ok := req.(*schemas.KoutakuContainerFileContentRequest); ok {
					return &ContainerFileRequest{
			...
			ContainerFileContentResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuContainerFileContentResponse) (interface{}, error) {
				return resp.Content, nil
			},
			ErrorConverter: func(ctx *schemas.KoutakuContext, err *schemas.KoutakuError) interface{} {
				return err
	...
	for _, path := range []string{
		...
		routes = append(routes, RouteConfig{
			...
			GetRequestTypeInstance: func(ctx context.Context) interface{} {
				return &schemas.KoutakuContainerFileDeleteRequest{}
			},
			ContainerFileRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*ContainerFileRequest, error) {
				enableRawRequestResponseForContainer(ctx)
				if deleteReq, ok := req.(*schemas.KoutakuContainerFileDeleteRequest); ok {
					return &ContainerFileRequest{
			...
			ContainerFileDeleteResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuContainerFileDeleteResponse) (interface{}, error) {
				return resp, nil
			},
			ErrorConverter: func(ctx *schemas.KoutakuContext, err *schemas.KoutakuError) interface{} {
				return err
...
func extractContainerAndFileIDFromPath(handlerStore lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
		...
		switch r := req.(type) {
		case *schemas.KoutakuContainerFileRetrieveRequest:
			r.ContainerID = containerIDStr
			r.FileID = fileIDStr
			r.Provider = provider
		case *schemas.KoutakuContainerFileContentRequest:
			r.ContainerID = containerIDStr
			r.FileID = fileIDStr
			r.Provider = provider
		case *schemas.KoutakuContainerFileDeleteRequest:
			r.ContainerID = containerIDStr
			r.FileID = fileIDStr
			r.Provider = provider
		}
...
// NewOpenAIRouter creates a new OpenAIRouter with the given koutaku client.
func NewOpenAIRouter(client *koutaku.Koutaku, handlerStore lib.HandlerStore, logger schemas.Logger) *OpenAIRouter {
...
func parseContainerFileCreateMultipartRequest(ctx *fasthttp.RequestCtx, req interface{}) error {
	createReq, ok := req.(*schemas.KoutakuContainerFileCreateRequest)
	if !ok {
