...
// automatically discover Koutaku's OAuth configuration and authenticate.
package handlers
...
// authenticate with Koutaku's MCP server endpoint.
...
func (h *OAuthMetadataHandler) RegisterRoutes(r *router.Router, middlewares ...schemas.KoutakuHTTPMiddleware) {
...
// document per RFC 8414. MCP clients use this to discover Koutaku's OAuth
