...
func (a *Accumulator) buildCompleteMessageFromAudioStreamChunks(chunks []*AudioStreamChunk) *schemas.KoutakuSpeechResponse {
	completeMessage := &schemas.KoutakuSpeechResponse{}
...
func (a *Accumulator) processAccumulatedAudioStreamingChunks(requestID string, koutakuErr *schemas.KoutakuError, isFinalChunk bool) (*AccumulatedData, error) {
...
func (a *Accumulator) processAudioStreamingResponse(ctx *schemas.KoutakuContext, result *schemas.KoutakuResponse, koutakuErr *schemas.KoutakuError) (*ProcessedStreamResponse, error) {
	...
	if koutakuErr != nil {
		...
		newDelta := &schemas.KoutakuSpeechStreamResponse{
		...
		if result.SpeechStreamResponse.ExtraFields.RawResponse != nil {
			chunk.RawResponse = koutaku.Ptr(fmt.Sprintf("%v", result.SpeechStreamResponse.ExtraFields.RawResponse))
		}
	...
	if isFinalChunk {
		...
		data, processErr := a.processAccumulatedAudioStreamingChunks(requestID, koutakuErr, isFinalChunk)
		if processErr != nil {
