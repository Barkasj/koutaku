...
echo "🚀 Releasing koutaku CLI v$VERSION..."
...
BODY="## Koutaku CLI Release v$VERSION
...
#### Binary Download
\`\`\`bash
npx @koutaku/koutaku --cli-version v$VERSION
\`\`\`
...
echo "✅ Koutaku CLI released successfully"
