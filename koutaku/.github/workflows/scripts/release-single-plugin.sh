...
if [ -f "go.mod" ]; then
  go_get_with_backoff "github.com/koutaku/koutaku/core@${CORE_VERSION}"
  go_get_with_backoff "github.com/koutaku/koutaku/framework@${FRAMEWORK_VERSION}"
  go mod tidy
...
go get github.com/koutaku/koutaku/plugins/$PLUGIN_NAME@v$PLUGIN_VERSION
\`\`\`
