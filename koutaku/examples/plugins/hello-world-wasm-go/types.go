...
type PreHookInput struct {
	Context map[string]interface{}  `json:"context"`
	Request *schemas.KoutakuRequest `json:"request,omitempty"` // Keep raw for pass-through
}

// PreHookOutput is the output for pre_hook
type PreHookOutput struct {
	Context         map[string]interface{}      `json:"context"`
	Request         *schemas.KoutakuRequest     `json:"request,omitempty"`
...
type PostHookInput struct {
	Context  map[string]interface{}   `json:"context"`
	Response *schemas.KoutakuResponse `json:"response,omitempty"`
	Error    *schemas.KoutakuError    `json:"error,omitempty"`
...
type HTTPStreamChunkHookInput struct {
	Context map[string]interface{}     `json:"context"`
	Request *schemas.HTTPRequest       `json:"request,omitempty"`
	Chunk   *schemas.KoutakuStreamChunk `json:"chunk,omitempty"`
}
