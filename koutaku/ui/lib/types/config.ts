...
// KoutakuErrorResponse matching Go's schemas.KoutakuError
export interface KoutakuErrorResponse {
	event_id?: string;
	type?: string;
...
// Core Koutaku configuration types
