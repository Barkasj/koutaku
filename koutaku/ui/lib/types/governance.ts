...
export interface RateLimit {
	...
	token_max_limit?: number; // Koutakuum tokens allowed
	...
	request_max_limit?: number; // Koutakuum requests allowed
...
export interface UpdateRateLimitRequest {
	token_max_limit?: number | null; // Koutakuum tokens allowed (null to clear)
	token_reset_duration?: string | null; // e.g., "30s", "5m", "1h", "1d", "1w", "1M" (null to clear)
	request_max_limit?: number | null; // Koutakuum requests allowed (null to clear)
