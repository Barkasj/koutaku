...
import (
	...
	"github.com/koutaku/koutaku/cli/internal/config"
	"github.com/koutaku/koutaku/cli/internal/harness"
	"github.com/koutaku/koutaku/cli/internal/installer"
	"github.com/koutaku/koutaku/cli/internal/mcp"
	"github.com/koutaku/koutaku/cli/internal/runtime"
	"github.com/koutaku/koutaku/cli/internal/secrets"
	"github.com/koutaku/koutaku/cli/internal/ui/logo"
	"github.com/koutaku/koutaku/cli/internal/ui/tui"
	"github.com/koutaku/koutaku/cli/internal/update"
	"golang.org/x/term"
)
...
// App is the main Koutaku CLI application. It manages configuration, state,
...
func (a *App) Run(ctx context.Context) error {
	...
	if errors.Is(err, runtime.ErrUpdateRequested) {
		...
		if err != nil {
			fmt.Fprintf(a.out, "Updated successfully. Please restart koutaku.\n")
			return nil
		}
...
// getOrCreateProfile fetches or creates a new Koutaku CLI profile
