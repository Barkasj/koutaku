...
const (
	defaultDirName  = ".koutaku"
	defaultFileName = "config.json"
	stateFileName   = "state.json"
)

// FileConfig represents the on-disk koutaku configuration file (~/.koutaku/config.json).
...
// Profile represents a named Koutaku connection profile with a base URL.
type Profile struct {
	ID      string `json:"id"`
...
// DefaultConfigPath returns the default path to the koutaku config file (~/.koutaku/config.json).
...
// DefaultStatePath returns the default path to the koutaku state file (~/.koutaku/state.json).
