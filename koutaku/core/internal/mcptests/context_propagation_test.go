...
func TestContext_ParentChildRequestIDs(t *testing.T) {
	...
	ctx.SetValue(schemas.KoutakuContextKeyRequestID, originalRequestID)

	toolCall := schemas.ChatAssistantMessageToolCall{
		ID:   schemas.Ptr("call-inspect"),
		Type: schemas.Ptr("function"),
		Function: schemas.ChatAssistantMessageToolCallFunction{
			Name:      schemas.Ptr("koutakuInternal-inspect_context"),
			Arguments: "{}",
		},
	}
...
func TestContext_CancellationPropagation(t *testing.T) {
	...
	if koutakuErr != nil {
		t.Logf("Cancellation propagated with error: %v", koutakuErr.Error)
	} else if result != nil {
...
func TestContext_DeadlineInheritance(t *testing.T) {
	...
	toolCall := schemas.ChatAssistantMessageToolCall{
		...
		Type: schemas.Ptr("function"),
		Function: schemas.ChatAssistantMessageToolCallFunction{
			Name:      schemas.Ptr("koutakuInternal-deadline_check"),
			Arguments: "{}",
		},
	}
...
func TestContext_ValueIsolation(t *testing.T) {
	...
	for i := 0; i < 3; i++ {
		...
		toolCalls = append(toolCalls, schemas.ChatAssistantMessageToolCall{
			...
			Type: schemas.Ptr("function"),
			Function: schemas.ChatAssistantMessageToolCallFunction{
				Name:      schemas.Ptr("koutakuInternal-value_tool"),
...
func TestContext_NestedToolCalls(t *testing.T) {
	...
	ctx := createTestContext()
	ctx.SetValue(schemas.KoutakuContextKeyRequestID, "root_request_001")

	toolCall := schemas.ChatAssistantMessageToolCall{
		ID:   schemas.Ptr("call-outer"),
		Type: schemas.Ptr("function"),
		Function: schemas.ChatAssistantMessageToolCallFunction{
			Name:      schemas.Ptr("koutakuInternal-outer_tool"),
			Arguments: "{}",
		},
	}
...
func TestContext_TimeoutPropagation(t *testing.T) {
	...
	for i := range delays {
		toolCalls = append(toolCalls, schemas.ChatAssistantMessageToolCall{
			...
			Type: schemas.Ptr("function"),
			Function: schemas.ChatAssistantMessageToolCallFunction{
				Name:      schemas.Ptr(fmt.Sprintf("koutakuInternal-delay_tool_%d", i)),
				Arguments: "{}",
			},
		})
	}
	...
	if koutakuErr != nil {
		t.Logf("Timeout propagated with error: %v", koutakuErr.Error)
	} else {
		require.NotNil(t, result)
			...
			CreateChatResponseWithToolCalls([]schemas.ChatAssistantMessageToolCall{
				{
					...
					Type: schemas.Ptr("function"),
					Function: schemas.ChatAssistantMessageToolCallFunction{
						Name:      schemas.Ptr("koutakuInternal-id_tool"),
						Arguments: "{}",
					},
				},
			}),
...
func TestContext_CleanupOnCompletion(t *testing.T) {
	...
	for i := 0; i < 3; i++ {
		toolCall := schemas.ChatAssistantMessageToolCall{
			...
			Type: schemas.Ptr("function"),
			Function: schemas.ChatAssistantMessageToolCallFunction{
				Name:      schemas.Ptr("koutakuInternal-cleanup_tool"),
				Arguments: "{}",
			},
		}
...
func TestContext_ConcurrentAccess(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		toolCalls = append(toolCalls, schemas.ChatAssistantMessageToolCall{
			...
			Type: schemas.Ptr("function"),
			Function: schemas.ChatAssistantMessageToolCallFunction{
				Name:      schemas.Ptr("koutakuInternal-concurrent_tool"),
				Arguments: "{}",
			},
		})
	}
