...
func TestProtocol_BasicToolExecution(t *testing.T) {
	...
	require.Nil(t, koutakuErr, "Echo tool should succeed")
	...
	result, koutakuErr = koutaku.ExecuteChatMCPTool(ctx, &toolCall)
	require.Nil(t, koutakuErr, "Calculator tool should succeed")
	require.NotNil(t, result, "Should have result")
...
func TestProtocol_ParallelExecution(t *testing.T) {
	...
	for _, tt := range testTools {
		t.Run(tt.name, func(t *testing.T) {
			...
			result, koutakuErr := koutaku.ExecuteChatMCPTool(ctx, &toolCall)
			require.Nil(t, koutakuErr, "Tool should succeed")
			require.NotNil(t, result, "Should have result")
...
func TestProtocol_ErrorHandling(t *testing.T) {
	...
	t.Run("IntermittentFailure", func(t *testing.T) {
		...
		result, _ := koutaku.ExecuteChatMCPTool(ctx, &toolCall)
	...
	t.Run("LargePayload", func(t *testing.T) {
		...
		result, koutakuErr := koutaku.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, koutakuErr, "Large payload should succeed")
		require.NotNil(t, result, "Should have result")
...
func TestProtocol_EdgeCases(t *testing.T) {
	...
	t.Run("UnicodeText", func(t *testing.T) {
		...
		result, koutakuErr := koutaku.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, koutakuErr, "Unicode tool should succeed")
		require.NotNil(t, result, "Should have result")
	...
	t.Run("DeeplyNested", func(t *testing.T) {
		...
		result, koutakuErr := koutaku.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, koutakuErr, "Deeply nested tool should succeed")
		require.NotNil(t, result, "Should have result")
	...
	t.Run("EmptyResponse", func(t *testing.T) {
		...
		result, koutakuErr := koutaku.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, koutakuErr, "Empty response tool should succeed")
		require.NotNil(t, result, "Should have result")
	...
	t.Run("NullFields", func(t *testing.T) {
		...
		result, koutakuErr := koutaku.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, koutakuErr, "Null fields tool should succeed")
		require.NotNil(t, result, "Should have result")
	...
	t.Run("SpecialCharacters", func(t *testing.T) {
		...
		result, koutakuErr := koutaku.ExecuteChatMCPTool(ctx, &toolCall)
		require.Nil(t, koutakuErr, "Special chars tool should succeed")
		require.NotNil(t, result, "Should have result")
...
func getTestToolsServerPath(t *testing.T) string {
	...
	// Path from koutaku root: examples/mcps/test-tools-server/dist/index.js
