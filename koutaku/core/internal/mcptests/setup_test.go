...
// createTestContext creates a KoutakuContext for testing
func createTestContext() *schemas.KoutakuContext {
	return schemas.NewKoutakuContext(context.Background(), schemas.NoDeadline)
}

// createTestContextWithTimeout creates a KoutakuContext with timeout
func createTestContextWithTimeout(timeout time.Duration) (*schemas.KoutakuContext, context.CancelFunc) {
	ctx, cancel := context.WithTimeout(context.Background(), timeout)
	return schemas.NewKoutakuContext(ctx, schemas.NoDeadline), cancel
}
