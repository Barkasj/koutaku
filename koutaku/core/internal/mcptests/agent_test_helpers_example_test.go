...
func TestAgentHelpers_Example_SimpleInProcessAgent(t *testing.T) {
	...
	AssertAgentSuccess(t, result, koutakuErr)
...
func TestAgentHelpers_Example_SimpleAgentTestHelper(t *testing.T) {
	...
	SimpleAgentTest(
		...
		func(t *testing.T, response *schemas.KoutakuChatResponse, koutakuErr *schemas.KoutakuError, mocker *DynamicLLMMocker) {
...
func TestAgentHelpers_Example_MaxDepthLimit(t *testing.T) {
	...
	require.Nil(t, koutakuErr, "Should not error at max depth")
