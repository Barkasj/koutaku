...
func RunAutomaticFunctionCallingTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("AutomaticFunctionCalling", func(t *testing.T) {
				...
				Params: &schemas.ResponsesParameters{
					...
					ToolChoice: &schemas.ResponsesToolChoice{
						ResponsesToolChoiceStruct: &schemas.ResponsesToolChoiceStruct{
							...
							Name: koutaku.Ptr(string(SampleToolTypeTime)),
						},
					},
				},
				Fallbacks: testConfig.Fallbacks,
		...
		validateChatAutomaticToolCall := func(response *schemas.KoutakuChatResponse, apiName string) {
			toolCalls := ExtractChatToolCalls(response)
			validateAutomaticToolCall(t, toolCalls, apiName)
		}

		validateResponsesAutomaticToolCall := func(response *schemas.KoutakuResponsesResponse, apiName string) {
