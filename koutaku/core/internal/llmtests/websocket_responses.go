...
func RunWebSocketResponsesTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("WebSocketResponses", func(t *testing.T) {
		...
		if provider == nil {
			t.Fatalf("provider %s not found in koutaku client", testConfig.Provider)
		}
