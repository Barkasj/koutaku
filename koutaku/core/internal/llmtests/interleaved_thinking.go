...
func RunInterleavedThinkingTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
		...
		t.Run("NonStreaming", func(t *testing.T) {
			...
			request := &schemas.KoutakuResponsesRequest{
				...
				Params: &schemas.ResponsesParameters{
					MaxOutputTokens: koutaku.Ptr(4096),
