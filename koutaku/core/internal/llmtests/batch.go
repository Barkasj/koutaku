// Package llmtests provides batch API test utilities for the Koutaku system.
package llmtests
...
func RunBatchCreateTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchCreate", func(t *testing.T) {
		...
		response, err := WithBatchCreateTestRetry(t, batchCreateRetryConfig, retryContext, expectations, "BatchCreate", func() (*schemas.KoutakuBatchCreateResponse, *schemas.KoutakuError) {
			request := &schemas.KoutakuBatchCreateRequest{
				Provider: testConfig.Provider,
...
func RunBatchListTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchList", func(t *testing.T) {
		...
		response, err := WithBatchListTestRetry(t, batchListRetryConfig, retryContext, expectations, "BatchList", func() (*schemas.KoutakuBatchListResponse, *schemas.KoutakuError) {
			request := &schemas.KoutakuBatchListRequest{
				Provider: testConfig.Provider,
				Limit:    10,
			}
			bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
...
func RunBatchRetrieveTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchRetrieve", func(t *testing.T) {
		...
		createResponse, createErr := WithBatchCreateTestRetry(t, batchCreateRetryConfig, createRetryContext, createExpectations, "BatchRetrieve_Create", func() (*schemas.KoutakuBatchCreateResponse, *schemas.KoutakuError) {
		...
		response, err := WithBatchRetrieveTestRetry(t, batchRetrieveRetryConfig, retrieveRetryContext, retrieveExpectations, "BatchRetrieve", func() (*schemas.KoutakuBatchRetrieveResponse, *schemas.KoutakuError) {
...
func RunBatchCancelTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchCancel", func(t *testing.T) {
		...
		createResponse, createErr := WithBatchCreateTestRetry(t, batchCreateRetryConfig, createRetryContext, createExpectations, "BatchCancel_Create", func() (*schemas.KoutakuBatchCreateResponse, *schemas.KoutakuError) {
			createRequest := &schemas.KoutakuBatchCreateRequest{
				Provider: testConfig.Provider,
				Model:    schemas.Ptr(testConfig.ChatModel),
				Endpoint: schemas.BatchEndpointChatCompletions,
		...
		response, err := WithBatchCancelTestRetry(t, batchCancelRetryConfig, cancelRetryContext, cancelExpectations, "BatchCancel", func() (*schemas.KoutakuBatchCancelResponse, *schemas.KoutakuError) {
...
func RunBatchResultsTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("BatchResults", func(t *testing.T) {
		...
		request := &schemas.KoutakuBatchResultsRequest{
			Provider: testConfig.Provider,
...
func RunBatchUnsupportedTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunFileUploadTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileUpload", func(t *testing.T) {
		...
		response, err := WithFileUploadTestRetry(t, fileUploadRetryConfig, retryContext, expectations, "FileUpload", func() (*schemas.KoutakuFileUploadResponse, *schemas.KoutakuError) {
...
`)
			request := &schemas.KoutakuFileUploadRequest{
				Provider:    testConfig.Provider,
				File:        fileContent,
...
func RunFileListTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileList", func(t *testing.T) {
		...
		response, err := WithFileListTestRetry(t, fileListRetryConfig, retryContext, expectations, "FileList", func() (*schemas.KoutakuFileListResponse, *schemas.KoutakuError) {
			request := &schemas.KoutakuFileListRequest{
				Provider:    testConfig.Provider,
				Limit:       10,
				ExtraParams: testConfig.FileExtraParams,
			}
...
func RunFileRetrieveTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileRetrieve", func(t *testing.T) {
		...
		uploadResponse, uploadErr := WithFileUploadTestRetry(t, fileUploadRetryConfig, uploadRetryContext, uploadExpectations, "FileRetrieve_Upload", func() (*schemas.KoutakuFileUploadResponse, *schemas.KoutakuError) {
...
`)
		...
		response, err := WithFileRetrieveTestRetry(t, fileRetrieveRetryConfig, retrieveRetryContext, retrieveExpectations, "FileRetrieve", func() (*schemas.KoutakuFileRetrieveResponse, *schemas.KoutakuError) {
...
func RunFileDeleteTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileDelete", func(t *testing.T) {
		...
		uploadResponse, uploadErr := WithFileUploadTestRetry(t, fileUploadRetryConfig, uploadRetryContext, uploadExpectations, "FileDelete_Upload", func() (*schemas.KoutakuFileUploadResponse, *schemas.KoutakuError) {
...
`)
		...
		response, err := WithFileDeleteTestRetry(t, fileDeleteRetryConfig, deleteRetryContext, deleteExpectations, "FileDelete", func() (*schemas.KoutakuFileDeleteResponse, *schemas.KoutakuError) {
...
func RunFileContentTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("FileContent", func(t *testing.T) {
		...
		uploadResponse, uploadErr := WithFileUploadTestRetry(t, fileUploadRetryConfig, uploadRetryContext, uploadExpectations, "FileContent_Upload", func() (*schemas.KoutakuFileUploadResponse, *schemas.KoutakuError) {
...
`)
		...
		response, err := WithFileContentTestRetry(t, fileContentRetryConfig, contentRetryContext, contentExpectations, "FileContent", func() (*schemas.KoutakuFileContentResponse, *schemas.KoutakuError) {
...
func RunFileUnsupportedTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunFileAndBatchIntegrationTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
`)
		...
		batchRequest := &schemas.KoutakuBatchCreateRequest{
			Provider:         testConfig.Provider,
			Model:            schemas.Ptr(testConfig.ChatModel),
		...
		bfCtx2 := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
