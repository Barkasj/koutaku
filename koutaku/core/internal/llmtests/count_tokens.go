...
func RunCountTokenTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("CountTokens", func(t *testing.T) {
		...
		countTokensReq := &schemas.KoutakuResponsesRequest{
		...
		countTokensResp, countTokensErr := WithCountTokensTestRetry(
			...
			expectations,
			"CountTokens",
			func() (*schemas.KoutakuCountTokensResponse, *schemas.KoutakuError) {
