...
func RunImageURLTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ImageURL", func(t *testing.T) {
		...
		validateChatImageProcessing := func(response *schemas.KoutakuChatResponse, apiName string) {
			content := GetChatContent(response)
			validateImageProcessingContent(t, content, apiName)
		}

		validateResponsesImageProcessing := func(response *schemas.KoutakuResponsesResponse, apiName string) {
