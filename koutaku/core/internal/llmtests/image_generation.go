...
func RunImageGenerationTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ImageGeneration", func(t *testing.T) {
		...
		imageGenerationOperation := func() (*schemas.KoutakuImageGenerationResponse, *schemas.KoutakuError) {
			...
			response, err := client.ImageGenerationRequest(schemas.NewKoutakuContext(ctx, schemas.NoDeadline), request)
			if err != nil {
				return nil, err
			}
			if response != nil {
...
func RunImageGenerationStreamTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	...
	t.Run("ImageGenerationStream", func(t *testing.T) {
		...
		validationResult := WithImageGenerationStreamRetry(
			...
			func() (chan *schemas.KoutakuStreamChunk, *schemas.KoutakuError) {
				return client.ImageGenerationStreamRequest(schemas.NewKoutakuContext(streamCtx, schemas.NoDeadline), request)
			},
