...
func RunFileURLTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
...
func RunFileURLChatCompletionsTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	if !testConfig.Scenarios.FileURL {
		t.Logf("File URL not supported for provider %s", testConfig.Provider)
		return
	}
	...
	t.Run("FileURL-ChatCompletions", func(t *testing.T) {
		...
		response, chatError := WithChatTestRetry(t, chatRetryConfig, retryContext, expectations, "FileURL", func() (*schemas.KoutakuChatResponse, *schemas.KoutakuError) {
...
func RunFileURLResponsesTest(t *testing.T, client *koutaku.Koutaku, ctx context.Context, testConfig ComprehensiveTestConfig) {
	if !testConfig.Scenarios.FileURL {
		t.Logf("File URL not supported for provider %s", testConfig.Provider)
		return
	}
	...
	t.Run("FileURL-Responses", func(t *testing.T) {
		...
		response, responsesError := WithResponsesTestRetry(t, responsesRetryConfig, retryContext, expectations, "FileURL", func() (*schemas.KoutakuResponsesResponse, *schemas.KoutakuError) {
			bfCtx := schemas.NewKoutakuContext(ctx, schemas.NoDeadline)
