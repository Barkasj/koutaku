...
func (c *EmptyResponseCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
...
func (c *MissingToolCallCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
...
func (c *MalformedToolArgsCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *WrongToolCalledCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *PartialToolCallCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *WrongToolSequenceCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *ImageNotProcessedCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *FileNotProcessedCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *GenericResponseCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *ContentValidationCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *StreamErrorCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
...
func (c *IncompleteStreamCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
	...
	if response.ChatResponse != nil {
		for i, choice := range response.ChatResponse.Choices {
			...
			if finishReason == "length" {
				...
				singleChoiceResponse := &schemas.KoutakuResponse{
					ChatResponse: &schemas.KoutakuChatResponse{
						Choices: []schemas.KoutakuResponseChoice{choice},
					},
				}
...
func (c *EmptySpeechCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
...
func (c *EmptyTranscriptionCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	// If there's an error, let other conditions handle it
	if err != nil {
		return false, ""
	}
...
func (c *EmptyEmbeddingCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *InvalidEmbeddingDimensionCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
...
func (c *EmptyImageGenerationCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	// If there's an error, let other conditions handle it
	if err != nil {
		return false, ""
	}
...
func (c *EmptyCountTokensCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	// If there's an error, let other conditions handle it
	if err != nil {
		return false, ""
	}
...
func (c *InvalidCountTokensCondition) ShouldRetry(response *schemas.KoutakuResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *ResponsesEmptyCondition) ShouldRetry(response *schemas.KoutakuResponsesResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil {
		return false, ""
	}
	if response == nil {
...
func (c *ResponsesFileNotProcessedCondition) ShouldRetry(response *schemas.KoutakuResponsesResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *ResponsesGenericResponseCondition) ShouldRetry(response *schemas.KoutakuResponsesResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
...
func (c *ResponsesContentValidationCondition) ShouldRetry(response *schemas.KoutakuResponsesResponse, err *schemas.KoutakuError, context TestRetryContext) (bool, string) {
	if err != nil || response == nil {
		return false, ""
	}
