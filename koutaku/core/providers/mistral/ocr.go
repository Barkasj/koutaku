...
// ToMistralOCRRequest converts a Koutaku OCR request to a Mistral OCR request.
func ToMistralOCRRequest(req *schemas.KoutakuOCRRequest) *MistralOCRRequest {
	if req == nil {
		return nil
	}
...
// ToKoutakuOCRResponse converts a Mistral OCR response to a Koutaku OCR response.
func (r *MistralOCRResponse) ToKoutakuOCRResponse() *schemas.KoutakuOCRResponse {
	if r == nil {
		return nil
	}

	resp := &schemas.KoutakuOCRResponse{
		Model:              r.Model,
