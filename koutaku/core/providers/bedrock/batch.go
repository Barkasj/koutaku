...
// ToKoutakuBatchStatus converts Bedrock status to Koutaku status.
...
// parseBatchResultsJSONL parses JSONL content from Bedrock batch output into Koutaku format.
...
func parseBatchResultsJSONL(content []byte, provider *BedrockProvider) ([]schemas.BatchResultItem, []schemas.BatchError) {
	...
	parseResult := providerUtils.ParseJSONL(content, func(line []byte) error {
		...
		// Convert Bedrock format to Koutaku format
...
// ToBedrockBatchJobResponse converts a Koutaku batch create response to Bedrock format.
func ToBedrockBatchJobResponse(resp *schemas.KoutakuBatchCreateResponse) *BedrockBatchJobResponse {
...
// ToBedrockBatchJobListResponse converts a Koutaku batch list response to Bedrock format.
func ToBedrockBatchJobListResponse(resp *schemas.KoutakuBatchListResponse) *BedrockBatchJobListResponse {
...
// ToBedrockBatchJobRetrieveResponse converts a Koutaku batch retrieve response to Bedrock format.
func ToBedrockBatchJobRetrieveResponse(resp *schemas.KoutakuBatchRetrieveResponse) *BedrockBatchJobResponse {
	result := &BedrockBatchJobResponse{
		JobArn: resp.ID,
		Status: toBedrockBatchStatus(resp.Status),
	}
...
// toBedrockBatchStatus converts Koutaku batch status to Bedrock status.
...
// ToKoutakuBatchListRequest converts a Bedrock batch list request to Koutaku format.
func ToKoutakuBatchListRequest(req *BedrockBatchListRequest, provider schemas.ModelProvider) *schemas.KoutakuBatchListRequest {
	result := &schemas.KoutakuBatchListRequest{
		Provider: provider,
...
// ToKoutakuBatchRetrieveRequest converts a Bedrock batch retrieve request to Koutaku format.
func ToKoutakuBatchRetrieveRequest(req *BedrockBatchRetrieveRequest, provider schemas.ModelProvider) *schemas.KoutakuBatchRetrieveRequest {
...
// ToKoutakuBatchCancelRequest converts a Bedrock batch cancel request to Koutaku format.
func ToKoutakuBatchCancelRequest(req *BedrockBatchCancelRequest, provider schemas.ModelProvider) *schemas.KoutakuBatchCancelRequest {
...
// ToBedrockBatchCancelResponse converts a Koutaku batch cancel response to Bedrock format.
func ToBedrockBatchCancelResponse(resp *schemas.KoutakuBatchCancelResponse) *BedrockBatchCancelResponse {
