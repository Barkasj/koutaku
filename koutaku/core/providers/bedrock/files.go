...
// ToBedrockFileUploadResponse converts a Koutaku file upload response to Bedrock format.
func ToBedrockFileUploadResponse(resp *schemas.KoutakuFileUploadResponse) *BedrockFileUploadResponse {
	if resp == nil {
		return nil
	}
...
// ToBedrockFileListResponse converts a Koutaku file list response to Bedrock format.
func ToBedrockFileListResponse(resp *schemas.KoutakuFileListResponse) *BedrockFileListResponse {
	if resp == nil {
		return nil
	}
...
// ToBedrockFileRetrieveResponse converts a Koutaku file retrieve response to Bedrock format.
func ToBedrockFileRetrieveResponse(resp *schemas.KoutakuFileRetrieveResponse) *BedrockFileRetrieveResponse {
	if resp == nil {
		return nil
	}
...
// ToBedrockFileDeleteResponse converts a Koutaku file delete response to Bedrock format.
func ToBedrockFileDeleteResponse(resp *schemas.KoutakuFileDeleteResponse) *BedrockFileDeleteResponse {
	if resp == nil {
		return nil
	}
...
// ToBedrockFileContentResponse converts a Koutaku file content response to Bedrock format.
func ToBedrockFileContentResponse(resp *schemas.KoutakuFileContentResponse) *BedrockFileContentResponse {
	if resp == nil {
		return nil
	}
...
// ToS3ListObjectsV2XML converts a Koutaku file list response to S3 ListObjectsV2 XML format.
func ToS3ListObjectsV2XML(resp *schemas.KoutakuFileListResponse, bucket, prefix string, maxKeys int) []byte {
	if resp == nil {
