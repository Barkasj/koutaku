...
func getRequestBodyForAnthropicResponses(ctx *schemas.KoutakuContext, request *schemas.KoutakuResponsesRequest, deployment string, isStreaming bool) ([]byte, *schemas.KoutakuError) {
