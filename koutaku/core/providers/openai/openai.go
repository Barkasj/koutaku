// Package openai provides the OpenAI provider implementation for the Koutaku framework.
package openai
...
func NewOpenAIProvider(config *schemas.ProviderConfig, logger schemas.Logger) *OpenAIProvider {
	...
	// 	openAIResponsePool.Put(&schemas.KoutakuResponse{})
	// }
...
func (provider *OpenAIProvider) buildRequestURL(ctx *schemas.KoutakuContext, defaultPath string, requestType schemas.RequestType) string {
...
func (provider *OpenAIProvider) ListModels(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuListModelsRequest) (*schemas.KoutakuListModelsResponse, *schemas.KoutakuError) {
	...
	if provider.customProviderConfig != nil && provider.customProviderConfig.IsKeyLess {
		return providerUtils.HandleKeylessListModelsRequest(providerName, func() (*schemas.KoutakuListModelsResponse, *schemas.KoutakuError) {
...
func ListModelsByKey(
...
) (*schemas.KoutakuListModelsResponse, *schemas.KoutakuError) {
	// Create request
	...
	if resp.StatusCode() != fasthttp.StatusOK {
		koutakuErr := ParseOpenAIError(resp)
		return nil, koutakuErr
	}
	...
	rawRequest, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(responseBody, openaiResponse, nil, sendBackRawRequest, sendBackRawResponse)
	if koutakuErr != nil {
		return nil, koutakuErr
	}

	response := openaiResponse.ToKoutakuListModelsResponse(providerName, key.Models, key.BlacklistedModels, key.Aliases, unfiltered)
...
func HandleOpenAIListModelsRequest(
	ctx *schemas.KoutakuContext,
	client *fasthttp.Client,
	request *schemas.KoutakuListModelsRequest,
	url string,
	keys []schemas.Key,
	extraHeaders map[string]string,
	providerName schemas.ModelProvider,
	...
	listModelsByKeyWrapper := func(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuListModelsRequest) (*schemas.KoutakuListModelsResponse, *schemas.KoutakuError) {
...
func (provider *OpenAIProvider) TextCompletion(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuTextCompletionRequest) (*schemas.KoutakuTextCompletionResponse, *schemas.KoutakuError) {
...
func HandleOpenAITextCompletionRequest(
	...
	sendBackRawRequest bool,
	sendBackRawResponse bool,
	customResponseHandler responseHandler[schemas.KoutakuTextCompletionResponse],
	customErrorConverter ErrorConverter,
	logger schemas.Logger,
) (*schemas.KoutakuTextCompletionResponse, *schemas.KoutakuError) {
	// Create request
	req := fasthttp.AcquireRequest()
	resp := fasthttp.AcquireResponse()
	defer fasthttp.ReleaseRequest(req)
	...
	if lpResult, lpErr, handled := handleOpenAILargePayloadPassthrough(ctx, client, url, key, extraHeaders, providerName, logger); handled {
		...
		if len(lpResult.ResponseBody) > 0 {
			...
			response.ExtraFields = schemas.KoutakuResponseExtraFields{Latency: lpResult.Latency}
			return response, nil
		}
		return &schemas.KoutakuTextCompletionResponse{
			Model:       request.Model,
			Usage:       lpResult.Usage,
			ExtraFields: schemas.KoutakuResponseExtraFields{Latency: lpResult.Latency},
		}, nil
	}
	...
	if customResponseHandler != nil {
		rawRequest, rawResponse, koutakuErr = customResponseHandler(body, response, jsonData, sendBackRawRequest, sendBackRawResponse)
	} else {
		rawRequest, rawResponse, koutakuErr = providerUtils.HandleProviderResponse(body, response, jsonData, sendBackRawRequest, sendBackRawResponse)
	}
...
func (provider *OpenAIProvider) TextCompletionStream(ctx *schemas.KoutakuContext, postHookRunner schemas.PostHookRunner, postHookSpanFinalizer func(context.Context), key schemas.Key, request *schemas.KoutakuTextCompletionRequest) (chan *schemas.KoutakuStreamChunk, *schemas.KoutakuError) {
...
func HandleOpenAITextCompletionStreaming(
	...
	customResponseHandler responseHandler[schemas.KoutakuTextCompletionResponse],
	postResponseConverter func(*schemas.KoutakuTextCompletionResponse) *schemas.KoutakuTextCompletionResponse,
	logger schemas.Logger,
	...
	go func() {
		...
		for {
			...
			var response schemas.KoutakuTextCompletionResponse
			if customResponseHandler != nil {
				...
				if handlerErr != nil {
					...
					ctx.SetValue(schemas.KoutakuContextKeyStreamEndIndicator, true)
					providerUtils.ProcessAndSendKoutakuError(ctx, postHookRunner, providerUtils.EnrichError(ctx, handlerErr, jsonBody, nil, sendBackRawRequest, sendBackRawResponse), responseChan, logger, postHookSpanFinalizer)
					return
				}
			} else {
			...
			if response.Choices == nil {
				response.Choices = []schemas.KoutakuResponseChoice{}
			}
			...
			if choice.TextCompletionResponseChoice != nil && choice.TextCompletionResponseChoice.Text != nil {
				...
				providerUtils.ProcessAndSendResponse(ctx, postHookRunner, providerUtils.GetKoutakuResponseForStreamResponse(&response, nil, nil, nil, nil, nil), responseChan, postHookSpanFinalizer)
			}
		...
		response := providerUtils.CreateKoutakuTextCompletionChunkResponse(messageID, usage, finishReason, chunkIndex, schemas.TextCompletionStreamRequest)
		if postResponseConverter != nil {
...
func (provider *OpenAIProvider) ChatCompletion(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuChatRequest) (*schemas.KoutakuChatResponse, *schemas.KoutakuError) {
...
func HandleOpenAIChatCompletionRequest(
	...
	sendBackRawResponse bool,
	providerName schemas.ModelProvider,
	customResponseHandler responseHandler[schemas.KoutakuChatResponse],
	customErrorConverter ErrorConverter,
	logger schemas.Logger,
...
func (provider *OpenAIProvider) ChatCompletionStream(ctx *schemas.KoutakuContext, postHookRunner schemas.PostHookRunner, postHookSpanFinalizer func(context.Context), key schemas.Key, request *schemas.KoutakuChatRequest) (chan *schemas.KoutakuStreamChunk, *schemas.KoutakuError) {
...
func HandleOpenAIChatCompletionStreaming(
	...
	providerName schemas.ModelProvider,
	postHookRunner schemas.PostHookRunner,
	customRequestConverter func(*schemas.KoutakuChatRequest) (providerUtils.RequestBodyWithExtraParams, error),
	customResponseHandler responseHandler[schemas.KoutakuChatResponse],
	customErrorConverter ErrorConverter,
	...
	if ctx.Value(schemas.KoutakuContextKeyIsResponsesToChatCompletionFallback) != nil {
		isResponsesToChatCompletionsFallbackValue, ok := ctx.Value(schemas.KoutakuContextKeyIsResponsesToChatCompletionFallback).(bool)
	...
	go func() {
		...
		for {
			...
			// Parse into koutaku response
			var response schemas.KoutakuChatResponse
			// TODO fix this
			if customResponseHandler != nil {
				rawRequest, rawResponse, handlerErr := customResponseHandler([]byte(jsonData), &response, nil, sendBackRawRequest, sendBackRawResponse)
				if handlerErr != nil {
			...
			if isResponsesToChatCompletionsFallback {
				spreadResponses := response.ToKoutakuResponsesStreamResponse(responsesStreamState)
				for _, response := range spreadResponses {
					if response.Type == schemas.ResponsesStreamResponseTypeError {
						...
						if response.Message != nil {
							koutakuErr.Error.Message = *response.Message
						}
						if response.Param != nil {
							koutakuErr.Error.Param = *response.Param
						}
						if response.Code != nil {
							koutakuErr.Error.Code = response.Code
						}
		...
		if !isResponsesToChatCompletionsFallback {
			...
			response := providerUtils.CreateKoutakuChatCompletionChunkResponse(messageID, usage, finalFinishReason, chunkIndex, modelName, created)
			if postResponseConverter != nil {
				response = postResponseConverter(response)
			}
			// Set raw request if enabled
...
func (provider *OpenAIProvider) Responses(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuResponsesRequest) (*schemas.KoutakuResponsesResponse, *schemas.KoutakuError) {
	// Check if chat completion is allowed for this provider
...
func HandleOpenAIResponsesRequest(
	...
	sendBackRawResponse bool,
	providerName schemas.ModelProvider,
	customResponseHandler responseHandler[schemas.KoutakuResponsesResponse],
	customErrorConverter ErrorConverter,
	logger schemas.Logger,
...
func (provider *OpenAIProvider) ResponsesStream(ctx *schemas.KoutakuContext, postHookRunner schemas.PostHookRunner, postHookSpanFinalizer func(context.Context), key schemas.Key, request *schemas.KoutakuResponsesRequest) (chan *schemas.KoutakuStreamChunk, *schemas.KoutakuError) {
	// Check if chat completion stream is allowed for this provider
...
func HandleOpenAIResponsesStreaming(
	...
	providerName schemas.ModelProvider,
	postHookRunner schemas.PostHookRunner,
	customResponseHandler responseHandler[schemas.KoutakuResponsesStreamResponse],
	customErrorConverter ErrorConverter,
	...
	go func() {
		...
		for {
			...
			// Parse into koutaku response
			var response schemas.KoutakuResponsesStreamResponse
			// TODO fix this
			if customResponseHandler != nil {
				rawRequest, rawResponse, koutakuErr := customResponseHandler([]byte(jsonData), &response, nil, false, false)
				if koutakuErr != nil {
					if sendBackRawRequest {
						koutakuErr.ExtraFields.RawRequest = rawRequest
					}
					if sendBackRawResponse {
				...
				if response.Type == schemas.ResponsesStreamResponseTypeError {
					...
					if response.Response != nil && response.Response.Error != nil {
						if response.Response.Error.Message != "" && koutakuErr.Error.Message == "" {
							koutakuErr.Error.Message = response.Response.Error.Message
						}
						if response.Response.Error.Code != "" && (koutakuErr.Error.Code == nil || *koutakuErr.Error.Code == "") {
							koutakuErr.Error.Code = schemas.Ptr(response.Response.Error.Code)
						}
					}

					ctx.SetValue(schemas.KoutakuContextKeyStreamEndIndicator, true)
					providerUtils.ProcessAndSendKoutakuError(ctx, postHookRunner, providerUtils.EnrichError(ctx, koutakuErr, jsonBody, []byte(jsonData), sendBackRawRequest, sendBackRawResponse), responseChan, logger, postHookSpanFinalizer)
					return
				}

				// Some providers (e.g. Fireworks) send response.failed on HTTP 200 streams
				// instead of a pre-stream 4xx. Convert to KoutakuError for consistent handling.
				if response.Type == schemas.ResponsesStreamResponseTypeFailed {
					...
					if response.Response != nil && response.Response.Error != nil {
						koutakuErr.Error.Message = response.Response.Error.Message
						koutakuErr.Error.Code = &response.Response.Error.Code
					}
					ctx.SetValue(schemas.KoutakuContextKeyStreamEndIndicator, true)
					providerUtils.ProcessAndSendKoutakuError(ctx, postHookRunner, providerUtils.EnrichError(ctx, koutakuErr, jsonBody, []byte(jsonData), sendBackRawRequest, sendBackRawResponse), responseChan, logger, postHookSpanFinalizer)
					return
...
func (provider *OpenAIProvider) Embedding(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuEmbeddingRequest) (*schemas.KoutakuEmbeddingResponse, *schemas.KoutakuError) {
...
func HandleOpenAIEmbeddingRequest(
	...
	client *fasthttp.Client,
	url string,
	request *schemas.KoutakuEmbeddingRequest,
	key schemas.Key,
	extraHeaders map[string]string,
	providerName schemas.ModelProvider,
	sendBackRawRequest bool,
	sendBackRawResponse bool,
	customResponseHandler responseHandler[schemas.KoutakuEmbeddingResponse],
	logger schemas.Logger,
) (*schemas.KoutakuEmbeddingResponse, *schemas.KoutakuError) {
	// Create request
	req := fasthttp.AcquireRequest()
	resp := fasthttp.AcquireResponse()
	defer fasthttp.ReleaseRequest(req)
...
func (provider *OpenAIProvider) Speech(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuSpeechRequest) (*schemas.KoutakuSpeechResponse, *schemas.KoutakuError) {
...
func HandleOpenAISpeechRequest(
	...
	client *fasthttp.Client,
	url string,
	request *schemas.KoutakuSpeechRequest,
	key schemas.Key,
	extraHeaders map[string]string,
	providerName schemas.ModelProvider,
	sendBackRawRequest bool,
	sendBackRawResponse bool,
	customResponseHandler responseHandler[schemas.KoutakuSpeechResponse],
	logger schemas.Logger,
) (*schemas.KoutakuSpeechResponse, *schemas.KoutakuError) {
	// Create request
	req := fasthttp.AcquireRequest()
	resp := fasthttp.AcquireResponse()
	defer fasthttp.ReleaseRequest(req)
...
// Returns a channel for streaming responses and any error that occurred.
func (provider *OpenAIProvider) SpeechStream(ctx *schemas.KoutakuContext, postHookRunner schemas.PostHookRunner, postHookSpanFinalizer func(context.Context), key schemas.Key, request *schemas.KoutakuSpeechRequest) (chan *schemas.KoutakuStreamChunk, *schemas.KoutakuError) {
	...
	for _, model := range providerUtils.UnsupportedSpeechStreamModels {
		if model == request.Model {
			return nil, providerUtils.NewKoutakuOperationError(fmt.Sprintf("model %s is not supported for streaming speech synthesis", model), nil)
		}
	}
...
func HandleOpenAISpeechStreamRequest(
	...
	postResponseConverter func(*schemas.KoutakuSpeechStreamResponse) *schemas.KoutakuSpeechStreamResponse,
	logger schemas.Logger,
	postHookSpanFinalizer func(context.Context),
) (chan *schemas.KoutakuStreamChunk, *schemas.KoutakuError) {
	// Create HTTP request for streaming
...
// Returns the response and any error that occurred.
func (provider *OpenAIProvider) Transcription(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuTranscriptionRequest) (*schemas.KoutakuTranscriptionResponse, *schemas.KoutakuError) {
...
func HandleOpenAITranscriptionRequest(
	...
	client *fasthttp.Client,
	url string,
	request *schemas.KoutakuTranscriptionRequest,
	key schemas.Key,
	extraHeaders map[string]string,
	providerName schemas.ModelProvider,
	sendBackRawResponse bool,
	customResponseHandler responseHandler[schemas.KoutakuTranscriptionResponse],
	logger schemas.Logger,
) (*schemas.KoutakuTranscriptionResponse, *schemas.KoutakuError) {
	...
	if lpResult, lpErr, handled := handleOpenAILargePayloadPassthrough(ctx, client, url, key, extraHeaders, providerName, logger); handled {
		...
		if len(lpResult.ResponseBody) > 0 {
			response := &schemas.KoutakuTranscriptionResponse{}
			if err := sonic.Unmarshal(lpResult.ResponseBody, response); err != nil {
				return nil, providerUtils.NewKoutakuOperationError(schemas.ErrProviderResponseUnmarshal, err)
			}
			response.ExtraFields = schemas.KoutakuResponseExtraFields{Latency: lpResult.Latency}
	...
	// Parse OpenAI's transcription response directly into KoutakuTranscribe
	response := &schemas.KoutakuTranscriptionResponse{}
	...
	if request.Params != nil && schemas.IsPlainTextTranscriptionFormat(request.Params.ResponseFormat) {
		...
		_, rawResponse, koutakuErr = customResponseHandler(copiedResponseBody, response, nil, false, sendBackRawResponse)
	} else {
		...
		if sendBackRawResponse {
			if err := sonic.Unmarshal(copiedResponseBody, &rawResponse); err != nil {
				return nil, providerUtils.NewKoutakuOperationError(schemas.ErrProviderRawResponseUnmarshal, err)
			}
		}
	}
...
func (provider *OpenAIProvider) TranscriptionStream(ctx *schemas.KoutakuContext, postHookRunner schemas.PostHookRunner, postHookSpanFinalizer func(context.Context), key schemas.Key, request *schemas.KoutakuTranscriptionRequest) (chan *schemas.KoutakuStreamChunk, *schemas.KoutakuError) {
...
func HandleOpenAITranscriptionStreamRequest(
	...
	providerName schemas.ModelProvider,
	postHookRunner schemas.PostHookRunner,
	customResponseHandler responseHandler[schemas.KoutakuTranscriptionStreamResponse],
	postRequestConverter func(*OpenAITranscriptionRequest) *OpenAITranscriptionRequest,
	postResponseConverter func(*schemas.KoutakuTranscriptionStreamResponse) *schemas.KoutakuTranscriptionStreamResponse,
	logger schemas.Logger,
	postHookSpanFinalizer func(context.Context),
) (chan *schemas.KoutakuStreamChunk, *schemas.KoutakuError) {
	// Use centralized converter
	...
	if koutakuErr := ParseTranscriptionFormDataBodyFromRequest(writer, reqBody, providerName); koutakuErr != nil {
		return nil, koutakuErr
	}
	...
	go func() {
		...
		for {
			...
			var koutakuErr *schemas.KoutakuError
			if customResponseHandler != nil {
				_, _, koutakuErr = customResponseHandler([]byte(jsonData), response, nil, false, false)
				if koutakuErr != nil {
					if sendBackRawResponse {
						koutakuErr.ExtraFields.RawResponse = jsonData
					}
					ctx.SetValue(schemas.KoutakuContextKeyStreamEndIndicator, true)
					providerUtils.ProcessAndSendKoutakuError(ctx, postHookRunner, providerUtils.EnrichError(ctx, koutakuErr, body.Bytes(), []byte(jsonData), false, sendBackRawResponse), responseChan, logger, postHookSpanFinalizer)
					return
				}
			} else {
				// Quick check for error field (allocation-free using sonic.GetFromString)
				if errorNode, _ := sonic.GetFromString(jsonData, "error"); errorNode.Exists() {
					// Only unmarshal when we know there's an error
					var koutakuErrVal schemas.KoutakuError
					if err := sonic.UnmarshalString(jsonData, &koutakuErrVal); err == nil {
						if koutakuErrVal.Error != nil && koutakuErrVal.Error.Message != "" {
							ctx.SetValue(schemas.KoutakuContextKeyStreamEndIndicator, true)
							respBody := append([]byte(nil), resp.Body()...)
							providerUtils.ProcessAndSendKoutakuError(ctx, postHookRunner, providerUtils.EnrichError(ctx, &koutakuErrVal, body.Bytes(), respBody, false, sendBackRawResponse), responseChan, logger, postHookSpanFinalizer)
							return
						}
					}
				}
...
func (provider *OpenAIProvider) ImageGeneration(ctx *schemas.KoutakuContext, key schemas.Key,
...
func HandleOpenAIImageGenerationRequest(
	...
	if lpResult, lpErr, handled := handleOpenAILargePayloadPassthrough(ctx, client, url, key, extraHeaders, providerName, logger); handled {
		...
		if len(lpResult.ResponseBody) > 0 {
			response := &schemas.KoutakuImageGenerationResponse{}
			if err := sonic.Unmarshal(lpResult.ResponseBody, response); err != nil {
				return nil, providerUtils.NewKoutakuOperationError(schemas.ErrProviderResponseUnmarshal, err)
			}
			response.ExtraFields = schemas.KoutakuResponseExtraFields{Latency: lpResult.Latency}
...
func (provider *OpenAIProvider) ImageGenerationStream(
	...
	if request == nil {
		return nil, providerUtils.NewKoutakuOperationError("invalid request: nil", nil)
	}
...
func HandleOpenAIImageGenerationStreaming(
	...
	providerName schemas.ModelProvider,
	postHookRunner schemas.PostHookRunner,
	customRequestConverter func(*schemas.KoutakuImageGenerationRequest) (providerUtils.RequestBodyWithExtraParams, error),
	postRequestConverter func(*OpenAIImageGenerationRequest) *OpenAIImageGenerationRequest,
	postResponseConverter func(*schemas.KoutakuImageGenerationStreamResponse) *schemas.KoutakuImageGenerationStreamResponse,
	logger schemas.Logger,
	postHookSpanFinalizer func(context.Context),
) (chan *schemas.KoutakuStreamChunk, *schemas.KoutakuError) {
	// Set headers
		...
		for {
			...
			if response.Type == "error" {
				...
				if response.Error != nil {
					koutakuErr.Error.Message = response.Error.Message
					if response.Error.Code != nil {
						koutakuErr.Error.Code = response.Error.Code
					}
					if response.Error.Param != nil {
						koutakuErr.Error.Param = response.Error.Param
					}
					if response.Error.Type != nil {
						koutakuErr.Error.Type = response.Error.Type
					}
				}
				ctx.SetValue(schemas.KoutakuContextKeyStreamEndIndicator, true)
			...
			if isCompleted {
				...
				chunk.BackfillParams(&schemas.KoutakuRequest{
...
func (provider *OpenAIProvider) Rerank(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuRerankRequest) (*schemas.KoutakuRerankResponse, *schemas.KoutakuError) {
	return nil, providerUtils.NewUnsupportedOperationError(schemas.RerankRequest, provider.GetProviderKey())
}

// OCR is not supported by the Openai provider.
func (provider *OpenAIProvider) OCR(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuOCRRequest) (*schemas.KoutakuOCRResponse, *schemas.KoutakuError) {
	return nil, providerUtils.NewUnsupportedOperationError(schemas.OCRRequest, provider.GetProviderKey())
}

// VideoGeneration performs a video generation request via the OpenAI API.
func (provider *OpenAIProvider) VideoGeneration(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuVideoGenerationRequest) (*schemas.KoutakuVideoGenerationResponse, *schemas.KoutakuError) {
...
func (provider *OpenAIProvider) VideoRetrieve(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuVideoRetrieveRequest) (*schemas.KoutakuVideoGenerationResponse, *schemas.KoutakuError) {
...
func (provider *OpenAIProvider) VideoDownload(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuVideoDownloadRequest) (*schemas.KoutakuVideoDownloadResponse, *schemas.KoutakuError) {
	...
	return &schemas.KoutakuVideoDownloadResponse{
...
func (provider *OpenAIProvider) VideoDelete(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuVideoDeleteRequest) (*schemas.KoutakuVideoDeleteResponse, *schemas.KoutakuError) {
...
func (provider *OpenAIProvider) VideoList(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuVideoListRequest) (*schemas.KoutakuVideoListResponse, *schemas.KoutakuError) {
...
func HandleOpenAIVideoGenerationRequest(
	...
	client *fasthttp.Client,
	url string,
	request *schemas.KoutakuVideoGenerationRequest,
	key schemas.Key,
	extraHeaders map[string]string,
	providerName schemas.ModelProvider,
	sendBackRawRequest bool,
	...
	if err != nil {
		return nil, providerUtils.NewKoutakuOperationError("failed to convert video generation request to openai format", err)
	}
	if reqBody == nil {
		return nil, providerUtils.NewKoutakuOperationError("video generation input is not provided", nil)
	}
	...
	rawRequest, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(responseBody, response, nil, sendBackRawRequest, sendBackRawResponse)
	if koutakuErr != nil {
		return nil, koutakuErr
	}
...
type VideoDownloadHandler func(ctx *schemas.KoutakuContext, key schemas.Key, req *schemas.KoutakuVideoDownloadRequest) (*schemas.KoutakuVideoDownloadResponse, *schemas.KoutakuError)
...
func HandleOpenAIVideoRetrieveRequest(
	...
	client *fasthttp.Client,
	url string,
	request *schemas.KoutakuVideoRetrieveRequest,
	key schemas.Key,
	extraHeaders map[string]string,
	...
	response := &schemas.KoutakuVideoGenerationResponse{}
	_, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(body, response, nil, sendBackRawRequest, sendBackRawResponse)
	if koutakuErr != nil {
		return nil, koutakuErr
	}
	if response.ID != "" {
	...
	if videoDownloaddHandler != nil {
		downloadVideo, ok := ctx.Value(schemas.KoutakuContextKeyVideoOutputRequested).(bool)
		if ok && downloadVideo && response.Status == schemas.VideoStatusCompleted {
			videoDownloadRequest := &schemas.KoutakuVideoDownloadRequest{
				Provider: providerName,
				ID:       response.ID,
			}
			videoDownloadResponse, koutakuErr := videoDownloaddHandler(ctx, key, videoDownloadRequest)
			if koutakuErr != nil {
				return nil, koutakuErr
			}
...
func HandleOpenAIVideoDeleteRequest(
	...
	sendBackRawResponse bool,
	logger schemas.Logger,
) (*schemas.KoutakuVideoDeleteResponse, *schemas.KoutakuError) {
	// Create request
	req := fasthttp.AcquireRequest()
	resp := fasthttp.AcquireResponse()
	defer fasthttp.ReleaseRequest(req)
	...
	rawRequest, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(body, response, nil, sendBackRawRequest, sendBackRawResponse)
	if koutakuErr != nil {
		return nil, koutakuErr
	}
	if response.ID != "" {
...
func HandleOpenAIVideoListRequest(
	...
	client *fasthttp.Client,
	baseURL string,
	request *schemas.KoutakuVideoListRequest,
	key schemas.Key,
	extraHeaders map[string]string,
	providerName schemas.ModelProvider,
	sendBackRawRequest bool,
	sendBackRawResponse bool,
	logger schemas.Logger,
) (*schemas.KoutakuVideoListResponse, *schemas.KoutakuError) {
	// Create request
	req := fasthttp.AcquireRequest()
	resp := fasthttp.AcquireResponse()
	defer fasthttp.ReleaseRequest(req)
	...
	response := &schemas.KoutakuVideoListResponse{}
	_, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(body, response, nil, sendBackRawRequest, sendBackRawResponse)
	if koutakuErr != nil {
		return nil, koutakuErr
	}
...
func (provider *OpenAIProvider) CountTokens(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuResponsesRequest) (*schemas.KoutakuCountTokensResponse, *schemas.KoutakuError) {
...
func HandleOpenAICountTokensRequest(
	...
	providerName schemas.ModelProvider,
	logger schemas.Logger,
) (*schemas.KoutakuCountTokensResponse, *schemas.KoutakuError) {
	// Create request
	req := fasthttp.AcquireRequest()
	resp := fasthttp.AcquireResponse()
	defer fasthttp.ReleaseRequest(req)
	...
	if lpResult, lpErr, handled := handleOpenAILargePayloadPassthrough(ctx, client, url, key, extraHeaders, providerName, logger); handled {
		...
		if len(lpResult.ResponseBody) > 0 {
			response := &schemas.KoutakuCountTokensResponse{}
			if err := sonic.Unmarshal(lpResult.ResponseBody, response); err != nil {
				return nil, providerUtils.NewKoutakuOperationError(schemas.ErrProviderResponseUnmarshal, err)
			}
			response.ExtraFields = schemas.KoutakuResponseExtraFields{Latency: lpResult.Latency}
...
func (provider *OpenAIProvider) ImageEdit(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuImageEditRequest) (*schemas.KoutakuImageGenerationResponse, *schemas.KoutakuError) {
...
func HandleOpenAIImageEditRequest(
	...
	client *fasthttp.Client,
	url string,
	request *schemas.KoutakuImageEditRequest,
	key schemas.Key,
	extraHeaders map[string]string,
	sendBackRawRequest bool,
	sendBackRawResponse bool,
	...
	if openaiReq == nil {
		return nil, providerUtils.NewKoutakuOperationError("failed to convert request to OpenAI format", nil)
	}
	...
	defer wait()
	if koutakuErr != nil {
		return nil, providerUtils.EnrichError(ctx, koutakuErr, bodyData, nil, sendBackRawRequest, sendBackRawResponse)
	}
	// Extract provider response headers early so they're available on error paths too
	providerResponseHeaders := providerUtils.ExtractProviderResponseHeaders(resp)
	ctx.SetValue(schemas.KoutakuContextKeyProviderResponseHeaders, providerResponseHeaders)
	...
	response := &schemas.KoutakuImageGenerationResponse{}
	rawRequest, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(bodyBytes, response, bodyData, false, sendBackRawResponse)
	if koutakuErr != nil {
		return nil, koutakuErr
	}
	response.ExtraFields.Latency = latency.Milliseconds()
...
func (provider *OpenAIProvider) ImageEditStream(ctx *schemas.KoutakuContext, postHookRunner schemas.PostHookRunner, postHookSpanFinalizer func(context.Context), key schemas.Key, request *schemas.KoutakuImageEditRequest) (chan *schemas.KoutakuStreamChunk, *schemas.KoutakuError) {
	// Check if image generation stream is allowed for this provider
...
func HandleOpenAIImageEditStreamRequest(
	...
	providerName schemas.ModelProvider,
	postHookRunner schemas.PostHookRunner,
	customRequestConverter func(*schemas.KoutakuImageEditRequest) (providerUtils.RequestBodyWithExtraParams, error),
	...
	if reqBody == nil {
		return nil, providerUtils.NewKoutakuOperationError("image edit input is not provided", nil)
	}
	...
	if koutakuErr := parseImageEditFormDataBodyFromRequest(writer, reqBody, providerName); koutakuErr != nil {
		return nil, koutakuErr
	}
		...
		for {
			...
			if errorNode, _ := sonic.GetFromString(jsonData, "error"); errorNode.Exists() {
				...
				if err := sonic.UnmarshalString(jsonData, &koutakuErr); err == nil {
					if koutakuErr.Error != nil && koutakuErr.Error.Message != "" {
						ctx.SetValue(schemas.KoutakuContextKeyStreamEndIndicator, true)
						providerUtils.ProcessAndSendKoutakuError(ctx, postHookRunner, providerUtils.EnrichError(ctx, &koutakuErr, body.Bytes(), nil, sendBackRawRequest, sendBackRawResponse), responseChan, logger, postHookSpanFinalizer)
						return
					}
				}
			}
...
func (provider *OpenAIProvider) ImageVariation(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuImageVariationRequest) (*schemas.KoutakuImageGenerationResponse, *schemas.KoutakuError) {
...
func HandleOpenAIImageVariationRequest(
	...
	client *fasthttp.Client,
	url string,
	request *schemas.KoutakuImageVariationRequest,
	key schemas.Key,
	extraHeaders map[string]string,
	sendBackRawRequest bool,
	sendBackRawResponse bool,
	...
	response := &schemas.KoutakuImageGenerationResponse{}
	_, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(bodyBytes, response, bodyData, sendBackRawRequest, sendBackRawResponse)
	if koutakuErr != nil {
		return nil, koutakuErr
	}
	response.ExtraFields.Latency = latency.Milliseconds()
...
func (provider *OpenAIProvider) FileUpload(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuFileUploadRequest) (*schemas.KoutakuFileUploadResponse, *schemas.KoutakuError) {
	...
	if request.ExpiresAfter != nil {
		if err := writer.WriteField("expires_after[anchor]", request.ExpiresAfter.Anchor); err != nil {
			return nil, providerUtils.NewKoutakuOperationError("failed to write expires_after[anchor] field", err)
		}
		if err := writer.WriteField("expires_after[seconds]", fmt.Sprintf("%d", request.ExpiresAfter.Seconds)); err != nil {
			return nil, providerUtils.NewKoutakuOperationError("failed to write expires_after[seconds] field", err)
		}
	}
	...
	fileResponse := openAIResp.ToKoutakuFileUploadResponse(latency, sendBackRawRequest, sendBackRawResponse, rawRequest, rawResponse)
...
func (provider *OpenAIProvider) FileList(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuFileListRequest) (*schemas.KoutakuFileListResponse, *schemas.KoutakuError) {
	...
	for _, file := range openAIResp.Data {
		files = append(files, schemas.FileObject{
			...
			Status:        ToKoutakuFileStatus(file.Status),
...
func (provider *OpenAIProvider) FileRetrieve(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuFileRetrieveRequest) (*schemas.KoutakuFileRetrieveResponse, *schemas.KoutakuError) {
...
func (provider *OpenAIProvider) FileDelete(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuFileDeleteRequest) (*schemas.KoutakuFileDeleteResponse, *schemas.KoutakuError) {
...
func (provider *OpenAIProvider) FileContent(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuFileContentRequest) (*schemas.KoutakuFileContentResponse, *schemas.KoutakuError) {
...
func (provider *OpenAIProvider) VideoRemix(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuVideoRemixRequest) (*schemas.KoutakuVideoGenerationResponse, *schemas.KoutakuError) {
	...
	if request.Input == nil || request.Input.Prompt == "" {
		return nil, providerUtils.NewKoutakuOperationError("prompt is required", nil)
	}
...
func (provider *OpenAIProvider) BatchCreate(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuBatchCreateRequest) (*schemas.KoutakuBatchCreateResponse, *schemas.KoutakuError) {
	...
	if inputFileID == "" {
		return nil, providerUtils.NewKoutakuOperationError("either input_file_id or requests array is required for OpenAI batch API", nil)
	}

	// Validate that we have an endpoint
	if request.Endpoint == "" {
		return nil, providerUtils.NewKoutakuOperationError("endpoint is required for OpenAI batch API", nil)
	}
...
// Exhausts all pages from one key before moving to the next.
func (provider *OpenAIProvider) BatchList(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuBatchListRequest) (*schemas.KoutakuBatchListResponse, *schemas.KoutakuError) {
...
func (provider *OpenAIProvider) BatchRetrieve(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuBatchRetrieveRequest) (*schemas.KoutakuBatchRetrieveResponse, *schemas.KoutakuError) {
...
func (provider *OpenAIProvider) BatchCancel(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuBatchCancelRequest) (*schemas.KoutakuBatchCancelResponse, *schemas.KoutakuError) {
	...
	for _, key := range keys {
		...
		result := &schemas.KoutakuBatchCancelResponse{
			ID:           openAIResp.ID,
			Object:       openAIResp.Object,
			Status:       ToKoutakuBatchStatus(openAIResp.Status),
...
func (provider *OpenAIProvider) BatchDelete(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuBatchDeleteRequest) (*schemas.KoutakuBatchDeleteResponse, *schemas.KoutakuError) {
...
func (provider *OpenAIProvider) BatchResults(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuBatchResultsRequest) (*schemas.KoutakuBatchResultsResponse, *schemas.KoutakuError) {
...
func (provider *OpenAIProvider) ContainerCreate(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuContainerCreateRequest) (*schemas.KoutakuContainerCreateResponse, *schemas.KoutakuError) {
	...
	if request.Name == "" {
		return nil, providerUtils.NewKoutakuOperationError("invalid request: name is required", nil)
	}
	...
	rawRequest, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(responseBody, &containerResp, jsonBody, providerUtils.ShouldSendBackRawRequest(ctx, provider.sendBackRawRequest), providerUtils.ShouldSendBackRawResponse(ctx, provider.sendBackRawResponse))
	if koutakuErr != nil {
		return nil, koutakuErr
	}

	response := &schemas.KoutakuContainerCreateResponse{
		ID:           containerResp.ID,
...
func (provider *OpenAIProvider) ContainerList(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuContainerListRequest) (*schemas.KoutakuContainerListResponse, *schemas.KoutakuError) {
	if request == nil {
		return nil, providerUtils.NewKoutakuOperationError("invalid request: nil", nil)
	}
	if len(keys) == 0 {
		if provider.customProviderConfig != nil && provider.customProviderConfig.IsKeyLess {
			...
			return nil, providerUtils.NewKoutakuOperationError("provider config not found", nil)
		}
	}
	...
	if !ok {
		// All keys exhausted
		return &schemas.KoutakuContainerListResponse{
			Object:  "list",
	...
	rawRequest, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(responseBody, &listResp, nil, sendBackRawRequest, sendBackRawResponse)
	if koutakuErr != nil {
		return nil, koutakuErr
	}
	...
	response := &schemas.KoutakuContainerListResponse{
...
func (provider *OpenAIProvider) ContainerRetrieve(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuContainerRetrieveRequest) (*schemas.KoutakuContainerRetrieveResponse, *schemas.KoutakuError) {
	if request == nil {
		return nil, providerUtils.NewKoutakuOperationError("invalid request: nil", nil)
	}
	if len(keys) == 0 {
	...
	if request.ContainerID == "" {
		return nil, providerUtils.NewKoutakuOperationError("container_id is required", nil)
	}
	...
	for _, key := range keys {
		...
		rawRequest, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(responseBody, &containerResp, nil, providerUtils.ShouldSendBackRawRequest(ctx, provider.sendBackRawRequest), providerUtils.ShouldSendBackRawResponse(ctx, provider.sendBackRawResponse))
		if koutakuErr != nil {
			fasthttp.ReleaseRequest(req)
			fasthttp.ReleaseResponse(resp)
			lastErr = koutakuErr
		...
		response := &schemas.KoutakuContainerRetrieveResponse{
			ID:           containerResp.ID,
			Object:       containerResp.Object,
			Name:         containerResp.Name,
			CreatedAt:    containerResp.CreatedAt,
...
func (provider *OpenAIProvider) ContainerDelete(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuContainerDeleteRequest) (*schemas.KoutakuContainerDeleteResponse, *schemas.KoutakuError) {
	if request == nil {
		return nil, providerUtils.NewKoutakuOperationError("invalid request: nil", nil)
	}
	if len(keys) == 0 {
	...
	for _, key := range keys {
		...
		rawRequest, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(responseBody, &deleteResp, nil, providerUtils.ShouldSendBackRawRequest(ctx, provider.sendBackRawRequest), providerUtils.ShouldSendBackRawResponse(ctx, provider.sendBackRawResponse))
		if koutakuErr != nil {
			fasthttp.ReleaseRequest(req)
			fasthttp.ReleaseResponse(resp)
			lastErr = koutakuErr
		...
		response := &schemas.KoutakuContainerDeleteResponse{
			ID:      deleteResp.ID,
...
func (provider *OpenAIProvider) ContainerFileCreate(ctx *schemas.KoutakuContext, key schemas.Key, request *schemas.KoutakuContainerFileCreateRequest) (*schemas.KoutakuContainerFileCreateResponse, *schemas.KoutakuError) {
	...
	if request.ContainerID == "" {
		return nil, providerUtils.NewKoutakuOperationError("invalid request: container_id is required", nil)
	}
	...
	if len(request.File) == 0 {
		return nil, providerUtils.NewKoutakuOperationError("invalid request: file is required", nil)
	}
	...
	if err != nil {
		return nil, providerUtils.NewKoutakuOperationError("failed to create multipart form", err)
	}
	if _, err = part.Write(request.File); err != nil {
		return nil, providerUtils.NewKoutakuOperationError("failed to write file to multipart form", err)
	}
	if err := writer.Close(); err != nil {
		return nil, providerUtils.NewKoutakuOperationError("failed to close multipart form", err)
	}
	...
	_, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(responseBody, &fileResp, nil, false, sendBackRawResponse)
	if koutakuErr != nil {
		return nil, koutakuErr
	}

	containerFileCreateResponse := &schemas.KoutakuContainerFileCreateResponse{
		ID:          fileResp.ID,
...
// Uses SerialListHelper for multi-key pagination - exhausts all pages from one key before moving to next.
func (provider *OpenAIProvider) ContainerFileList(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuContainerFileListRequest) (*schemas.KoutakuContainerFileListResponse, *schemas.KoutakuError) {
	if request == nil {
		return nil, providerUtils.NewKoutakuOperationError("invalid request: nil", nil)
	}
	...
	if len(keys) == 0 {
		if provider.customProviderConfig != nil && provider.customProviderConfig.IsKeyLess {
			...
			return nil, providerUtils.NewKoutakuOperationError("no keys provided", nil)
		}
	}
	...
	if !ok {
		// All keys exhausted
		return &schemas.KoutakuContainerFileListResponse{
			Object:  "list",
	...
	containerFileListResponse := &schemas.KoutakuContainerFileListResponse{
		Object:  listResp.Object,
		Data:    listResp.Data,
		FirstID: listResp.FirstID,
		LastID:  listResp.LastID,
...
func (provider *OpenAIProvider) ContainerFileRetrieve(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuContainerFileRetrieveRequest) (*schemas.KoutakuContainerFileRetrieveResponse, *schemas.KoutakuError) {
	if len(keys) == 0 {
		if provider.customProviderConfig != nil && provider.customProviderConfig.IsKeyLess {
			keys = []schemas.Key{{}}
		} else {
	...
	if request.FileID == "" {
		return nil, providerUtils.NewKoutakuOperationError("invalid request: file_id is required", nil)
	}
	...
	for _, key := range keys {
		...
		rawRequest, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(responseBody, &fileResp, nil, sendBackRawRequest, sendBackRawResponse)
		if koutakuErr != nil {
			lastErr = koutakuErr
			fasthttp.ReleaseRequest(req)
			fasthttp.ReleaseResponse(resp)
		...
		containerFileRetrieveResponse := &schemas.KoutakuContainerFileRetrieveResponse{
			ID:          fileResp.ID,
			Object:      fileResp.Object,
			Bytes:       fileResp.Bytes,
			CreatedAt:   fileResp.CreatedAt,
...
func (provider *OpenAIProvider) ContainerFileContent(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuContainerFileContentRequest) (*schemas.KoutakuContainerFileContentResponse, *schemas.KoutakuError) {
	if len(keys) == 0 {
		if provider.customProviderConfig != nil && provider.customProviderConfig.IsKeyLess {
			keys = []schemas.Key{{}}
		} else {
	...
	for _, key := range keys {
		...
		containerFileContentResponse := &schemas.KoutakuContainerFileContentResponse{
			Content:     content,
			ContentType: contentType,
			ExtraFields: schemas.KoutakuResponseExtraFields{
				Latency: latency.Milliseconds(),
...
func (provider *OpenAIProvider) ContainerFileDelete(ctx *schemas.KoutakuContext, keys []schemas.Key, request *schemas.KoutakuContainerFileDeleteRequest) (*schemas.KoutakuContainerFileDeleteResponse, *schemas.KoutakuError) {
	if len(keys) == 0 {
		if provider.customProviderConfig != nil && provider.customProviderConfig.IsKeyLess {
			keys = []schemas.Key{{}}
		} else {
	...
	for _, key := range keys {
		...
		rawRequest, rawResponse, koutakuErr := providerUtils.HandleProviderResponse(responseBody, &deleteResp, nil, sendBackRawRequest, sendBackRawResponse)
		if koutakuErr != nil {
			lastErr = koutakuErr
			fasthttp.ReleaseRequest(req)
			fasthttp.ReleaseResponse(resp)
		...
		containerFileDeleteResponse := &schemas.KoutakuContainerFileDeleteResponse{
			ID:      deleteResp.ID,
			Object:  deleteResp.Object,
			Deleted: deleteResp.Deleted,
			ExtraFields: schemas.KoutakuResponseExtraFields{
