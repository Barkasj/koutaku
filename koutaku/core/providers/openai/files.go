...
// ToKoutakuFileStatus converts OpenAI status to Koutaku status.
func ToKoutakuFileStatus(status string) schemas.FileStatus {
	switch status {
	case "uploaded":
...
// ToKoutakuFileUploadResponse converts OpenAI file response to Koutaku file upload response.
func (r *OpenAIFileResponse) ToKoutakuFileUploadResponse(latency time.Duration, sendBackRawRequest bool, sendBackRawResponse bool, rawRequest interface{}, rawResponse interface{}) *schemas.KoutakuFileUploadResponse {
	resp := &schemas.KoutakuFileUploadResponse{
		...
		Filename:       r.Filename,
		Purpose:        r.Purpose,
		Status:         ToKoutakuFileStatus(r.Status),
...
// ToKoutakuFileRetrieveResponse converts OpenAI file response to Koutaku file retrieve response.
func (r *OpenAIFileResponse) ToKoutakuFileRetrieveResponse(providerName schemas.ModelProvider, latency time.Duration, sendBackRawRequest bool, sendBackRawResponse bool, rawRequest interface{}, rawResponse interface{}) *schemas.KoutakuFileRetrieveResponse {
