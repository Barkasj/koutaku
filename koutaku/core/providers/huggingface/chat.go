...
func ToHuggingFaceChatCompletionRequest(koutakuReq *schemas.KoutakuChatRequest) (*HuggingFaceChatRequest, error) {
	...
	hfReq := &HuggingFaceChatRequest{
		Messages: sanitizeMessagesForHuggingFace(koutakuReq.Input),
	...
	if koutakuReq.Params != nil {
		...
		hfReq.ExtraParams = koutakuReq.Params.ExtraParams
	}
