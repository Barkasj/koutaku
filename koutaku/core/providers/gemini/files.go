...
// ToKoutakuFileStatus converts Gemini file state to Koutaku status.
func ToKoutakuFileStatus(state string) schemas.FileStatus {
	switch state {
	case "PROCESSING":
...
// ToGeminiFileListResponse converts a Koutaku file list response to Gemini format.
func ToGeminiFileListResponse(resp *schemas.KoutakuFileListResponse) *GeminiFileListResponse {
...
// ToGeminiFileRetrieveResponse converts a Koutaku file retrieve response to Gemini format.
func ToGeminiFileRetrieveResponse(resp *schemas.KoutakuFileRetrieveResponse) *GeminiFileResponse {
...
// toGeminiFileState converts Koutaku file status to Gemini state.
...
// ToGeminiFileUploadResponse converts a Koutaku file upload response to Gemini format.
func ToGeminiFileUploadResponse(resp *schemas.KoutakuFileUploadResponse) map[string]interface{} {
