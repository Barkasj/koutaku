...
func (response *GeminiListModelsResponse) ToKoutakuListModelsResponse(providerKey schemas.ModelProvider, allowedModels schemas.WhiteList, blacklistedModels schemas.BlackList, aliases map[string]string, unfiltered bool) *schemas.KoutakuListModelsResponse {
	if response == nil {
		return nil
	}
...
func ToGeminiListModelsResponse(resp *schemas.KoutakuListModelsResponse) *GeminiListModelsResponse {
	if resp == nil {
		return nil
	}
