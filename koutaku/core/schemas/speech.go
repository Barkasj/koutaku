...
type KoutakuSpeechRequest struct {
...
func (r *KoutakuSpeechRequest) GetRawRequestBody() []byte {
	return r.RawRequestBody
}

type KoutakuSpeechResponse struct {
...
func (r *KoutakuSpeechResponse) BackfillParams(request *KoutakuSpeechRequest) {
...
type KoutakuSpeechStreamResponse struct {
...
func (r *KoutakuSpeechStreamResponse) BackfillParams(request *KoutakuSpeechRequest) {
	if r == nil || request == nil || request.Input == nil {
		return
	}
	if r.Usage == nil {
