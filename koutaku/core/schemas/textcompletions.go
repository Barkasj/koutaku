...
// KoutakuTextCompletionRequest is the request struct for text completion requests
type KoutakuTextCompletionRequest struct {
...
func (r *KoutakuTextCompletionRequest) GetRawRequestBody() []byte {
	return r.RawRequestBody
}

// ToKoutakuChatRequest converts a Koutaku text completion request to a Koutaku chat completion request
// This method is discouraged to use, but is useful for litellm fallback flows
func (r *KoutakuTextCompletionRequest) ToKoutakuChatRequest() *KoutakuChatRequest {
...
type KoutakuTextCompletionResponse struct {
	ID                string                     `json:"id"`
