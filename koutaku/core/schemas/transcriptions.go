...
type KoutakuTranscriptionRequest struct {
...
func (r *KoutakuTranscriptionRequest) GetRawRequestBody() []byte {
	return r.RawRequestBody
}

type KoutakuTranscriptionResponse struct {
...
func (r *KoutakuTranscriptionResponse) BackfillParams(req *KoutakuTranscriptionRequest) {
...
// KoutakuTranscriptionStreamResponse represents streaming specific fields only
type KoutakuTranscriptionStreamResponse struct {
