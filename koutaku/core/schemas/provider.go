...
const (
	...
	DefaultStreamIdleTimeoutInSeconds = 60 // Idle timeout per stream chunk — if no data for this many seconds, koutaku closes the connection
...
const (
	...
	ErrRequestBodyConversion        = "failed to convert koutaku request to the expected provider request body"
...
type CustomProviderConfig struct {
	CustomProviderKey    string                 `json:"-"`                                // Custom provider key, internally set by Koutaku
...
type ProviderConfig struct {
	...
	// Logger instance, can be provided by the user or koutaku default logger is used if not provided
	Logger                  Logger                `json:"-"`
	ProxyConfig             *ProxyConfig          `json:"proxy_config,omitempty"`     // Proxy configuration
	SendBackRawRequest      bool                  `json:"send_back_raw_request"`      // Send raw request back in the koutaku response (default: false)
	SendBackRawResponse     bool                  `json:"send_back_raw_response"`     // Send raw response back in the koutaku response (default: false)
...
type PostHookRunner func(ctx *KoutakuContext, result *KoutakuResponse, err *KoutakuError) (*KoutakuResponse, *KoutakuError)
...
type Provider interface {
	...
	ListModels(ctx *KoutakuContext, keys []Key, request *KoutakuListModelsRequest) (*KoutakuListModelsResponse, *KoutakuError)
	// TextCompletion performs a text completion request
	TextCompletion(ctx *KoutakuContext, key Key, request *KoutakuTextCompletionRequest) (*KoutakuTextCompletionResponse, *KoutakuError)
	...
	TextCompletionStream(ctx *KoutakuContext, postHookRunner PostHookRunner, postHookSpanFinalizer func(context.Context), key Key, request *KoutakuTextCompletionRequest) (chan *KoutakuStreamChunk, *KoutakuError)
	// ChatCompletion performs a chat completion request
	ChatCompletion(ctx *KoutakuContext, key Key, request *KoutakuChatRequest) (*KoutakuChatResponse, *KoutakuError)
	// ChatCompletionStream performs a chat completion stream request
	ChatCompletionStream(ctx *KoutakuContext, postHookRunner PostHookRunner, postHookSpanFinalizer func(context.Context), key Key, request *KoutakuChatRequest) (chan *KoutakuStreamChunk, *KoutakuError)
	...
	Responses(ctx *KoutakuContext, key Key, request *KoutakuResponsesRequest) (*KoutakuResponsesResponse, *KoutakuError)
	...
	ResponsesStream(ctx *KoutakuContext, postHookRunner PostHookRunner, postHookSpanFinalizer func(context.Context), key Key, request *KoutakuResponsesRequest) (chan *KoutakuStreamChunk, *KoutakuError)
	// CountTokens performs a count tokens request
	CountTokens(ctx *KoutakuContext, key Key, request *KoutakuResponsesRequest) (*KoutakuCountTokensResponse, *KoutakuError)
	// Embedding performs an embedding request
	Embedding(ctx *KoutakuContext, key Key, request *KoutakuEmbeddingRequest) (*KoutakuEmbeddingResponse, *KoutakuError)
	// Rerank performs a rerank request to reorder documents by relevance to a query
	Rerank(ctx *KoutakuContext, key Key, request *KoutakuRerankRequest) (*KoutakuRerankResponse, *KoutakuError)
	// OCR performs an optical character recognition request on a document
	OCR(ctx *KoutakuContext, key Key, request *KoutakuOCRRequest) (*KoutakuOCRResponse, *KoutakuError)
	// Speech performs a text to speech request
	Speech(ctx *KoutakuContext, key Key, request *KoutakuSpeechRequest) (*KoutakuSpeechResponse, *KoutakuError)
	// SpeechStream performs a text to speech stream request
	SpeechStream(ctx *KoutakuContext, postHookRunner PostHookRunner, postHookSpanFinalizer func(context.Context), key Key, request *KoutakuSpeechRequest) (chan *KoutakuStreamChunk, *KoutakuError)
	// Transcription performs a transcription request
	Transcription(ctx *KoutakuContext, key Key, request *KoutakuTranscriptionRequest) (*KoutakuTranscriptionResponse, *KoutakuError)
	// TranscriptionStream performs a transcription stream request
	TranscriptionStream(ctx *KoutakuContext, postHookRunner PostHookRunner, postHookSpanFinalizer func(context.Context), key Key, request *KoutakuTranscriptionRequest) (chan *KoutakuStreamChunk, *KoutakuError)
	// ImageGeneration performs an image generation request
	ImageGeneration(ctx *KoutakuContext, key Key, request *KoutakuImageGenerationRequest) (
		*KoutakuImageGenerationResponse, *KoutakuError)
	// ImageGenerationStream performs an image generation stream request
	ImageGenerationStream(ctx *KoutakuContext, postHookRunner PostHookRunner, postHookSpanFinalizer func(context.Context), key Key,
		request *KoutakuImageGenerationRequest) (chan *KoutakuStreamChunk, *KoutakuError)
	// ImageEdit performs an image edit request
	ImageEdit(ctx *KoutakuContext, key Key, request *KoutakuImageEditRequest) (*KoutakuImageGenerationResponse, *KoutakuError)
	// ImageEditStream performs an image edit stream request
	ImageEditStream(ctx *KoutakuContext, postHookRunner PostHookRunner, postHookSpanFinalizer func(context.Context), key Key,
		request *KoutakuImageEditRequest) (chan *KoutakuStreamChunk, *KoutakuError)
	// ImageVariation performs an image variation request
	ImageVariation(ctx *KoutakuContext, key Key, request *KoutakuImageVariationRequest) (*KoutakuImageGenerationResponse, *KoutakuError)
	// VideoGeneration performs a video generation request
	VideoGeneration(ctx *KoutakuContext, key Key, request *KoutakuVideoGenerationRequest) (*KoutakuVideoGenerationResponse, *KoutakuError)
	// VideoRetrieve retrieves a video from the provider
	VideoRetrieve(ctx *KoutakuContext, key Key, request *KoutakuVideoRetrieveRequest) (*KoutakuVideoGenerationResponse, *KoutakuError)
	// VideoDownload downloads a video from the provider
	VideoDownload(ctx *KoutakuContext, key Key, request *KoutakuVideoDownloadRequest) (*KoutakuVideoDownloadResponse, *KoutakuError)
	// VideoDelete deletes a video from the provider
	VideoDelete(ctx *KoutakuContext, key Key, request *KoutakuVideoDeleteRequest) (*KoutakuVideoDeleteResponse, *KoutakuError)
	// VideoList lists videos from the provider
	VideoList(ctx *KoutakuContext, key Key, request *KoutakuVideoListRequest) (*KoutakuVideoListResponse, *KoutakuError)
	// VideoRemix remixes a video from the provider
	VideoRemix(ctx *KoutakuContext, key Key, request *KoutakuVideoRemixRequest) (*KoutakuVideoGenerationResponse, *KoutakuError)
	// BatchCreate creates a new batch job for asynchronous processing
	BatchCreate(ctx *KoutakuContext, key Key, request *KoutakuBatchCreateRequest) (*KoutakuBatchCreateResponse, *KoutakuError)
	// BatchList lists batch jobs
	BatchList(ctx *KoutakuContext, keys []Key, request *KoutakuBatchListRequest) (*KoutakuBatchListResponse, *KoutakuError)
	// BatchRetrieve retrieves a specific batch job
	BatchRetrieve(ctx *KoutakuContext, keys []Key, request *KoutakuBatchRetrieveRequest) (*KoutakuBatchRetrieveResponse, *KoutakuError)
	// BatchCancel cancels a batch job
	BatchCancel(ctx *KoutakuContext, keys []Key, request *KoutakuBatchCancelRequest) (*KoutakuBatchCancelResponse, *KoutakuError)
	// BatchDelete deletes a batch job
	BatchDelete(ctx *KoutakuContext, keys []Key, request *KoutakuBatchDeleteRequest) (*KoutakuBatchDeleteResponse, *KoutakuError)
	// BatchResults retrieves results from a completed batch job
	BatchResults(ctx *KoutakuContext, keys []Key, request *KoutakuBatchResultsRequest) (*KoutakuBatchResultsResponse, *KoutakuError)
	// FileUpload uploads a file to the provider
	FileUpload(ctx *KoutakuContext, key Key, request *KoutakuFileUploadRequest) (*KoutakuFileUploadResponse, *KoutakuError)
	// FileList lists files from the provider
	FileList(ctx *KoutakuContext, keys []Key, request *KoutakuFileListRequest) (*KoutakuFileListResponse, *KoutakuError)
	// FileRetrieve retrieves file metadata from the provider
	FileRetrieve(ctx *KoutakuContext, keys []Key, request *KoutakuFileRetrieveRequest) (*KoutakuFileRetrieveResponse, *KoutakuError)
	// FileDelete deletes a file from the provider
	FileDelete(ctx *KoutakuContext, keys []Key, request *KoutakuFileDeleteRequest) (*KoutakuFileDeleteResponse, *KoutakuError)
	// FileContent downloads file content from the provider
	FileContent(ctx *KoutakuContext, keys []Key, request *KoutakuFileContentRequest) (*KoutakuFileContentResponse, *KoutakuError)
	// ContainerCreate creates a new container
	ContainerCreate(ctx *KoutakuContext, key Key, request *KoutakuContainerCreateRequest) (*KoutakuContainerCreateResponse, *KoutakuError)
	// ContainerList lists containers
	ContainerList(ctx *KoutakuContext, keys []Key, request *KoutakuContainerListRequest) (*KoutakuContainerListResponse, *KoutakuError)
	// ContainerRetrieve retrieves a specific container
	ContainerRetrieve(ctx *KoutakuContext, keys []Key, request *KoutakuContainerRetrieveRequest) (*KoutakuContainerRetrieveResponse, *KoutakuError)
	// ContainerDelete deletes a container
	ContainerDelete(ctx *KoutakuContext, keys []Key, request *KoutakuContainerDeleteRequest) (*KoutakuContainerDeleteResponse, *KoutakuError)
	// ContainerFileCreate creates a file in a container
	ContainerFileCreate(ctx *KoutakuContext, key Key, request *KoutakuContainerFileCreateRequest) (*KoutakuContainerFileCreateResponse, *KoutakuError)
	// ContainerFileList lists files in a container
	ContainerFileList(ctx *KoutakuContext, keys []Key, request *KoutakuContainerFileListRequest) (*KoutakuContainerFileListResponse, *KoutakuError)
	// ContainerFileRetrieve retrieves a file from a container
	ContainerFileRetrieve(ctx *KoutakuContext, keys []Key, request *KoutakuContainerFileRetrieveRequest) (*KoutakuContainerFileRetrieveResponse, *KoutakuError)
	// ContainerFileContent retrieves the content of a file from a container
	ContainerFileContent(ctx *KoutakuContext, keys []Key, request *KoutakuContainerFileContentRequest) (*KoutakuContainerFileContentResponse, *KoutakuError)
	// ContainerFileDelete deletes a file from a container
	ContainerFileDelete(ctx *KoutakuContext, keys []Key, request *KoutakuContainerFileDeleteRequest) (*KoutakuContainerFileDeleteResponse, *KoutakuError)
	// Passthrough executes a non-streaming passthrough; body is fully buffered.
	Passthrough(ctx *KoutakuContext, key Key, req *KoutakuPassthroughRequest) (*KoutakuPassthroughResponse, *KoutakuError)
	// PassthroughStream executes a streaming passthrough, forwarding raw response bytes as KoutakuStreamChunks.
	PassthroughStream(ctx *KoutakuContext, postHookRunner PostHookRunner, postHookSpanFinalizer func(context.Context), key Key, req *KoutakuPassthroughRequest) (chan *KoutakuStreamChunk, *KoutakuError)
}
