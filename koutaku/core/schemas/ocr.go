...
// KoutakuOCRRequest represents a request to perform OCR on a document.
type KoutakuOCRRequest struct {
...
func (r *KoutakuOCRRequest) GetRawRequestBody() []byte {
...
// KoutakuOCRResponse represents the response from an OCR request.
type KoutakuOCRResponse struct {
	Model               string                     `json:"model"`
