...
// MCPConfig represents the configuration for MCP integration in Koutaku.
...
type MCPConfig struct {
	...
	FetchNewRequestIDFunc func(ctx *KoutakuContext) string `json:"-"`
...
// It is returned by GetMCPClients() method in koutaku.
