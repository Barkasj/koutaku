...
// KoutakuFileUploadRequest represents a request to upload a file.
type KoutakuFileUploadRequest struct {
...
// KoutakuFileUploadResponse represents the response from uploading a file.
type KoutakuFileUploadResponse struct {
	ID            string      `json:"id"`
	Object        string      `json:"object,omitempty"` // "file"
	Bytes         int64       `json:"bytes"`
	CreatedAt     int64       `json:"created_at"`
...
// KoutakuFileListRequest represents a request to list files.
type KoutakuFileListRequest struct {
	Provider ModelProvider `json:"provider"`
	Model    *string       `json:"model"`
...
func (request *KoutakuFileListRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}

// KoutakuFileListResponse represents the response from listing files.
type KoutakuFileListResponse struct {
...
// KoutakuFileRetrieveRequest represents a request to retrieve file metadata.
type KoutakuFileRetrieveRequest struct {
	Provider ModelProvider `json:"provider"`
	Model    *string       `json:"model"`
...
// GetRawRequestBody returns the raw request body.
func (request *KoutakuFileRetrieveRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}

// KoutakuFileRetrieveResponse represents the response from retrieving file metadata.
type KoutakuFileRetrieveResponse struct {
	ID            string      `json:"id"`
	Object        string      `json:"object,omitempty"` // "file"
	Bytes         int64       `json:"bytes"`
	CreatedAt     int64       `json:"created_at"`
...
// KoutakuFileDeleteRequest represents a request to delete a file.
type KoutakuFileDeleteRequest struct {
	Provider ModelProvider `json:"provider"`
	Model    *string       `json:"model"`
...
// GetRawRequestBody returns the raw request body.
func (request *KoutakuFileDeleteRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}

// KoutakuFileDeleteResponse represents the response from deleting a file.
type KoutakuFileDeleteResponse struct {
	ID      string `json:"id"`
	Object  string `json:"object,omitempty"` // "file"
...
// KoutakuFileContentRequest represents a request to download file content.
type KoutakuFileContentRequest struct {
	Provider ModelProvider `json:"provider"`
	Model    *string       `json:"model"`
...
// GetRawRequestBody returns the raw request body.
func (request *KoutakuFileContentRequest) GetRawRequestBody() []byte {
	return request.RawRequestBody
}

// KoutakuFileContentResponse represents the response from downloading file content.
type KoutakuFileContentResponse struct {
