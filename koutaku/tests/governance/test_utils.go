...
// APIRequest represents a request to the Koutaku API
...
// APIResponse represents a response from the Koutaku API
...
// MakeRequest makes an HTTP request to the Koutaku API
