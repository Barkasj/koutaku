...
# Koutaku V1 Fallbacks Newman Test Runner
...
COLLECTION="collections/koutaku-v1-fallbacks.postman_collection.json"
...
echo -e "${GREEN}==============================================${NC}"
echo -e "${GREEN}Koutaku V1 Fallbacks Test Runner${NC}"
echo -e "${GREEN}==============================================${NC}"
echo ""
