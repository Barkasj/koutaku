...
# Koutaku V1 Rate Limit Newman Test Runner
...
COLLECTION="collections/koutaku-v1-rate-limit.postman_collection.json"
...
echo -e "${GREEN}==============================================${NC}"
echo -e "${GREEN}Koutaku V1 Rate Limit Test Runner${NC}"
echo -e "${GREEN}==============================================${NC}"
echo ""
