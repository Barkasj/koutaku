...
# Koutaku V1 VK Routing Newman Test Runner
...
COLLECTION="collections/koutaku-v1-vk-routing.postman_collection.json"
...
echo -e "${GREEN}==============================================${NC}"
echo -e "${GREEN}Koutaku V1 VK Routing Test Runner${NC}"
echo -e "${GREEN}==============================================${NC}"
echo ""
