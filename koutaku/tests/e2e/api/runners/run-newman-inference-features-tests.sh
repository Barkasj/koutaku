...
# Koutaku V1 Inference with Koutaku Features Newman Test Runner
...
COLLECTION="collections/koutaku-v1-inference-features.postman_collection.json"
...
echo -e "${GREEN}==============================================${NC}"
echo -e "${GREEN}Koutaku V1 Inference with Koutaku Features Test Runner${NC}"
echo -e "${GREEN}==============================================${NC}"
echo ""
