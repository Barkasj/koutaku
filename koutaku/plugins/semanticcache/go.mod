module github.com/koutaku/koutaku/plugins/semanticcache
...
require (
	...
	github.com/koutaku/koutaku/plugins/mocker v1.5.3
)
...
replace github.com/koutaku/koutaku/plugins/mocker => ../mocker
