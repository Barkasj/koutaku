...
func TestSemanticCacheBasicFlow(t *testing.T) {
	...
	// Test request
	request := &schemas.KoutakuRequest{
			...
			Input: []schemas.ChatMessage{
				{
					...
					Content: &schemas.ChatMessageContent{
						ContentStr: koutaku.Ptr("Hello, world!"),
					},
				},
			},
			...
			Choices: []schemas.KoutakuResponseChoice{
				{
					...
					ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
						Message: &schemas.ChatMessage{
							...
							Content: &schemas.ChatMessageContent{
								ContentStr: koutaku.Ptr("Hello! How can I help you today?"),
							}},
					},
				},
			},
	...
	ctx2 := schemas.NewKoutakuContext(context.Background(), schemas.NoDeadline)
...
func TestSemanticCacheStrictFiltering(t *testing.T) {
	...
	// Base request
	baseRequest := &schemas.KoutakuRequest{
		RequestType: schemas.ChatCompletionRequest,
		ChatRequest: &schemas.KoutakuChatRequest{
			Provider: schemas.OpenAI,
			Model:    "gpt-4o-mini",
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: koutaku.Ptr("What is the weather like?"),
					},
				},
			},
			Params: &schemas.ChatParameters{
			...
			Choices: []schemas.KoutakuResponseChoice{
				{
					ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
						Message: &schemas.ChatMessage{
							Role: schemas.ChatMessageRoleAssistant,
							Content: &schemas.ChatMessageContent{
								ContentStr: koutaku.Ptr("It's sunny today!"),
							}},
					},
				},
			},
	...
	modifiedRequest := &schemas.KoutakuRequest{
		RequestType: schemas.ChatCompletionRequest,
		ChatRequest: &schemas.KoutakuChatRequest{
			Provider: schemas.OpenAI,
			Model:    "gpt-4o-mini",
			...
			Params: &schemas.ChatParameters{
				Temperature:         koutaku.Ptr(0.5), // Different temperature
				MaxCompletionTokens: koutaku.Ptr(100),
			},
		},
	}
	...
	ctx3 := schemas.NewKoutakuContext(context.Background(), schemas.NoDeadline)
	ctx3.SetValue(CacheKey, "test-cache-enabled")

	modifiedRequest2 := &schemas.KoutakuRequest{
		RequestType: schemas.ChatCompletionRequest,
		ChatRequest: &schemas.KoutakuChatRequest{
			Provider: schemas.OpenAI,
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: koutaku.Ptr("Tell me a short story"),
					},
				},
			},
			Params: &schemas.ChatParameters{
				Temperature: koutaku.Ptr(0.8),
			},
		},
	}
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: koutaku.Ptr("Test message"),
					},
				},
			},
		},
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: koutaku.Ptr("TTL test message"),
					},
				},
			},
		},
			...
			Choices: []schemas.KoutakuResponseChoice{
				{
					ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
						Message: &schemas.ChatMessage{
							Role: "assistant",
							Content: &schemas.ChatMessageContent{
								ContentStr: koutaku.Ptr("TTL test response"),
							},
						},
					},
				},
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: koutaku.Ptr("Threshold test message"),
					},
				},
			},
		},
...
func TestSemanticCache_ProviderModelCachingFlags(t *testing.T) {
	...
	setup.Config.CacheByProvider = koutaku.Ptr(false)
	setup.Config.CacheByModel = koutaku.Ptr(false)

	ctx := schemas.NewKoutakuContext(context.Background(), schemas.NoDeadline)
	ctx.SetValue(CacheKey, "test-cache-enabled")

	request1 := &schemas.KoutakuRequest{
		RequestType: schemas.ChatCompletionRequest,
		ChatRequest: &schemas.KoutakuChatRequest{
			Provider: schemas.OpenAI,
			Model:    "gpt-4o-mini",
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: koutaku.Ptr("Provider model flags test"),
					},
				},
			},
		},
			...
			Choices: []schemas.KoutakuResponseChoice{
				{
					ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
						Message: &schemas.ChatMessage{
							Role: "assistant",
							Content: &schemas.ChatMessageContent{
								ContentStr: koutaku.Ptr("Provider model test response"),
							},
						},
					},
				},
	...
	request2 := &schemas.KoutakuRequest{
		RequestType: schemas.ChatCompletionRequest,
		ChatRequest: &schemas.KoutakuChatRequest{
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: koutaku.Ptr("Provider model flags test"), // Same content
					},
				},
			},
		},
			...
			Input: []schemas.ChatMessage{
				{
					Role: schemas.ChatMessageRoleUser,
					Content: &schemas.ChatMessageContent{
						ContentStr: koutaku.Ptr("Edge case test"),
					},
				},
			},
		},
