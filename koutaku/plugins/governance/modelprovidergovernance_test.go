...
func TestPreLLMHook_ModelProviderPass_VirtualKeyBudgetExceeded(t *testing.T) {
	...
	parentCtx := context.WithValue(context.Background(), schemas.KoutakuContextKeyVirtualKey, "sk-bf-test")
	parentCtx = context.WithValue(parentCtx, schemas.KoutakuContextKeyRequestID, "req-1")
	ctx := schemas.NewKoutakuContext(parentCtx, schemas.NoDeadline)
	req := &schemas.KoutakuRequest{
		RequestType: schemas.ChatCompletionRequest,
		ChatRequest: &schemas.KoutakuChatRequest{
			Provider: schemas.OpenAI,
...
func TestPreLLMHook_ModelProviderPass_VirtualKeyNotFound(t *testing.T) {
	...
	parentCtx := context.WithValue(context.Background(), schemas.KoutakuContextKeyVirtualKey, "sk-bf-nonexistent")
	parentCtx = context.WithValue(parentCtx, schemas.KoutakuContextKeyRequestID, "req-1")
	ctx := schemas.NewKoutakuContext(parentCtx, schemas.NoDeadline)
	req := &schemas.KoutakuRequest{
		RequestType: schemas.ChatCompletionRequest,
...
func TestPostHook_UpdatesProviderBudgetUsage_NoVirtualKey(t *testing.T) {
	...
	parentCtx1 := context.WithValue(context.Background(), schemas.KoutakuContextKeyRequestID, "req-1")
	ctx1 := schemas.NewKoutakuContext(parentCtx1, schemas.NoDeadline)
	req1 := &schemas.KoutakuRequest{
		RequestType: schemas.ChatCompletionRequest,
		ChatRequest: &schemas.KoutakuChatRequest{
			Provider: schemas.OpenAI,
			Model:    "gpt-4",
	...
	result1 := &schemas.KoutakuResponse{
	...
	parentCtx2 := context.WithValue(context.Background(), schemas.KoutakuContextKeyRequestID, "req-2")
	ctx2 := schemas.NewKoutakuContext(parentCtx2, schemas.NoDeadline)
	req2 := &schemas.KoutakuRequest{
		RequestType: schemas.ChatCompletionRequest,
		ChatRequest: &schemas.KoutakuChatRequest{
			Provider: schemas.OpenAI,
			Model:    "gpt-4",
