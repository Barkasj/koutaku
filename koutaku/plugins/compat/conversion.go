...
func applyParameterConversion(req *schemas.KoutakuRequest) {
	if req == nil {
		return
	}
...
func flattenNamespaceTools(req *schemas.KoutakuResponsesRequest) {
...
func normalizeDeveloperRoleForChatRequest(req *schemas.KoutakuChatRequest) {
