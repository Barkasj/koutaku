...
func (p *MockerPlugin) HTTPTransportPreHook(ctx *schemas.KoutakuContext, req *schemas.HTTPRequest) (*schemas.HTTPResponse, error) {
	return nil, nil
}

// HTTPTransportPostHook is not used for this plugin
func (p *MockerPlugin) HTTPTransportPostHook(ctx *schemas.KoutakuContext, req *schemas.HTTPRequest, resp *schemas.HTTPResponse) error {
	return nil
}

// HTTPTransportStreamChunkHook passes through streaming chunks unchanged
func (p *MockerPlugin) HTTPTransportStreamChunkHook(ctx *schemas.KoutakuContext, req *schemas.HTTPRequest, chunk *schemas.KoutakuStreamChunk) (*schemas.KoutakuStreamChunk, error) {
	return chunk, nil
}
...
func (p *MockerPlugin) PreLLMHook(ctx *schemas.KoutakuContext, req *schemas.KoutakuRequest) (*schemas.KoutakuRequest, *schemas.LLMPluginShortCircuit, error) {
	// Skip processing if plugin is disabled
	if !p.config.Enabled {
		return req, nil, nil
	}

	skipMocker, ok := ctx.Value(schemas.KoutakuContextKey("skip-mocker")).(bool)
	if ok && skipMocker {
		return req, nil, nil
	}
	...
	var modifiedReq *schemas.KoutakuRequest
	...
	if shortCircuit != nil && shortCircuit.Response != nil && koutaku.IsStreamRequestType(req.RequestType) {
...
func (p *MockerPlugin) PostLLMHook(ctx *schemas.KoutakuContext, result *schemas.KoutakuResponse, err *schemas.KoutakuError) (*schemas.KoutakuResponse, *schemas.KoutakuError, error) {
...
func (p *MockerPlugin) findMatchingCompiledRule(req *schemas.KoutakuRequest) *compiledRule {
...
func (p *MockerPlugin) matchesConditionsFast(req *schemas.KoutakuRequest, conditions *Conditions, compiledRegex *regexp.Regexp) bool {
...
func (p *MockerPlugin) extractMessageContentFast(req *schemas.KoutakuRequest) string {
...
func (p *MockerPlugin) calculateRequestSizeFast(req *schemas.KoutakuRequest) int {
	provider, model, _ := req.GetRequestFields()
...
func (p *MockerPlugin) generateSuccessShortCircuit(req *schemas.KoutakuRequest, response *Response, startTime time.Time) (*schemas.KoutakuRequest, *schemas.LLMPluginShortCircuit, error) {
	if response.Content == nil {
		return req, nil, nil
	}
	...
	if req.RequestType == schemas.ChatCompletionRequest || req.RequestType == schemas.ChatCompletionStreamRequest {
		...
		mockResponse.ResponsesResponse = &schemas.KoutakuResponsesResponse{
		...
		mockResponse.ResponsesStreamResponse = &schemas.KoutakuResponsesStreamResponse{
...
func (p *MockerPlugin) generateErrorShortCircuit(req *schemas.KoutakuRequest, response *Response) (*schemas.KoutakuRequest, *schemas.LLMPluginShortCircuit, error) {
	if response.Error == nil {
		return req, nil, nil
	}
	...
	// Create mock error
	mockError := &schemas.KoutakuError{
...
func (p *MockerPlugin) handleDefaultBehavior(req *schemas.KoutakuRequest) (*schemas.KoutakuRequest, *schemas.LLMPluginShortCircuit, error) {
	provider, model, _ := req.GetRequestFields()
					...
					Choices: []schemas.KoutakuResponseChoice{
						{
							...
							ChatNonStreamResponseChoice: &schemas.ChatNonStreamResponseChoice{
								Message: &schemas.ChatMessage{
									Role: schemas.ChatMessageRoleAssistant,
									Content: &schemas.ChatMessageContent{
										ContentStr: koutaku.Ptr("Mock plugin default response"),
									},
								},
							},
							FinishReason: &finishReason,
...
func (p *MockerPlugin) applyTemplate(template string, req *schemas.KoutakuRequest) string {
	provider, model, _ := req.GetRequestFields()
