// Package configstore provides a persistent configuration store for Koutaku.
package configstore
...
type ConfigStore interface {
	...
	// Per-user OAuth Authorization Server CRUD (Koutaku as OAuth server)
	...
	// (identified by gateway_session_id) to the real Koutaku session token, and sets VirtualKeyID/UserID on each record.
