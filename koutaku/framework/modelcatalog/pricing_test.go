...
func chatPricing(input, output float64) configstoreTables.TableModelPricing {
	return configstoreTables.TableModelPricing{
		...
		Mode:               "chat",
		InputCostPerToken:  koutaku.Ptr(input),
		OutputCostPerToken: koutaku.Ptr(output),
	}
}
...
// makeChatResponse builds a minimal KoutakuResponse for a chat completion.
func makeChatResponse(provider schemas.ModelProvider, model string, usage *schemas.KoutakuLLMUsage) *schemas.KoutakuResponse {
	return &schemas.KoutakuResponse{
...
// makeEmbeddingResponse builds a minimal KoutakuResponse for an embedding request.
func makeEmbeddingResponse(provider schemas.ModelProvider, model string, usage *schemas.KoutakuLLMUsage) *schemas.KoutakuResponse {
	return &schemas.KoutakuResponse{
		EmbeddingResponse: &schemas.KoutakuEmbeddingResponse{
			Usage: usage,
			ExtraFields: schemas.KoutakuResponseExtraFields{
...
// makeRerankResponse builds a minimal KoutakuResponse for a rerank request.
func makeRerankResponse(provider schemas.ModelProvider, model string, usage *schemas.KoutakuLLMUsage) *schemas.KoutakuResponse {
	return &schemas.KoutakuResponse{
		RerankResponse: &schemas.KoutakuRerankResponse{
			Usage: usage,
			ExtraFields: schemas.KoutakuResponseExtraFields{
...
// makeImageResponse builds a minimal KoutakuResponse for an image generation request.
func makeImageResponse(provider schemas.ModelProvider, model string, usage *schemas.ImageUsage) *schemas.KoutakuResponse {
	return &schemas.KoutakuResponse{
		ImageGenerationResponse: &schemas.KoutakuImageGenerationResponse{
			Usage: usage,
			ExtraFields: schemas.KoutakuResponseExtraFields{
...
func TestComputeTextCost_WithCachedPromptTokens(t *testing.T) {
	...
	p.CacheReadInputTokenCost = koutaku.Ptr(0.0000003)
	p.CacheCreationInputTokenCost = koutaku.Ptr(0.00000375)
...
func TestComputeTextCost_Tiered200k(t *testing.T) {
	...
	p := chatPricing(0.000003, 0.000015)
	p.InputCostPerTokenAbove200kTokens = koutaku.Ptr(0.000006)
	p.OutputCostPerTokenAbove200kTokens = koutaku.Ptr(0.00003)
...
func TestComputeTextCost_SearchQueryCost(t *testing.T) {
	p := chatPricing(0.000003, 0.000015)
	p.SearchContextCostPerQuery = koutaku.Ptr(0.01) // $0.01 per search query
...
func TestComputeEmbeddingCost_Basic(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:  koutaku.Ptr(0.0000001),
		OutputCostPerToken: koutaku.Ptr(0.0),
	}
	usage := &schemas.KoutakuLLMUsage{
		PromptTokens: 5000,
		TotalTokens:  5000,
...
func TestComputeRerankCost_Basic(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:  koutaku.Ptr(0.000001),
		OutputCostPerToken: koutaku.Ptr(0.000002),
	}
	usage := &schemas.KoutakuLLMUsage{
		PromptTokens:     2000,
...
func TestComputeRerankCost_WithSearchCost(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:         koutaku.Ptr(0.0),
		OutputCostPerToken:        koutaku.Ptr(0.0),
		SearchContextCostPerQuery: koutaku.Ptr(0.001),
	}
	numQueries := 5
	usage := &schemas.KoutakuLLMUsage{
		CompletionTokensDetails: &schemas.ChatCompletionTokensDetails{
...
func TestComputeSpeechCost_TokensPreferredOverDuration(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:   koutaku.Ptr(0.0000025),
		OutputCostPerToken:  koutaku.Ptr(0.00001),
		OutputCostPerSecond: koutaku.Ptr(0.00025),
	}
	seconds := 60
	usage := &schemas.KoutakuLLMUsage{
		PromptTokens:     100,
...
func TestComputeSpeechCost_OutputFallsBackToPerSecond(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:   koutaku.Ptr(0.000001),
		OutputCostPerToken:  koutaku.Ptr(0.000002),
		OutputCostPerSecond: koutaku.Ptr(0.0001),
	}
	seconds := 120
	usage := &schemas.KoutakuLLMUsage{PromptTokens: 500}
	cost := computeSpeechCost(&p, usage, &seconds, 0, serviceTier{})
...
func TestComputeSpeechCost_OutputAudioTokenRate(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:       koutaku.Ptr(0.000001),
		OutputCostPerToken:      koutaku.Ptr(0.000002),
		OutputCostPerAudioToken: koutaku.Ptr(0.00005),
	}
	usage := &schemas.KoutakuLLMUsage{
		PromptTokens:     200,
		CompletionTokens: 100,
...
func TestComputeTranscriptionCost_DurationBased(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:  koutaku.Ptr(0.0),
		OutputCostPerToken: koutaku.Ptr(0.0),
		InputCostPerSecond: koutaku.Ptr(0.00010278),
	}
...
func TestComputeTranscriptionCost_AudioTokenDetails(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:      koutaku.Ptr(0.000005),
		OutputCostPerToken:     koutaku.Ptr(0.000015),
		InputCostPerAudioToken: koutaku.Ptr(0.00001),
	}
	usage := &schemas.KoutakuLLMUsage{
		PromptTokens:     2000,
		CompletionTokens: 500,
...
func TestComputeTranscriptionCost_TokenDetailsPreferredOverDuration(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:          koutaku.Ptr(0.000005),
		OutputCostPerToken:         koutaku.Ptr(0.0),
		InputCostPerAudioPerSecond: koutaku.Ptr(0.0001),
		InputCostPerAudioToken:     koutaku.Ptr(0.00001),
	}
	seconds := 60
	audioDetails := &schemas.TranscriptionUsageInputTokenDetails{
...
func TestComputeImageCost_PerImage(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:  koutaku.Ptr(0.0),
		OutputCostPerToken: koutaku.Ptr(0.0),
		OutputCostPerImage: koutaku.Ptr(0.052),
	}
...
func TestComputeImageCost_InputAndOutputPerImage(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerImage:  koutaku.Ptr(0.01),
		OutputCostPerImage: koutaku.Ptr(0.05),
	}
	usage := &schemas.ImageUsage{
		NumInputImages:      3,
...
func TestComputeImageCost_PerPixelOutput(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		OutputCostPerPixel: koutaku.Ptr(0.000000019), // ~$0.02 for 1024x1024
	}
	usage := &schemas.ImageUsage{
...
func TestComputeImageCost_PerPixelInputAndOutput(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerPixel:  koutaku.Ptr(0.00000001),
		OutputCostPerPixel: koutaku.Ptr(0.00000002),
	}
	usage := &schemas.ImageUsage{
		NumInputImages:      2,
...
func TestComputeImageCost_PixelsPreferredOverPerImage(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		OutputCostPerPixel: koutaku.Ptr(0.00000002),
		OutputCostPerImage: koutaku.Ptr(999.0), // should not be used
	}
	usage := &schemas.ImageUsage{
		OutputTokensDetails: &schemas.ImageTokenDetails{NImages: 1},
	}
...
func TestComputeImageCost_QualityBasedRates(t *testing.T) {
	...
	p := configstoreTables.TableModelPricing{
		OutputCostPerImage:              koutaku.Ptr(0.01),
		OutputCostPerImageLowQuality:    koutaku.Ptr(0.02),
		OutputCostPerImageMediumQuality: koutaku.Ptr(0.03),
		OutputCostPerImageHighQuality:   koutaku.Ptr(0.04),
		OutputCostPerImageAutoQuality:   koutaku.Ptr(0.05),
	}
...
func TestComputeVideoCost_DurationBased(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:           koutaku.Ptr(0.000001),
		OutputCostPerToken:          koutaku.Ptr(0.0),
		OutputCostPerVideoPerSecond: koutaku.Ptr(0.001),
	}
	seconds := 30
	usage := &schemas.KoutakuLLMUsage{PromptTokens: 500, TotalTokens: 500}
...
func TestComputeVideoCost_OutputCostPerSecondFallback(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:   koutaku.Ptr(0.0),
		OutputCostPerToken:  koutaku.Ptr(0.0),
		OutputCostPerSecond: koutaku.Ptr(0.002),
	}
	seconds := 10
...
func TestComputeVideoCost_NilSeconds(t *testing.T) {
	...
	usage := &schemas.KoutakuLLMUsage{PromptTokens: 1000}
...
func TestTieredInputRate_BelowThreshold(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		InputCostPerToken:                koutaku.Ptr(0.000003),
		InputCostPerTokenAbove200kTokens: koutaku.Ptr(0.000006),
	}
...
func TestTieredOutputRate_AboveThreshold(t *testing.T) {
	p := configstoreTables.TableModelPricing{
		OutputCostPerToken:                koutaku.Ptr(0.000015),
		OutputCostPerTokenAbove200kTokens: koutaku.Ptr(0.00003),
	}
...
func TestExtractCostInput_ChatResponse(t *testing.T) {
	usage := &schemas.KoutakuLLMUsage{PromptTokens: 100, CompletionTokens: 50, TotalTokens: 150}
	resp := &schemas.KoutakuResponse{
		ChatResponse: &schemas.KoutakuChatResponse{Usage: usage},
	}
...
func TestExtractCostInput_EmbeddingResponse(t *testing.T) {
	usage := &schemas.KoutakuLLMUsage{PromptTokens: 200, TotalTokens: 200}
	resp := &schemas.KoutakuResponse{
		EmbeddingResponse: &schemas.KoutakuEmbeddingResponse{Usage: usage},
	}
	input := extractCostInput(resp)
	require.NotNil(t, input.usage)
...
func TestExtractCostInput_ImageResponse(t *testing.T) {
	...
	resp := &schemas.KoutakuResponse{
		ImageGenerationResponse: &schemas.KoutakuImageGenerationResponse{Usage: imgUsage},
	}
	input := extractCostInput(resp)
...
func TestExtractCostInput_TranscriptionWithSeconds(t *testing.T) {
	sec := 60
	resp := &schemas.KoutakuResponse{
		TranscriptionResponse: &schemas.KoutakuTranscriptionResponse{
			Usage: &schemas.TranscriptionUsage{
				Seconds:      &sec,
				InputTokens:  koutaku.Ptr(1000),
				OutputTokens: koutaku.Ptr(200),
				TotalTokens:  koutaku.Ptr(1200),
			},
		},
	}
	input := extractCostInput(resp)
...
func TestExtractCostInput_SpeechResponse(t *testing.T) {
	resp := &schemas.KoutakuResponse{
		SpeechResponse: &schemas.KoutakuSpeechResponse{
...
func TestExtractCostInput_VideoResponse(t *testing.T) {
	sec := "15"
	resp := &schemas.KoutakuResponse{
		VideoGenerationResponse: &schemas.KoutakuVideoGenerationResponse{
			Seconds: &sec,
		},
	}
	input := extractCostInput(resp)
...
func TestCalculateCost_SemanticCacheDirectHit(t *testing.T) {
	mc := testCatalogWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("gpt-4o", "openai", "chat"): {
			...
			InputCostPerToken: koutaku.Ptr(0.000005), OutputCostPerToken: koutaku.Ptr(0.000015),
		},
	})
...
func TestCalculateCost_SemanticCacheSemanticHit(t *testing.T) {
	...
	mc := testCatalogWithPricing(map[string]configstoreTables.TableModelPricing{
		...
		makeKey("text-embedding-3-small", "openai", "embedding"): {
			...
			InputCostPerToken: koutaku.Ptr(0.00000002),
		},
	})
...
func TestCalculateCost_SemanticCacheMiss(t *testing.T) {
	...
	resp := &schemas.KoutakuResponse{
		ChatResponse: &schemas.KoutakuChatResponse{
			Usage: &schemas.KoutakuLLMUsage{PromptTokens: 1000, CompletionTokens: 500, TotalTokens: 1500},
			ExtraFields: schemas.KoutakuResponseExtraFields{
				RequestType:            schemas.ChatCompletionRequest,
				Provider:               schemas.OpenAI,
				OriginalModelRequested: "gpt-4o",
...
func TestCalculateCost_ProviderComputedCostPassthrough(t *testing.T) {
	...
	resp := makeChatResponse(schemas.OpenAI, "gpt-4o", &schemas.KoutakuLLMUsage{
		PromptTokens:     1000,
		CompletionTokens: 500,
		TotalTokens:      1500,
		Cost: &schemas.KoutakuCost{
...
func TestCalculateCost_ChatCompletion_GPT4o(t *testing.T) {
	...
	mc := testCatalogWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("gpt-4o", "openai", "chat"): {
			...
			InputCostPerToken:       koutaku.Ptr(0.000005),
			OutputCostPerToken:      koutaku.Ptr(0.000015),
			CacheReadInputTokenCost: koutaku.Ptr(0.0000005),
		},
	})
...
func TestCalculateCost_ChatCompletion_Claude35Sonnet_WithCache(t *testing.T) {
	...
	mc := testCatalogWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("anthropic.claude-3-5-sonnet-20241022-v2:0", "bedrock", "chat"): {
			...
			InputCostPerToken:                 koutaku.Ptr(0.000003),
			OutputCostPerToken:                koutaku.Ptr(0.000015),
			CacheReadInputTokenCost:           koutaku.Ptr(0.0000003),
			CacheCreationInputTokenCost:       koutaku.Ptr(0.00000375),
			InputCostPerTokenAbove200kTokens:  koutaku.Ptr(0.000006),
			OutputCostPerTokenAbove200kTokens: koutaku.Ptr(0.00003),
		},
	})

	resp := makeChatResponse(schemas.Bedrock, "anthropic.claude-3-5-sonnet-20241022-v2:0", &schemas.KoutakuLLMUsage{
		PromptTokens:     5000,
...
func TestCalculateCost_Embedding(t *testing.T) {
	...
	resp := makeEmbeddingResponse(schemas.Bedrock, "amazon.titan-embed-text-v1", &schemas.KoutakuLLMUsage{
		PromptTokens: 10000,
		TotalTokens:  10000,
	})
...
func TestCalculateCost_Rerank(t *testing.T) {
	...
	resp := makeRerankResponse(schemas.Bedrock, "amazon.rerank-v1:0", &schemas.KoutakuLLMUsage{
		PromptTokens: 500,
		TotalTokens:  500,
	})
...
func TestCalculateCost_NoPricingData(t *testing.T) {
	mc := testCatalogWithPricing(nil)
	resp := makeChatResponse(schemas.OpenAI, "unknown-model", &schemas.KoutakuLLMUsage{
...
func TestGetPricing_GeminiFallsBackToVertex(t *testing.T) {
	mc := testCatalogWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("gemini-2.0-flash", "vertex", "chat"): {
			...
			InputCostPerToken: koutaku.Ptr(0.0000001), OutputCostPerToken: koutaku.Ptr(0.0000004),
		},
	})
...
// =========================================================================
// 15. responsesUsageToKoutakuUsage
// =========================================================================

func TestResponsesUsageToKoutakuUsage_Basic(t *testing.T) {
	u := &schemas.ResponsesResponseUsage{
		InputTokens:  100,
		OutputTokens: 50,
		TotalTokens:  150,
	}
	result := responsesUsageToKoutakuUsage(u)
...
func TestResponsesUsageToKoutakuUsage_WithTokenDetails(t *testing.T) {
	numQueries := 2
	u := &schemas.ResponsesResponseUsage{
		InputTokens:  1000,
		OutputTokens: 500,
...
func TestCalculateCost_200kTier_EndToEnd(t *testing.T) {
	...
	mc := testCatalogWithPricing(map[string]configstoreTables.TableModelPricing{
		makeKey("anthropic.claude-3-5-sonnet-20240620-v1:0", "bedrock", "chat"): {
			...
			CacheReadInputTokenCost:                    koutaku.Ptr(0.0000003),
			CacheCreationInputTokenCost:                koutaku.Ptr(0.00000375),
			CacheReadInputTokenCostAbove200kTokens:     koutaku.Ptr(0.0000006),
			CacheCreationInputTokenCostAbove200kTokens: koutaku.Ptr(0.0000075),
		},
	})

	resp := makeChatResponse(schemas.Bedrock, "anthropic.claude-3-5-sonnet-20240620-v1:0", &schemas.KoutakuLLMUsage{
		PromptTokens:     190000,
...
func TestCalculateCost_272kTier_EndToEnd(t *testing.T) {
	...
	resp := makeChatResponse(schemas.Anthropic, "claude-3-7-sonnet", &schemas.KoutakuLLMUsage{
		PromptTokens:     250000,
		CompletionTokens: 30000,
		TotalTokens:      280000, // Above 272k
	})
...
func TestCalculateCost_AllCachedTokens(t *testing.T) {
	...
	p := chatPricing(0.000005, 0.000015)
	p.CacheReadInputTokenCost = koutaku.Ptr(0.0000005)
...
func TestCalculateCost_ImageGeneration_NilUsage_PerImagePricing(t *testing.T) {
	...
	pricing := configstoreTables.TableModelPricing{
		...
		InputCostPerToken:  koutaku.Ptr(0.0),
		OutputCostPerImage: koutaku.Ptr(0.04),
	}
