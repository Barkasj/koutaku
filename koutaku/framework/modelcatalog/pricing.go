...
// costInput holds the extracted usage data from a KoutakuResponse,
...
// CalculateCost calculates the cost of a Koutaku response.
...
func (mc *ModelCatalog) CalculateCost(result *schemas.KoutakuResponse, scopes *PricingLookupScopes) float64 {
	if result == nil {
		return 0
	}
...
func (mc *ModelCatalog) calculateCostWithCache(result *schemas.KoutakuResponse, cacheDebug *schemas.KoutakuCacheDebug, scopes PricingLookupScopes) float64 {
...
func (mc *ModelCatalog) computeCacheEmbeddingCost(cacheDebug *schemas.KoutakuCacheDebug, scopes PricingLookupScopes) float64 {
...
func (mc *ModelCatalog) calculateBaseCost(result *schemas.KoutakuResponse, scopes PricingLookupScopes) float64 {
...
func extractCostInput(result *schemas.KoutakuResponse) costInput {
	var input costInput
	...
	case result.ResponsesResponse != nil && result.ResponsesResponse.Usage != nil:
		input.usage = responsesUsageToKoutakuUsage(result.ResponsesResponse.Usage)
		input.tier = tierFromString(result.ResponsesResponse.ServiceTier)

	case result.ResponsesStreamResponse != nil && result.ResponsesStreamResponse.Response != nil && result.ResponsesStreamResponse.Response.Usage != nil:
		input.usage = responsesUsageToKoutakuUsage(result.ResponsesStreamResponse.Response.Usage)
	...
	case result.SpeechResponse != nil && result.SpeechResponse.Usage != nil:
		input.usage = speechUsageToKoutakuUsage(result.SpeechResponse.Usage)
	...
	case result.SpeechStreamResponse != nil && result.SpeechStreamResponse.Usage != nil:
		input.usage = speechUsageToKoutakuUsage(result.SpeechStreamResponse.Usage)
...
func responsesUsageToKoutakuUsage(u *schemas.ResponsesResponseUsage) *schemas.KoutakuLLMUsage {
	usage := &schemas.KoutakuLLMUsage{
...
func speechUsageToKoutakuUsage(u *schemas.SpeechUsage) *schemas.KoutakuLLMUsage {
...
func extractTranscriptionUsage(u *schemas.TranscriptionUsage) (*schemas.KoutakuLLMUsage, *int, *schemas.TranscriptionUsageInputTokenDetails) {
	usage := &schemas.KoutakuLLMUsage{}
...
func computeTextCost(pricing *configstoreTables.TableModelPricing, usage *schemas.KoutakuLLMUsage, tier serviceTier) float64 {
	if usage == nil {
		return 0
	}
...
func computeEmbeddingCost(pricing *configstoreTables.TableModelPricing, usage *schemas.KoutakuLLMUsage, tier serviceTier) float64 {
	if usage == nil {
		return 0
	}
...
func computeRerankCost(pricing *configstoreTables.TableModelPricing, usage *schemas.KoutakuLLMUsage, tier serviceTier) float64 {
	if usage == nil {
		return 0
	}
...
func computeSpeechCost(pricing *configstoreTables.TableModelPricing, usage *schemas.KoutakuLLMUsage, audioSeconds *int, audioTextInputChars int, tier serviceTier) float64 {
...
func computeTranscriptionCost(pricing *configstoreTables.TableModelPricing, usage *schemas.KoutakuLLMUsage, audioSeconds *int, audioTokenDetails *schemas.TranscriptionUsageInputTokenDetails, tier serviceTier) float64 {
	totalTokens := safeTotalTokens(usage)
...
func computeAudioInputCost(pricing *configstoreTables.TableModelPricing, usage *schemas.KoutakuLLMUsage, audioSeconds *int, audioTokenDetails *schemas.TranscriptionUsageInputTokenDetails, totalTokens int, tier serviceTier) float64 {
...
func computeAudioOutputCost(pricing *configstoreTables.TableModelPricing, usage *schemas.KoutakuLLMUsage, audioSeconds *int, totalTokens int, tier serviceTier) float64 {
...
// Input and output are calculated independently — tokens first, then per-second fallback.
func computeVideoCost(pricing *configstoreTables.TableModelPricing, usage *schemas.KoutakuLLMUsage, videoSeconds *int, tier serviceTier) float64 {
	totalTokens := safeTotalTokens(usage)
...
func safeTotalTokens(usage *schemas.KoutakuLLMUsage) int {
	if usage == nil {
		return 0
	}
