# Koutaku on Kubernetes

Deploys Koutaku on any existing Kubernetes cluster using a Deployment, PVC, and optional Ingress + HPA.
...
To expose Koutaku externally, set `create_load_balancer = true` and configure:
