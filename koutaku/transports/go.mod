module github.com/koutaku/koutaku/transports
...
require (
	...
	github.com/koutaku/koutaku/plugins/governance v1.5.4
	github.com/koutaku/koutaku/plugins/logging v1.5.4
	github.com/koutaku/koutaku/plugins/otel v1.2.4
