...
func extractRealtimeTurnSummary(event *schemas.KoutakuRealtimeEvent, contentOverride string) string {
...
func finalizedRealtimeInputSummary(event *schemas.KoutakuRealtimeEvent) string {
	if event == nil {
		return ""
	}
...
func pendingRealtimeInputUpdate(event *schemas.KoutakuRealtimeEvent) (string, string) {
	if event == nil {
		return "", ""
	}
...
func finalizedRealtimeToolOutputSummary(event *schemas.KoutakuRealtimeEvent) string {
...
func pendingRealtimeToolOutputUpdate(event *schemas.KoutakuRealtimeEvent) (string, string) {
...
func extractRealtimeExtraParamString(event *schemas.KoutakuRealtimeEvent, key string) string {
...
func realtimeEventItemID(event *schemas.KoutakuRealtimeEvent) string {
	if event == nil {
		return ""
	}
...
func extractRealtimeTurnUsage(provider schemas.RealtimeProvider, rawMessage []byte) *schemas.KoutakuLLMUsage {
...
func extractRealtimeResponseDoneUsage(rawMessage []byte) *schemas.KoutakuLLMUsage {
	if len(rawMessage) == 0 {
		return nil
	}
