...
func TestExtractModelAndRequestType_LargePayloadUsesMetadataWithoutBodyParse(t *testing.T) {
	...
	koutakuCtx.SetValue(schemas.KoutakuContextKeyLargePayloadMode, true)
	koutakuCtx.SetValue(schemas.KoutakuContextKeyLargePayloadMetadata, &schemas.LargePayloadMetadata{
		ResponseModalities: []string{"AUDIO"},
	})
	ctx.SetUserValue(lib.FastHTTPUserValueKoutakuContext, koutakuCtx)
