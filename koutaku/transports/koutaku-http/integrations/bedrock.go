...
const (
	s3ContextKeyBucket  = schemas.KoutakuContextKey("s3_bucket")
	s3ContextKeyPrefix  = schemas.KoutakuContextKey("s3_prefix")
	s3ContextKeyMaxKeys = schemas.KoutakuContextKey("s3_max_keys")
)
	...
	return RouteConfig{
		...
		RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
			if invokeReq, ok := req.(*bedrock.BedrockInvokeRequest); ok {
				requestType, _ := ctx.Value(schemas.KoutakuContextKeyHTTPRequestType).(schemas.RequestType)
				switch requestType {
				...
				if requestType == schemas.ResponsesRequest {
					...
					responsesReq, err := converseReq.ToKoutakuResponsesRequest(ctx)
					if err != nil {
						return nil, fmt.Errorf("failed to convert invoke messages stream request: %w", err)
					}
					return &schemas.KoutakuRequest{ResponsesRequest: responsesReq}, nil
				}
				// Prompt-based → Text Completion path (streaming)
				return &schemas.KoutakuRequest{
					TextCompletionRequest: invokeReq.ToKoutakuTextCompletionRequest(ctx),
				}, nil
			}
			return nil, errors.New("invalid request type")
		},
	...
	return RouteConfig{
		...
		RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
			...
			case schemas.EmbeddingRequest:
				return &schemas.KoutakuRequest{
					EmbeddingRequest: invokeReq.ToKoutakuEmbeddingRequest(ctx),
				}, nil

			case schemas.ImageGenerationRequest:
				return &schemas.KoutakuRequest{
					ImageGenerationRequest: invokeReq.ToKoutakuImageGenerationRequest(ctx),
				}, nil

			case schemas.ImageEditRequest:
				editReq, err := invokeReq.ToKoutakuImageEditRequest(ctx)
				if err != nil {
					return nil, fmt.Errorf("failed to convert invoke image edit request: %w", err)
				}
				return &schemas.KoutakuRequest{ImageEditRequest: editReq}, nil

			case schemas.ImageVariationRequest:
				varReq, err := invokeReq.ToKoutakuImageVariationRequest(ctx)
				if err != nil {
					return nil, fmt.Errorf("failed to convert invoke image variation request: %w", err)
				}
				return &schemas.KoutakuRequest{ImageVariationRequest: varReq}, nil
	...
	return RouteConfig{
		...
		RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
			if bedrockReq, ok := req.(*bedrock.BedrockRerankRequest); ok {
				return &schemas.KoutakuRequest{
					RerankRequest: bedrockReq.ToKoutakuRerankRequest(ctx),
				}, nil
			}
	...
	return RouteConfig{
		...
		RequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*schemas.KoutakuRequest, error) {
			if countTokensReq, ok := req.(*bedrock.BedrockCountTokensRequest); ok {
				...
				koutakuReq, err := countTokensReq.Input.Converse.ToKoutakuResponsesRequest(ctx)
				if err != nil {
					return nil, fmt.Errorf("failed to convert bedrock count tokens request: %w", err)
				}
				return &schemas.KoutakuRequest{
					CountTokensRequest: koutakuReq,
				}, nil
			}
	...
	routes = append(routes, RouteConfig{
		...
		BatchRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*BatchRequest, error) {
			if bedrockReq, ok := req.(*bedrock.BedrockBatchJobRequest); ok {
				provider := ctx.Value(koutakuContextKeyProvider).(schemas.ModelProvider)

				// Convert Bedrock batch request to Koutaku format
				// For Bedrock: use S3 URIs directly
				// For other providers: S3 URIs are not applicable, use file_id from tags
				createReq := &schemas.KoutakuBatchCreateRequest{
					Provider: provider,
		...
		PreCallback: func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
			...
			if provider != "" {
				koutakuCtx.SetValue(koutakuContextKeyProvider, schemas.ModelProvider(provider))
			} else {
				koutakuCtx.SetValue(koutakuContextKeyProvider, schemas.Bedrock)
			}
			return bedrockBatchPreCallback(handlerStore)(ctx, koutakuCtx, req)
		},
	})
	...
	routes = append(routes, RouteConfig{
		...
		BatchRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*BatchRequest, error) {
			if bedrockReq, ok := req.(*bedrock.BedrockBatchListRequest); ok {
				provider := ctx.Value(koutakuContextKeyProvider).(schemas.ModelProvider)
				koutakuReq := bedrock.ToKoutakuBatchListRequest(bedrockReq, provider)
				return &BatchRequest{
					Type:        schemas.BatchListRequest,
					ListRequest: koutakuReq,
				}, nil
			}
		...
		PreCallback: func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
			...
			return extractBedrockBatchListQueryParams(handlerStore)(ctx, koutakuCtx, req)
		},
	})
	...
	routes = append(routes, RouteConfig{
		...
		BatchRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*BatchRequest, error) {
			if bedrockReq, ok := req.(*bedrock.BedrockBatchRetrieveRequest); ok {
				provider := ctx.Value(koutakuContextKeyProvider).(schemas.ModelProvider)
				koutakuReq := bedrock.ToKoutakuBatchRetrieveRequest(bedrockReq, provider)
				return &BatchRequest{
					Type:            schemas.BatchRetrieveRequest,
					RetrieveRequest: koutakuReq,
				}, nil
			}
		...
		PreCallback: func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
			...
			return extractBedrockJobArnFromPath(handlerStore)(ctx, koutakuCtx, req)
		},
	})
	...
	routes = append(routes, RouteConfig{
		...
		BatchRequestConverter: func(ctx *schemas.KoutakuContext, req interface{}) (*BatchRequest, error) {
			if bedrockReq, ok := req.(*bedrock.BedrockBatchCancelRequest); ok {
				provider := ctx.Value(koutakuContextKeyProvider).(schemas.ModelProvider)
				koutakuReq := bedrock.ToKoutakuBatchCancelRequest(bedrockReq, provider)
				return &BatchRequest{
					Type:          schemas.BatchCancelRequest,
					CancelRequest: koutakuReq,
				}, nil
			}
...
func bedrockBatchPreCallback(handlerStore lib.HandlerStore) func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
...
func extractBedrockBatchListQueryParams(handlerStore lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
		...
		if err := bedrockBatchPreCallback(handlerStore)(ctx, koutakuCtx, req); err != nil {
			return err
		}
...
func extractBedrockJobArnFromPath(handlerStore lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
		...
		if (*koutakuCtx).Value(koutakuContextKeyProvider).(schemas.ModelProvider) != schemas.Bedrock {
...
// NewBedrockRouter creates a new BedrockRouter with the given koutaku client
func NewBedrockRouter(client *koutaku.Koutaku, handlerStore lib.HandlerStore, logger schemas.Logger) *BedrockRouter {
...
// This allows boto3's S3 client to work directly against Koutaku using endpoint_url.
...
func createBedrockFilesRouteConfigs(pathPrefix string, handlerStore lib.HandlerStore) []RouteConfig {
	...
	routes = append(routes, RouteConfig{
		...
		FileContentResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuFileContentResponse) (interface{}, error) {
			// Return raw content
	...
	routes = append(routes, RouteConfig{
		...
		PreCallback: func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
			...
			return extractS3BucketKeyFromPath(handlerStore, "retrieve")(ctx, koutakuCtx, req)
		},
	...
	routes = append(routes, RouteConfig{
		...
		PreCallback: func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
			...
			return extractS3BucketKeyFromPath(handlerStore, "delete")(ctx, koutakuCtx, req)
		},
	...
	routes = append(routes, RouteConfig{
		...
		FileListResponseConverter: func(ctx *schemas.KoutakuContext, resp *schemas.KoutakuFileListResponse) (interface{}, error) {
			...
			// Fallback: reconstruct XML from Koutaku response
			bucket := ""
			prefix := ""
			maxKeys := 1000
		...
		PreCallback: func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
			...
			return extractS3ListObjectsV2Params(handlerStore)(ctx, koutakuCtx, req)
		},
...
func extractS3ListObjectsV2Params(handlerStore lib.HandlerStore) PreRequestCallback {
	return func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
		...
		koutakuCtx.SetValue(s3ContextKeyBucket, bucketStr)
		koutakuCtx.SetValue(s3ContextKeyPrefix, prefix)
		koutakuCtx.SetValue(s3ContextKeyMaxKeys, maxKeys)
...
func s3PutObjectPostCallback(ctx *fasthttp.RequestCtx, req interface{}, resp interface{}) error {
	...
	ctx.Response.Header.Set("x-amz-request-id", "koutaku")
	if uploadResp, ok := resp.(*schemas.KoutakuFileUploadResponse); ok && uploadResp != nil {
...
func s3GetObjectPostCallback(ctx *fasthttp.RequestCtx, req interface{}, resp interface{}) error {
	if contentResp, ok := resp.(*schemas.KoutakuFileContentResponse); ok && contentResp != nil {
...
func s3HeadObjectPostCallback(ctx *fasthttp.RequestCtx, req interface{}, resp interface{}) error {
	if retrieveResp, ok := resp.(*schemas.KoutakuFileRetrieveResponse); ok && retrieveResp != nil {
...
func bedrockPreCallback(handlerStore lib.HandlerStore) func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
	return func(ctx *fasthttp.RequestCtx, koutakuCtx *schemas.KoutakuContext, req interface{}) error {
