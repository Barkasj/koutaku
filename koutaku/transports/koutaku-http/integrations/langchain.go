...
// NewLangChainRouter creates a new LangChainRouter with the given koutaku client.
func NewLangChainRouter(client *koutaku.Koutaku, handlerStore lib.HandlerStore, logger schemas.Logger) *LangChainRouter {
	routes := []RouteConfig{}
