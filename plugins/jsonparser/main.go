...
const (
	EnableStreamingJSONParser schemas.KoutakuContextKey = "enable-streaming-json-parser"
)
...
func (p *JsonParserPlugin) HTTPTransportPreHook(ctx *schemas.KoutakuContext, req *schemas.HTTPRequest) (*schemas.HTTPResponse, error) {
	return nil, nil
}

// HTTPTransportPostHook is not used for this plugin
func (p *JsonParserPlugin) HTTPTransportPostHook(ctx *schemas.KoutakuContext, req *schemas.HTTPRequest, resp *schemas.HTTPResponse) error {
	return nil
}

// HTTPTransportStreamChunkHook passes through streaming chunks unchanged
func (p *JsonParserPlugin) HTTPTransportStreamChunkHook(ctx *schemas.KoutakuContext, req *schemas.HTTPRequest, chunk *schemas.KoutakuStreamChunk) (*schemas.KoutakuStreamChunk, error) {
	return chunk, nil
}
...
func (p *JsonParserPlugin) PreLLMHook(ctx *schemas.KoutakuContext, req *schemas.KoutakuRequest) (*schemas.KoutakuRequest, *schemas.LLMPluginShortCircuit, error) {
	return req, nil, nil
}
...
//   - error: Any error that occurred during processing
func (p *JsonParserPlugin) PostLLMHook(ctx *schemas.KoutakuContext, result *schemas.KoutakuResponse, err *schemas.KoutakuError) (*schemas.KoutakuResponse, *schemas.KoutakuError, error) {
	...
	resultCopy := p.deepCopyKoutakuResponse(result)
	...
	if streamEndIndicatorValue := ctx.Value(schemas.KoutakuContextKeyStreamEndIndicator); streamEndIndicatorValue != nil {
