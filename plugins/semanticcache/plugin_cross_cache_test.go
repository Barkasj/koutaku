...
func TestCrossCacheTypeAccessibility(t *testing.T) {
	...
	AssertCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response2}, "direct") // Should find direct match
	...
	AssertCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response3}, "semantic") // Should find semantic match
...
func TestCacheTypeIsolation(t *testing.T) {
	...
	AssertNoCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response1}) // Fresh request
	...
	AssertNoCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response2}) // Should miss - no semantic cache entry
	...
	AssertCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response3}, "direct") // Should hit direct cache
	...
	AssertCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response4}, "direct") // Should find existing direct cache
...
func TestCacheTypeFallbackBehavior(t *testing.T) {
	...
	AssertNoCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response2}) // Should miss - no direct match, no semantic search
	...
	if response4.ExtraFields.CacheDebug != nil && response4.ExtraFields.CacheDebug.CacheHit {
		AssertCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response4}, "semantic")
...
func TestMultipleCacheEntriesPriority(t *testing.T) {
	...
	AssertCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response2}, "direct") // Should hit direct cache
	...
	AssertCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response3}, "direct") // Should find direct cache
	...
	AssertCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response4}, "semantic") // Should find semantic cache
...
func TestCrossCacheTypeWithDifferentParameters(t *testing.T) {
	...
	AssertCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response2}, "direct") // Should hit
	...
	AssertNoCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response3}) // Should miss due to different params
...
func TestCacheTypeErrorHandling(t *testing.T) {
	...
	AssertNoCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response1}) // Should work with fallback behavior
	...
	AssertCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response2}, "direct") // Should find cached entry from first request
