...
func TestCacheNoStoreBasicFunctionality(t *testing.T) {
	...
	AssertNoCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response3}) // Fresh request
	...
	AssertNoCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response5}) // Fresh request
	...
	AssertCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response6}, "direct") // Should be cached
...
func TestCacheNoStoreWithDifferentRequestTypes(t *testing.T) {
	...
	AssertNoCacheHit(t, &schemas.KoutakuResponse{EmbeddingResponse: response4}) // Should not be cached
...
func TestCacheNoStoreWithConversationHistory(t *testing.T) {
	...
	AssertNoCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response2}) // Should not be cached due to no-store
...
func TestCacheNoStoreWithCacheTypes(t *testing.T) {
	...
	AssertNoCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response2}) // No-store should override cache type
	...
	AssertNoCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response4}) // No-store should override cache type
...
func TestCacheNoStoreErrorHandling(t *testing.T) {
	...
	AssertCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response2}, "direct") // Should be cached (invalid value ignored)
	...
	AssertCacheHit(t, &schemas.KoutakuResponse{ChatResponse: response4}, "direct") // Should be cached (nil ignored)
