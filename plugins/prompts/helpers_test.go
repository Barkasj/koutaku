...
import (
	...
	tables "github.com/koutaku/koutaku/framework/configstore/tables"
)
...
func (r *staticResolver) Resolve(_ *schemas.KoutakuContext, _ *schemas.KoutakuRequest) (string, int, error) {
...
// chatRequest returns a KoutakuRequest wrapping a ChatRequest with the given messages.
func chatRequest(msgs ...schemas.ChatMessage) *schemas.KoutakuRequest {
...
// bfCtx returns a fresh KoutakuContext with no deadline.
func bfCtx() *schemas.KoutakuContext {
...
// chatRequestWithParams returns a KoutakuRequest with Params pre-set.
func chatRequestWithParams(params *schemas.ChatParameters, msgs ...schemas.ChatMessage) *schemas.KoutakuRequest {
	return &schemas.KoutakuRequest{
		ChatRequest: &schemas.KoutakuChatRequest{
			Input:  append([]schemas.ChatMessage{}, msgs...),
			Params: params,
...
// chatRequestWithModel returns a KoutakuRequest with the Model field pre-set.
func chatRequestWithModel(model string, msgs ...schemas.ChatMessage) *schemas.KoutakuRequest {
	return &schemas.KoutakuRequest{
		ChatRequest: &schemas.KoutakuChatRequest{
			Model: model,
			Input: append([]schemas.ChatMessage{}, msgs...),
...
// the Koutaku UI writes for assistant (completion_result) messages.
