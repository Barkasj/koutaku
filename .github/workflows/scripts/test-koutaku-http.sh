...
# Test koutaku-http component
# Usage: ./test-koutaku-http.sh
...
echo "🧪 Running koutaku-http tests..."
...
cd ..
echo "✅ Koutaku-HTTP tests completed successfully"
