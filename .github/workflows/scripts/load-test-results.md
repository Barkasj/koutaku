# Koutaku Load Test Results (single instance, 1000 RPS)
...
- **Single instance**: All tests run against one koutaku-http process at 1000 RPS
- **Overhead measurement**: Mocker at 1000ms latency, calibration (Vegeta->Mocker) subtracted from test (Vegeta->Koutaku->Mocker)
