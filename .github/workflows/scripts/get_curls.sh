...
# Koutaku HTTP Transport - GET API Endpoints
...
echo "Koutaku GET API Endpoints - Status Check"
echo "========================================"
...
echo "The aim of the script is to make sure koutaku server is not crashing"