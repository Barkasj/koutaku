/**
 * Azure OpenAI SDK Integration Tests - Azure Provider via Koutaku
 *
 * This test suite uses the AzureOpenAI SDK to test against Azure through Koutaku.
 ...
 *   uses the model as deployment-id in the URL path, and Koutaku's AzureEndpointPreHook
