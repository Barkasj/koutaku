...
# Koutaku V1 Session Stickiness Newman Test Runner
...
COLLECTION="collections/koutaku-v1-session.postman_collection.json"
...
echo -e "${GREEN}==============================================${NC}"
echo -e "${GREEN}Koutaku V1 Session Stickiness Test Runner${NC}"
echo -e "${GREEN}==============================================${NC}"
echo ""
